...
resource 'STR#' (290, "Colors Palette: Favorites Picker: Baloon Help", purgeable) {
	{	/* array StringArray: 1 elements */
		/* [1] */
		"D‚«‚ÈF‚ğ’u‚¢‚Ä‚¨‚­‚±‚Æ‚ªo—ˆ‚éƒpƒŒƒbƒg‚Å‚·BƒpƒŒƒbƒg‚Ì‹ó‚¢‚Ä‚¢‚é•”•ª‚Éƒ}ƒEƒX‚ğˆÚ“®‚µƒNƒŠƒbƒN‚·‚ê‚Î‚»‚±‚Ö•Û‘¶‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B"
		"F‚ğíœ‚·‚éê‡‚É‚ÍAƒRƒ}ƒ“ƒh‚ğ‰Ÿ‚µ‚È‚ª‚ç‘I‘ğ‚µƒNƒŠƒbƒN‚µ‚Ä‰º‚³‚¢B"
	}
};
...
resource 'STR#' (250, "Colors Palette: Balloon Help", purgeable) {
	{	/* array StringArray: 4 elements */
		...
		"‚à‚¤ˆê•û‚Ì˜g‚ğ‘I‘ğ‚·‚é‚±‚Æ‚Å•ÒW‚·‚éF‚ğ•ÏX‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B",
		/* [2] */
