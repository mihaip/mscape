/* Resource fork of software/extras/Iconographer Support/Translations/Iconographer French 2.2/French Resources/icnsEditorClass.ClassicF.rsrc */
...
resource 'DITL' (1100, purgeable) {
	{	/* array DITLarray: 17 elements */
		...
		CheckBox {
			enabled,
			"VŽrifier les masques 8-bit et 1-bit"
		},
		/* [3] */
		{74, 8, 90, 313},
		CheckBox {
