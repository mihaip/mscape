...
resource 'STR#' (200, "-Basic Strings", purgeable) {
	{	/* array StringArray: 9 elements */
		...
		"ƒLƒƒƒ“ƒZƒ‹",
		/* [5] */
		"‘åƒTƒCƒY 8 bit ‚Æ 1 bit ‚Ìƒ}ƒXƒN‚ªˆÙ‚È‚Á‚Ä‚¢‚Ü‚·B‘åƒTƒCƒY 1 bit ‚Ìƒ}ƒXƒN‚ğ 8 bit ‚Ìƒ}ƒXƒN‚©‚çÄ¶¬‚µ‚Ü‚·‚©H",
		/* [6] */
		"¬ƒTƒCƒY 8 bit ‚Æ 1 bit ‚Ìƒ}ƒXƒN‚ªˆÙ‚È‚Á‚Ä‚¢‚Ü‚·B¬ƒTƒCƒY 1 bit ‚Ìƒ}ƒXƒN‚ğ 8 bit ‚Ìƒ}ƒXƒN‚©‚çÄ¶¬‚µ‚Ü‚·‚©H",
		/* [7] */
		"Å‘åƒTƒCƒY 8 bit ‚Æ 1 bit ‚Ìƒ}ƒXƒN‚ªˆÙ‚È‚Á‚Ä‚¢‚Ü‚·BÅ‘åƒTƒCƒY 1 bit ‚Ìƒ}ƒXƒN‚ğ 8 bit ‚Ìƒ}ƒXƒN‚©‚çÄ¶¬‚µ‚Ü‚·‚©H ",
		/* [8] */
		"‚Í‚¢",
		/* [9] */
		"‚¢‚¢‚¦"
...
resource 'STR#' (204, "-Icon Info Balloon Help", purgeable) {
	{	/* array StringArray: 11 elements */
		...
		/* [8] */
		"‚±‚±‚ğƒ`ƒFƒbƒN‚·‚é‚ÆAƒAƒCƒRƒ“‚ªƒƒbƒN‚³‚ÄAƒƒ‚ƒŠ“à‚É“Ç‚İ‚ñ‚¾‚Éƒƒ‚ƒŠ—Ìˆæ‚ğˆÚ“®‚Å‚«‚È‚­‚È‚è‚Ü‚·B",
		/* [9] */
...
resource 'STR#' (300, "Icon Browser: Strings", purgeable) {
	{	/* array StringArray: 4 elements */
		...
		/* [4] */
		"IDF<ID> NameFg<name>h TypeF<type> ƒtƒ@ƒ~ƒŠ[",
		/* [5] */
		"ƒAƒCƒRƒ“í•ÊF <types>",
		/* [6] */
		"<number> ƒAƒCƒRƒ“"
...
resource 'STR#' (162, "Windows Balloon Help", purgeable) {
	{	/* array StringArray: 3 elements */
		/* [1] */
		"ƒEƒCƒ“ƒhƒEƒƒjƒ…[\n\n‚±‚Ìƒƒjƒ…[‚ÍAIconographer ‚ªƒAƒCƒRƒ“‚ğŠJ‚¢‚½‚Ég—p‚·‚éƒpƒŒƒbƒg‚ğ•\¦^”ñ•\¦‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·B"
		".",
		/* [2] */
		"ƒEƒCƒ“ƒhƒEƒƒjƒ…[\n\n‚±‚Ìƒƒjƒ…[‚ÍAIconographer ‚ªƒAƒCƒRƒ“‚ğŠJ‚¢‚½‚Ég—p‚·‚éƒpƒŒƒbƒg‚ğ•\¦^”ñ•\¦‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·B"
...
resource 'STR#' (270, "Colors Palette: HSV Picker: Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		...
		/* [3] */
		"Ê“x-ƒXƒ‰ƒCƒ_[FŒ»İ‚ÌF‚ÌÊ“x‚ğ§Œä‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·BÊ“x‚Í‚»‚ÌF©‘Ì‚Ì‹­‚³‚ğİ’è‚µ‚Ü‚·B"
		"ã‚­‚·‚é‚ÆŠDF‚©‚ç”’‚Ö‚Æ•Ï‰»‚µ‚Ä‚¢‚«‚Ü‚·B\n\ng—p•s‰Â‚Ìê‡A‚Ü‚¸‚»‚Ì’l‚ğ‘‚â‚·•K—v‚ª‚ ‚è‚Ü‚·B",
		/* [4] */
...
resource 'STR#' (290, "Colors Palette: Favorites Picker: Baloon Help", purgeable) {
	{	/* array StringArray: 1 elements */
		/* [1] */
		"‚ ‚È‚½‚ÌD‚«‚ÈF‚ğ’u‚¢‚Ä‚¨‚«A‚ ‚Æ‚Åg—p‚µ‚½‚è‚·‚é‚±‚Æ‚ªo—ˆ‚éƒpƒŒƒbƒg‚Å‚·BƒpƒŒƒbƒg‚Ì‹ó‚¢‚Ä‚¢‚é•”•ª‚Éƒ}ƒEƒX‚ğˆÚ“®‚µƒoƒPƒcƒAƒCƒRƒ“‚É‚È‚Á‚½‚çƒNƒŠƒbƒN‚·‚ê‚Î‚»‚±‚Ö•Û‘¶‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B"
		"F‚ğíœ‚·‚éê‡‚É‚ÍAƒRƒ}ƒ“ƒh‚ğ‰Ÿ‚µ‚È‚ª‚ç‘I‘ğ‚µA‚Í‚³‚İƒAƒCƒRƒ“‚É‚È‚Á‚½‚çƒNƒŠƒbƒN‚µ‚Ä‰º‚³‚¢B"
	}
};
...
resource 'STR#' (250, "Colors Palette: Balloon Help", purgeable) {
	{	/* array StringArray: 4 elements */
		/* [1] */
		"Œ»İ‚Ì‘OŒiF^”wŒiF‚ª‚±‚±‚É•\¦‚³‚ê‚Ü‚·B‘I‘ğ˜g‚ª•\¦‚³‚ê‚Ä‚¢‚é•”•ª‚ªŒ»İ•ÒW’†‚ÌF‚Å‚·B"
		"‘¼‚Ì˜g‚ğƒNƒŠƒbƒN‚·‚é‚±‚Æ‚Å‘¼‚ÌF‚ğ•ÒW‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B",
		/* [2] */
		"‚±‚ê‚ç‚Ìƒ^ƒu‚ÍA‚¢‚­‚Â‚©‚ÌFŒ©–{‚ğ‘I‘ğ‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·BF Ô^—Î^ÂAF‡‚¢^Ê“x^’lA"
		"ƒVƒXƒeƒ€ƒpƒŒƒbƒgA‚¨‹C‚É“ü‚èƒpƒŒƒbƒg‚È‚Ç",
		/* [3] */
