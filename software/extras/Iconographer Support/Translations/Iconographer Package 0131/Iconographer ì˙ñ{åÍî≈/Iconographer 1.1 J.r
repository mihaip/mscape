/* Resource fork of software/extras/Iconographer Support/Translations/Iconographer Package 0131/Iconographer Ã¬Ë™Ã±{Ã¥ÃÃ®â‰ˆ/Iconographer 1.1 J */
...
resource 'DLOG' (1011, purgeable) {
	...
	0x0,
	1011,
	"DITL 1011 gAdjust: Pane 1h from icnsEd"
	"itorClass.rsrc",
	noAutoCenter
};
...
data 'hwin' (1001, "Icon Info", purgeable) {
	...
	$"0F83 4183 4383 5283 938F EE95 F12E 2E2E"            /* .ƒAƒCƒRƒ“î•ñ... */
};

data 'hwin' (128, "About", purgeable) {
	$"0002 0000 0000 0001 0080 6872 6374 0005"            /* .........€hrct.. */
	$"0882 C982 C282 A282 C400"                           /* .‚É‚Â‚¢‚Ä. */
};
...
data 'hwin' (300, "Icon Browser", purgeable) {
	...
	$"1083 4183 4383 5283 9383 7583 8983 4583"            /* .ƒAƒCƒRƒ“ƒuƒ‰ƒEƒ */
	$"5500"                                               /* U. */
};
...
resource 'MENU' (129) {
	...
	{	/* array: 9 elements */
		...
		/* [6] */
		"•Ê–¼‚Å•Û‘¶...", noIcon, noKey, noMark, plain,
		/* [7] */
...
resource 'STR#' (200, "-Basic Strings", purgeable) {
	{	/* array StringArray: 9 elements */
		...
		"–¼Ì–¢İ’è",
		/* [2] */
		"‚±‚ÌƒAƒCƒRƒ“‚Ì IDF<ID> ‚Í‚·‚Å‚É‚±‚Ìƒtƒ@"
		"ƒCƒ‹‚Ì’†‚Åg‚í‚ê‚Ä‚¢‚Ü‚·B‚à‚µ‚±‚Ì‚Ü‚Ü‘€"
		"ì‚ğ‘±‚¯‚é‚ÆAŒÃ‚¢ƒAƒCƒRƒ“‚Éã‘‚«‚³‚ê‚Ü"
		"‚·B",
		/* [3] */
		"ã‘‚«",
		/* [4] */
		"ƒLƒƒƒ“ƒZƒ‹",
		/* [5] */
		"‘åƒTƒCƒY 8 bit ‚Æ 1 bit ‚Ìƒ}ƒXƒN‚ªˆÙ‚È‚Á"
		"‚Ä‚¢‚Ü‚·B‘åƒTƒCƒY 1 bit ‚Ìƒ}ƒXƒN‚ğ 8 bi"
		"t ‚Ìƒ}ƒXƒN‚©‚çÄ¶¬‚µ‚Ü‚·‚©H",
		/* [6] */
		"¬ƒTƒCƒY 8 bit ‚Æ 1 bit ‚Ìƒ}ƒXƒN‚ªˆÙ‚È‚Á"
		"‚Ä‚¢‚Ü‚·B¬ƒTƒCƒY 1 bit ‚Ìƒ}ƒXƒN‚ğ 8 bi"
		"t ‚Ìƒ}ƒXƒN‚©‚çÄ¶¬‚µ‚Ü‚·‚©H",
		/* [7] */
		"Å‘åƒTƒCƒY 8 bit ‚Æ 1 bit ‚Ìƒ}ƒXƒN‚ªˆÙ‚È"
		"‚Á‚Ä‚¢‚Ü‚·BÅ‘åƒTƒCƒY 1 bit ‚Ìƒ}ƒXƒN‚ğ "
		"8 bit ‚Ìƒ}ƒXƒN‚©‚çÄ¶¬‚µ‚Ü‚·‚©H ",
		/* [8] */
		"‚Í‚¢",
		/* [9] */
		"‚¢‚¢‚¦"
...
resource 'STR#' (203, "-Editor Balloon Help", purgeable) {
	{	/* array StringArray: 24 elements */
		...
		"•¶š•`‰æƒc[ƒ‹ (T)",
		/* [15] */
		"ƒƒCƒ“‚Ì•ÒW‰æ–Ê‚Å‚·BŒ»İ•ÒW’†‚ÌƒAƒCƒR"
		"ƒ“‚ªŠg‘å‚³‚ê‚Ä•\\¦‚³‚ê‚Ü‚·B",
		/* [16] */
		"Œ»İ‚ÌŠg‘åƒTƒCƒY‚ª‚±‚±‚É•\\¦‚³‚ê‚Ü‚·BŠg"
		"‘åƒTƒCƒY‚ğ•ÏX‚·‚é‚É‚ÍƒAƒCƒRƒ“ƒƒjƒ…[‚©"
		"‚çŠg‘å^k¬‚©‚çs‚È‚¤‚©AƒEƒCƒ“ƒhƒEƒTƒC"
		"ƒYƒ{ƒbƒNƒX‚Å•ÒWƒEƒCƒ“ƒhƒE‚ÌƒTƒCƒY‚ğ•ÏX"
		"‚µ‚Ä‰º‚³‚¢B",
		/* [17] */
		"Œ»İ•ÒW’†‚ÌƒAƒCƒRƒ“‚Ì–¼Ì‚Æ ID ‚ª‚±‚±‚É"
		"•\\¦‚³‚ê‚Ü‚·B‚±‚±‚ğƒNƒŠƒbƒN‚µ‚Ä•\\¦‚³‚ê"
		"‚éƒ_ƒCƒAƒƒO‚ÅƒAƒCƒRƒ“‚Ì–¼Ì‚â ID AŠeí"
		"İ’è‚ğ•ÏX‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B",
		/* [18] */
		"Œ»İ‚Ì‘OŒiF‚Æ”wŒiF‚ª‚±‚±‚É•\\¦‚³‚ê‚Ü‚·"
		"B‚±‚±‚ğƒNƒŠƒbƒN‚·‚é‚ÆF‚ğ•ÏXo—ˆ‚Ü‚·B",
		/* [19] */
		"Œ»İ•ÒW’†‚ÌF[“x‚ÌƒAƒCƒRƒ“‚Ì 3 í—Ş‚Ìƒ"
		"TƒCƒY (48 x 48A32 x 32A16 x16) ‚ÌƒAƒCƒ"
		"Rƒ“‰æ‘œ‚ª‚±‚±‚É•\\¦‚³‚ê‚Ü‚·B‚±‚±‚ğƒNƒŠƒ"
		"bƒN‚·‚é‚Æ•ÒW‚·‚éƒTƒCƒY‚ÌƒAƒCƒRƒ“‚ğ•ÏX‚"
		"Å‚«‚Ü‚·BƒTƒCƒY‚Ìˆá‚¤ƒAƒCƒRƒ“‚ğ©“®“I‚Éƒ"
		"TƒCƒY‚ğ’²®‚µ‚ÄƒRƒs[‚·‚é‚±‚Æ‚ào—ˆ‚Ü‚·"
		"B",
		/* [20] */
		"‚±‚Ìƒ|ƒbƒvƒAƒbƒvƒƒjƒ…[‚ÍƒAƒCƒRƒ“‚ÌF["
		"“x‚ğ•ÏX‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·BƒIƒvƒVƒ‡ƒ“"
		"ƒL[‚ğ‰Ÿ‚µ‚È‚ª‚çAˆá‚¤F[“x‚É•ÏX‚·‚é‚±"
		"‚Æ‚É‚æ‚Á‚ÄŒ»İ‚ÌƒAƒCƒRƒ“‚ğƒRƒs[‚·‚é‚±‚Æ"
		"‚ªo—ˆ‚Ü‚·B",
		/* [21] */
		"Œ»İ•ÒW’†‚ÌF[“x‚ÌƒAƒCƒRƒ“‚Ì 3 í—Ş‚Ìƒ"
		"TƒCƒY (48 x 48A32 x 32A16 x16) ‚Ìƒ}ƒXƒ"
		"N‰æ‘œ‚ª‚±‚±‚É•\\¦‚³‚ê‚Ü‚·B‚±‚±‚ğƒNƒŠƒbƒ"
		"N‚·‚é‚Æ•ÒW‚·‚éƒTƒCƒY‚Ìƒ}ƒXƒN‚ğ•ÏX‚Å‚«‚"
		"Ü‚·BƒTƒCƒY‚Ìˆá‚¤ƒ}ƒXƒN‚ğ©“®“I‚ÉƒTƒCƒY‚"
		"ğ’²®‚µ‚ÄƒRƒs[‚·‚é‚±‚Æ‚ào—ˆ‚Ü‚·B",
		/* [22] */
		"‚±‚Ìƒ|ƒbƒvƒAƒbƒvƒƒjƒ…[‚Íƒ}ƒXƒN‚ÌF[“x"
		"‚ğ•ÏX‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·BƒIƒvƒVƒ‡ƒ“ƒL"
		"[‚ğ‰Ÿ‚µ‚È‚ª‚çAˆá‚¤F[“x‚É•ÏX‚·‚é‚±‚Æ"
		"‚É‚æ‚Á‚ÄŒ»İ‚Ìƒ}ƒXƒN‚ğƒRƒs[‚·‚é‚±‚Æ‚ªo"
		"—ˆ‚Ü‚·B",
		/* [23] */
		"Œ»İ•ÒW’†‚ÌƒAƒCƒRƒ“‚ğƒ}ƒXƒN‚ğ‡¬‚µ‚½ó"
		"‘Ô‚Å2 í—Ş‚Ì”wŒii”’F‚Ì”wŒi‚ÆŒ»İ‚ÌƒfƒX"
		"ƒNƒgƒbƒvƒpƒ^[ƒ“j‚É•\\¦‚³‚ê‚Ü‚·B‚±‚ÌƒA"
		"ƒCƒRƒ“‚ğƒNƒŠƒbƒN‚·‚é‚Æ‘I‘ğ^”ñ‘I‘ğ‚Ì—¼•û"
		"‚Ìó‘Ô‚ÌƒAƒCƒRƒ“‚ğƒvƒŒƒrƒ…[‚·‚é‚±‚Æ‚ªo"
		"—ˆ‚Ü‚·B",
		/* [24] */
		"Œ»İ‚Ì•`‰æƒpƒ^[ƒ“‚ª‚±‚±‚É•\\¦‚³‚ê‚Ü‚·B"
		"‚±‚±‚ğƒNƒŠƒbƒN‚·‚é‚Æ•`‰æƒpƒ^[ƒ“‚ğ•ÏXo"
		"—ˆ‚Ü‚·B"
	}
};
...
resource 'STR#' (204, "-Icon Info Balloon Help", purgeable) {
	{	/* array StringArray: 11 elements */
		...
		"‚ÄAƒƒ‚ƒŠ“à‚É“Ç‚İ‚ñ‚¾‚Éƒƒ‚ƒŠ—Ìˆæ‚ğ"
		"ˆÚ“®‚Å‚«‚È‚­‚È‚è‚Ü‚·B",
		/* [9] */
...
resource 'STR#' (300, "Icon Browser: Strings", purgeable) {
	{	/* array StringArray: 6 elements */
		...
		/* [3] */
		"IDF<ID> TypeF<type> ƒtƒ@ƒ~ƒŠ[",
		/* [4] */
		"IDF<ID> NameFg<name>h TypeF<type> ƒ"
		"tƒ@ƒ~ƒŠ[",
		/* [5] */
		"ƒAƒCƒRƒ“í•ÊF <types>",
		/* [6] */
...
resource 'STR#' (130, "-Prompts", purgeable) {
	{	/* array StringArray: 10 elements */
		...
		"‚³‚¢B",
		/* [4] */
		"ƒAƒCƒRƒ“‚ğ‘}“ü‚·‚éƒtƒ@ƒCƒ‹‚©ƒtƒHƒ‹ƒ_‚ğw"
		"’è‚µ‚Ä‰º‚³‚¢B",
		/* [5] */
		"ƒAƒCƒRƒ“‚ğ‘}“ü",
		/* [6] */
...
resource 'STR#' (150, "-App Balloon Help", purgeable) {
	{	/* array StringArray: 1 elements */
		/* [1] */
		"Iconographer\n\n‚±‚ÌƒAƒvƒŠƒP[ƒVƒ‡ƒ“‚Åƒtƒ@"
		"ƒCƒ‹‚âƒtƒHƒ‹ƒ_‚ÌƒAƒCƒRƒ“‚ğ•ÒW‚·‚é‚±‚Æ‚ª"
		"o—ˆ‚Ü‚·B•ÒW‚·‚éƒAƒCƒRƒ“‚ÌŠÜ‚Ü‚ê‚½ƒtƒ@"
		"ƒCƒ‹‚ğ‚±‚ÌƒAƒCƒRƒ“‚Éƒhƒ‰ƒbƒOƒAƒ“ƒhƒhƒƒb"
		"ƒv‚µ‚Ä‰º‚³‚¢B"
	}
};
...
resource 'STR#' (151, "-Apple Menu Balloon Help", purgeable) {
	{	/* array StringArray: 4 elements */
		...
		"ğÏ‚Ü‚¹‚é‚ÆƒVƒFƒAƒEƒFƒA—¿‹àx•¥‚¢Ã‘£ƒƒ"
...
resource 'STR#' (152, "-File Balloon Help", purgeable) {
	{	/* array StringArray: 16 elements */
		...
		/* [6] */
		"ƒAƒCƒRƒ“‚ğ•ÒWƒEƒCƒ“ƒhƒE‚ÉŠJ‚«‚Ü‚·B\n\n‚±"
		"‚êˆÈã•ÒWƒEƒCƒ“ƒhƒE‚ğì¬‚Å‚«‚È‚¢‚Ì‚Å‘I"
		"‘ğo—ˆ‚Ü‚¹‚ñB",
		/* [7] */
...
resource 'STR#' (156, "-Paste Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		...
		"‚«‚³‚É‡‚í‚¹‚Ä“]‘—‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B",
		/* [4] */
		"ƒNƒŠƒbƒvƒ{[ƒh‚Ì“à—e‚ğŒ»İ‚Ì‚Ì‘I‘ğ”ÍˆÍ‚Ì"
		"‘å‚«‚³‚É‡‚í‚¹‚Ä“]‘—‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B"
		"\n\n‰½‚à‘I‘ğ”ÍˆÍ‚ª‚È‚¢‚Ì‚Å‘I‘ğo—ˆ‚Ü‚¹‚ñB",
		/* [5] */
		"Œ»İ•ÒW’†‚ÌƒAƒCƒRƒ“‚ÌƒAƒCƒRƒ“ƒtƒ@ƒ~ƒŠ["
		"‚·‚×‚Ä‚É“]‘—‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B",
		/* [6] */
		"Œ»İ•ÒW’†‚ÌƒAƒCƒRƒ“‚ÌƒAƒCƒRƒ“ƒtƒ@ƒ~ƒŠ["
		"‚·‚×‚Ä‚É“]‘—‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B\n\nƒNƒŠƒb"
		"ƒvƒ{[ƒh‚Ì“à—e‚ÉƒAƒCƒRƒ“ƒtƒ@ƒ~ƒŠ[‚ªŠÜ‚Ü"
...
resource 'STR#' (129, "-Standard Errors", purgeable) {
	{	/* array StringArray: 15 elements */
		...
		"‚Í1999”N9Œ1“ú‚Åg—pŠúŒÀ‚ªØ‚ê‚Ä‚¢‚Ü‚·B"
		"V‚µ‚¢ƒo[ƒWƒ‡ƒ“‚ğƒ_ƒEƒ“ƒ[ƒh‚µ‚Ä‰º‚³‚¢"
		"B",
		/* [3] */
		...
		"‚½B<app name> ‚ÌƒŠƒ\\[ƒX‚ÉáŠQ‚ª”­¶‚·‚"
		"é‰Â”\\«‚ª‚ ‚é‚Ì‚ÅƒCƒ“ƒXƒg[ƒ‹‚µ‚È‚¨‚µ‚Ä‰"
		"º‚³‚¢B",
		/* [8] */
		...
		" ‚è‚Ü‚·BMacOS 8.0 ˆÈ~‚ÌƒVƒXƒeƒ€ƒƒtƒgƒE"
		"ƒFƒA‚©AƒAƒsƒAƒ‰ƒ“ƒXƒ}ƒl[ƒWƒƒ‚ğƒCƒ“ƒXƒg"
		"[ƒ‹‚µ‚Ä‰º‚³‚¢BƒAƒbƒvƒ‹’ñ‹Ÿ‚Ì Manager S"
		"DK"
	}
};
...
resource 'STR#' (162, "Windows Balloon Help", purgeable) {
	{	/* array StringArray: 3 elements */
		...
		"g—po—ˆ‚Ü‚¹‚ñB",
		/* [3] */
		"F‘I‘ğ‚Ì‚½‚ß‚ÌŠeí‹@”‚ğŠÜ‚Şƒtƒ[ƒeƒBƒ“ƒ"
		"OƒEƒCƒ“ƒhƒE‚Ì•¦^”ñ•¦‚ğØ‚è‘Ö‚¦‚é‚½‚ß‚"
		"Ég—p‚µ‚Ü‚·B"
	}
};
...
resource 'STR#' (270, "Colors Palette: HSV Picker: Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		/* [1] */
		"F‡‚¢-ƒXƒ‰ƒCƒ_[F Œ»İ‚ÌF‚ÌF‡‚¢‚ğ§"
		"Œä‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·B‘S‘Ì“I‚ÈF‚Ìí—Ş"
		"‚ğİ’è‚µ‚Ü‚·B\n\ng—p•s‰Â‚Ìê‡A‚Ü‚¸‚»‚Ì"
		"’l‚ğ‘‚â‚·•K—v‚ª‚ ‚è‚Ü‚·B",
		/* [2] */
		"F‡‚¢-ƒvƒŒƒrƒ…[FF‡‚¢-ƒXƒ‰ƒCƒ_[‚É‚æ"
		"‚éF‡‚¢‚Ì•ÏXŒ‹‰Ê‚ÌŒ©–{‚ğ•¦‚µ‚Ü‚·B",
		/* [3] */
		...
		/* [5] */
		"’l-ƒXƒ‰ƒCƒ_[FŒ»İ‚ÌF‚Ì’l‚Ì‹­“x‚ğ§Œä‚"
		"·‚é‚½‚ß‚Ég—p‚µ‚Ü‚·B’l‚ÍF‚Ì–¾‚é‚³‚ğİ’"
		"è‚µ‚Ü‚·B",
		/* [6] */
		"’l-ƒvƒŒƒrƒ…[F’l-ƒXƒ‰ƒCƒ_[‚É‚æ‚é’l‚Ì•Ï"
		"XŒ‹‰Ê‚ÌŒ©–{‚ğ•¦‚µ‚Ü‚·B"
	}
};
...
resource 'STR#' (290, "Colors Palette: Favorites Picker: Baloon Help", purgeable) {
	{	/* array StringArray: 1 elements */
		/* [1] */
		"‚ ‚È‚½‚ÌD‚«‚ÈF‚ğ’u‚¢‚Ä‚¨‚«A‚ ‚Æ‚Åg—p"
		"‚µ‚½‚è‚·‚é‚±‚Æ‚ªo—ˆ‚éƒpƒŒƒbƒg‚Å‚·BƒpƒŒ"
		"ƒbƒg‚Ì‹ó‚¢‚Ä‚¢‚é•”•ª‚Éƒ}ƒEƒX‚ğˆÚ“®‚µƒoƒP"
		"ƒcƒAƒCƒRƒ“‚É‚È‚Á‚½‚çƒNƒŠƒbƒN‚·‚ê‚Î‚»‚±‚Ö"
		"•Û‘¶‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·BF‚ğíœ‚·‚éê‡"
		"‚É‚ÍAƒRƒ}ƒ“ƒh‚ğ‰Ÿ‚µ‚È‚ª‚ç‘I‘ğ‚µA‚Í‚³‚İ"
		"ƒAƒCƒRƒ“‚É‚È‚Á‚"
	}
};
...
resource 'STR#' (250, "Colors Palette: Balloon Help", purgeable) {
	{	/* array StringArray: 4 elements */
		...
		"B‘I‘ğ˜g‚ª•¦‚³‚ê‚Ä‚¢‚é•”•ª‚ªŒ»İ•ÒW’†‚Ì"
		"F‚Å‚·B‘¼‚Ì˜g‚ğƒNƒŠƒbƒN‚·‚é‚±‚Æ‚Å‘¼‚ÌF"
		"‚ğ•ÒW‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚·B",
		/* [2] */
		"‚±‚ê‚ç‚Ìƒ^ƒu‚ÍA‚¢‚­‚Â‚©‚ÌFŒ©–{‚ğ‘I‘ğ‚·"
		"‚é‚½‚ß‚Ég—p‚µ‚Ü‚·BF Ô^—Î^ÂAF‡‚"
		"¢^Ê“x^’lAƒVƒXƒeƒ€ƒpƒŒƒbƒgA‚¨‹C‚É“ü‚"
		"èƒpƒŒƒbƒg‚È‚Ç",
		/* [3] */
		"Œ»İ•ÒW’†‚Ì‰æ‘œ“à‚Å‚ÌƒJ[ƒƒ‹‚ÌˆÊ’uî•ñ‚"
		"ğ•¦‚µ‚Ü‚·B",
		/* [4] */
		"Œ»İ•ÒW’†‚Ì‰æ‘œ“à‚Å‚ÌƒJ[ƒƒ‹‚ÌˆÊ’u‚ÌF"
		"î•ñ‚ğ•¦‚µ‚Ü‚·B"
	}
};
...
resource 'vers' (1) {
	...
	14,
	"1.1J",
	"1.1 “ú–{Œê”Å ı1998-2000 Mihai Parparita\n"
...
data 'cicn' (200, "Swap Fore/Back Colors Enabled") {
	...
	$"0001 0001 0001 0000 0000 0000 008E 0000"            /* ............... */
...
data 'cicn' (202, "Reset Fore/Back Colors Enabled") {
	...
	$"0000 0000 0000 0002 0000 0000 000A 000A"            /* ................ */
	$"0000 0000 0002 0000 0000 000A 000A 0000"            /* ................ */
	$"0000 FE00 FE00 FFC0 FFC0 FFC0 FFC0 FFC0"            /* ..ş.ş.ÿÀÿÀÿÀÿÀÿÀ */
	$"3FC0 3FC0 3FC0 FE00 FE00 FFC0 FE40 FE40"            /* ?À?À?Àş.ş.ÿÀş@ş@ */
	$"FE40 FE40 2040 2040 3FC0 0001 1B6D 0000"            /* ş@ş@ @ @?À...m.. */
	$"0001 0000 FFFF FFFF FFFF 0001 0000 0000"            /* ....ÿÿÿÿÿÿ...... */
	$"0000 FE00 FE00 FFC0 FE40 FE40 FE40 FE40"            /* ..ş.ş.ÿÀş@ş@ş@ş@ */
	$"2040 2040 3FC0"                                     /*  @ @?À */
};
...
data 'cicn' (203, "Reset Fore/Back Colors Disabled") {
	...
	$"1540 2A80 1540 FE00 FE00 FFC0 FE40 FE40"            /* .@*€.@ş.ş.ÿÀş@ş@ */
	$"FE40 FE40 2040 2040 3FC0 0001 1F19 0000"            /* ş@ş@ @ @?À...... */
	$"0001 0000 FFFF FFFF FFFF 0001 0000 0000"            /* ....ÿÿÿÿÿÿ...... */
	$"0000 FE00 FE00 FFC0 FE40 FE40 FE40 FE40"            /* ..ş.ş.ÿÀş@ş@ş@ş@ */
	$"2040 2040 3FC0"                                     /*  @ @?À */
};
...
data 'crsr' (130, "Bucket") {
	...
	$"108E 2147 4087 800F 8017 4027 2047 1086"            /* .!G@‡€.€.@' G.† */
	$"0904 0600 0700 0880 0980 0BC0 0FE0 0FF0"            /* .......€.€.À.à.ğ */
	$"1FF8 3FFC 7FFC FFF8 FFF0 7FE0 3FC0 1F80"            /* .ø?ü.üÿøÿğ.à?À.€ */
	$"0F00 0600 000E 000D 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 8002 0000 0000 0010 0010 0000"            /* ....€........... */
	$"0000 0000 0000 0048 0000 0048 0000 0000"            /* .......H...H.... */
	$"0001 0001 0001 0000 0000 0000 00B2 0000"            /* .............².. */
	$"0000 0700 0880 0980 0AC0 0CB0 089C 108E"            /* .....€.€.À.°.œ. */
...
data 'crsr' (132, "Marquee") {
	...
	$"0100 FFFE 0100 0100 0100 0100 0100 0100"            /* ..ÿş............ */
	...
	$"FFFE 0100 0100 0100 0100 0100 0100 0100"            /* ÿş.............. */
...
data 'crsr' (204, "Magic Wand Additive") {
	...
	$"1000 0000 1000 5400 3800 FE00 3800 5400"            /* ......T.8.ş.8.T. */
	$"1100 0380 01C0 00E0 0070 0038 001C 0008"            /* ...€.À.à.p.8.... */
	$"0000 0000 0003 0003 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 8002 0000 0000 0010 0010 0000"            /* ....€........... */
	$"0000 0000 0000 0048 0000 0048 0000 0000"            /* .......H...H.... */
...
data 'crsr' (201, "Marquee Subtractive") {
	$"8001 0000 0060 0000 0092 0000 0000 0000"            /* €....`...’...... */
	$"0000 0000 0100 0100 0100 0100 0100 0100"            /* ................ */
	$"0100 FFFE 0100 0100 0100 0100 0100 011F"            /* ..ÿş............ */
	$"0100 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0007 0007 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 8002 0000 0000 0010 0010 0000"            /* ....€........... */
	...
	$"0001 0001 0001 0000 0000 0000 00B2 0000"            /* .............².. */
	$"0000 0100 0100 0100 0100 0100 0100 0100"            /* ................ */
	$"FFFE 0100 0100 0100 0100 0100 011F 0100"            /* ÿş.............. */
...
data 'crsr' (200, "Marquee Additive") {
	$"8001 0000 0060 0000 0092 0000 0000 0000"            /* €....`...’...... */
	$"0000 0000 0100 0100 0100 0100 0100 0100"            /* ................ */
	$"0100 FFFE 0100 0100 0100 0104 0104 011F"            /* ..ÿş............ */
	...
	$"0001 0001 0001 0000 0000 0000 00B2 0000"            /* .............².. */
	$"0000 0100 0100 0100 0100 0100 0100 0100"            /* ................ */
	$"FFFE 0100 0100 0100 0104 0104 011F 0104"            /* ÿş.............. */
...
data 'hrct' (1001, "Icon Info", purgeable) {
	...
	$"0000 0000 002A 0040 003A 00FE 00CC 0005"            /* .....*.@.:.ş.Ì.. */
	$"0014 0003 0000 0000 005A 000E 006A 007C"            /* .........Z...j.| */
	$"00CC 0006 0014 0003 0000 0000 006C 000E"            /* .Ì...........l.. */
	$"007C 007C 00CC 0007 0014 0003 0000 0000"            /* .|.|.Ì.......... */
...
data 'PROC' (128, "Find_icon 3.1 fat") {
	...
	$"4EFA 00F2 41FA FFD6 D1FC 0000 1FB7 2008"            /* Nú.òAúÿÖÑü...· . */
	...
	$"0003 2417 E58A E282 DDB1 2800 5385 4A85"            /* ..$.åŠâ‚İ±(.S…J… */
	...
	$"41FA FEFA D1FC 0000 1BD2 2008 A055 C18C"            /* AúşúÑü...Ò . UÁŒ */
	$"4E75 4E75 4E56 FF2E 48E7 1E30 246E 0014"            /* NuNuNVÿ.Hç.0$n.. */
	$"266E 0010 2A2E 000C 282E 0008 7600 4EBA"            /* &n..*...(...v.Nº */
	$"FFD0 2C00 2044 4290 200A 6712 3F12 4EBA"            /* ÿĞ,. DB .g.?.Nº */
	$"0B48 4A00 544F 6706 76CB 6000 0116 200B"            /* .HJ.TOg.vË`... . */
	...
	$"00E2 47EE FF94 6026 206B 0012 7000 1010"            /* .âGîÿ”`& k..p... */
	$"5240 48C0 206B 0012 43EE FF54 A22E 2D6B"            /* R@HÀ k..CîÿT¢.-k */
	$"0064 FF50 3D6B 0016 FF4E 45EE FF4E 2044"            /* .dÿP=k..ÿNEîÿN D */
	$"4A90 6600 008C 102B 001E 0240 0010 662E"            /* Jf..Œ.+...@..f. */
	$"302B 0028 0240 0400 6712 2F04 2F05 2F0A"            /* 0+.(.@..g./././. */
	$"4EBA 02C6 3600 4FEF 000C 6064 2F04 2F05"            /* Nº.Æ6.Oï..`d/./. */
	$"2F0B 4EBA 0104 3600 4FEF 000C 6052 302B"            /* /.Nº..6.Oï..`R0+ */
	$"0028 0240 0400 6716 2F04 2F05 2F2B 0030"            /* .(.@..g./././+.0 */
	$"3F12 4EBA 0578 4A40 4FEF 000E 6732 7002"            /* ?.Nº.xJ@Oï..g2p. */
	$"B0AB 0030 661A 3F12 4EBA 0AB6 4A00 544F"            /* °«.0f.?.Nº.¶J.TO */
	$"670E 2F04 3F12 4EBA 05BE 3600 5C4F 6010"            /* g./.?.Nº.¾6.\O`. */
	$"2F04 2F05 2F0B 4EBA 0372 3600 4FEF 000C"            /* /././.Nº.r6.Oï.. */
	$"2044 4A90 6730 554F 2044 2F10 302B 0028"            /*  DJg0UO D/.0+.( */
	$"0240 000E E248 3F00 303C 0316 ABC9 301F"            /* .@..âH?.0<..«É0. */
	$"6014 7001 B0AA 0002 660C 2F04 3F12 4EBA"            /* `.p.°ª..f./.?.Nº */
	$"0576 3600 5C4F 2006 C18C 3F43 0102 4CDF"            /* .v6.\O .ÁŒ?C..Lß */
	$"0C78 4E5E 205F 4FEF 0010 4ED0 846D 6169"            /* .xN^ _Oï..NĞ„mai */
	$"6E00 0000 4E56 FFBA 2F04 2F03 41EE FFBA"            /* n...NVÿº/./.Aîÿº */
	$"2D48 FFEE 7014 2D40 FFF2 3D6E 0008 FFE4"            /* -Hÿîp.-@ÿò=n..ÿä */
	$"42AE FFE0 41EE FFCE 7030 A260 3800 7601"            /* B®ÿàAîÿÎp0¢`8.v. */
	$"4A44 6608 4AAE FFC4 6702 7600 1003 261F"            /* JDf.J®ÿÄg.v...&. */
	$"281F 4E5E 4E75 8F49 735F 6C6F 6361 6C5F"            /* (.N^NuIs_local_ */
	$"766F 6C75 6D65 0000 4E56 FFB2 48E7 1F30"            /* volume..NVÿ²Hç.0 */
	$"266E 0008 2A2E 000C 246E 0010 282B 0020"            /* &n..*...$n..(+.  */
	$"2C2B 0024 2F05 2F06 2F04 4EBA 0DF4 2488"            /* ,+.$/././.Nº.ô$ˆ */
	$"4FEF 000C 6706 7000 6000 015E 486E FFBB"            /* Oï..g.p.`..^Hnÿ» */
	$"2F04 4EBA 05DE 3D40 FFBC A994 301F 3D40"            /* /.Nº.Ş=@ÿ¼©”0.=@ */
	$"FFB8 0C2E 0001 FFBB 5C4F 666E 554F 3F3C"            /* ÿ¸....ÿ»\OfnUO?< */
	$"8000 2F3C 6D61 6373 4227 486E FFB6 486E"            /* €./<macsB'Hnÿ¶Hn */
	$"FFB2 7000 A823 301F 4227 A99B 554F 3F2E"            /* ÿ²p.¨#0.B'©›UO?. */
	$"FFB6 2F2E FFB2 4878 02E0 1F3C 0001 A81A"            /* ÿ¶/.ÿ²Hx.à.<..¨. */
	$"301F 3E00 1F3C 0001 A99B 0C47 FFFF 660C"            /* 0.>..<..©›.Gÿÿf. */
	$"554F A9AF 301F 3600 6000 00CE 554F 2F0A"            /* UO©¯0.6.`..ÎUO/. */
	$"3F2E FFBC 2F05 1F3C 0001 4EBA 0650 301F"            /* ?.ÿ¼/..<..Nº.P0. */
	$"3600 3F07 A99A 6000 00B0 0C84 6164 7270"            /* 6.?.©š`..°.„adrp */
	$"6606 283C 4150 504C 3D6B 0016 FFBE 554F"            /* f.(<APPL=k..ÿ¾UO */
	$"3F2E FFBE 2F05 2F06 2F04 2F0A 4EBA 0AB6"            /* ?.ÿ¾/./././.Nº.¶ */
	$"301F 3600 674A 42AE FFD2 3D7C 0001 FFDC"            /* 0.6.gJB®ÿÒ=|..ÿÜ */
	$"6034 302E FFD6 B06E FFBE 6726 3F2E FFD6"            /* `40.ÿÖ°nÿ¾g&?.ÿÖ */
	$"4EBA FEA2 4A00 544F 6718 554F 3F2E FFD6"            /* Nºş¢J.TOg.UO?.ÿÖ */
	$"2F05 2F06 2F04 2F0A 4EBA 0A7A 301F 3600"            /* /./././.Nº.z0.6. */
	$"670E 526E FFDC 41EE FFC0 A007 4A40 67C2"            /* g.RnÿÜAîÿÀ .J@gÂ */
	$"4A43 6734 4267 A998 554F 2F0A 3F2E FFBC"            /* JCg4Bg©˜UO/.?.ÿ¼ */
	$"2F05 1F3C 0001 4EBA 05B4 301F 3600 4A92"            /* /..<..Nº.´0.6.J’ */
	$"6616 554F 2F0A 3F3C F060 2F05 1F3C 0001"            /* f.UO/.?<ğ`/..<.. */
	$"4EBA 059A 301F 3600 3F2E FFB8 A998 4A43"            /* Nº.š0.6.?.ÿ¸©˜JC */
	$"6614 4A92 6710 2F12 2F05 2F06 2F04 4EBA"            /* f.J’g././././.Nº */
	$"0D42 4FEF 0010 3003 4CDF 0CF8 4E5E 4E75"            /* .BOï..0.Lß.øN^Nu */
	$"9447 6574 5F6E 6F72 6D61 6C5F 6669 6C65"            /* ”Get_normal_file */
	$"5F69 636F 6E00 0000 4E56 0000 48E7 1E20"            /* _icon...NV..Hç.  */
	$"2C2E 000C 246E 0010 554F A994 301F 3A00"            /* ,...$n..UO©”0.:. */
	$"4227 A99B 554F 2F2E 0008 1F3C 0001 700D"            /* B'©›UO/....<..p. */
	$"AA52 301F 3800 1F3C 0001 A99B 0C44 FFFF"            /* ªR0.8..<..©›.Dÿÿ */
	$"660A 554F A9AF 301F 3600 603A 554F 2F0A"            /* f.UO©¯0.6.`:UO/. */
	$"3F3C BFB9 2F06 1F3C 0001 4EBA 0500 301F"            /* ?<¿¹/..<..Nº..0. */
	$"3600 0C43 FC18 6616 554F 2F0A 3F3C BF90"            /* 6..Cü.f.UO/.?<¿ */
	$"2F06 1F3C 0001 4EBA 04E4 301F 3600 3F04"            /* /..<..Nº.ä0.6.?. */
	$"A99A 3F05 A998 3003 4CDF 0478 4E5E 4E75"            /* ©š?.©˜0.Lß.xN^Nu */
	$"9447 6574 5F63 7573 746F 6D5F 6669 6C65"            /* ”Get_custom_file */
	$"5F69 636F 6E00 0000 4E56 FFFE 48E7 1C20"            /* _icon...NVÿşHç.  */
	$"3A2E 0008 282E 000A 246E 000E 7600 42A7"            /* :...(...$n..v.B§ */
	$"3045 2F08 2F04 4EBA 0BA8 2488 4FEF 000C"            /* 0E/./.Nº.¨$ˆOï.. */
	$"662E 554F 3F05 2F04 4227 486E FFFE 2F0A"            /* f.UO?./.B'Hnÿş/. */
	$"7000 A823 301F 3600 6704 4292 6012 2F12"            /* p.¨#0.6.g.B’`./. */
	$"42A7 3045 2F08 2F04 4EBA 0C28 4FEF 0010"            /* B§0E/./.Nº.(Oï.. */
	$"3003 4CDF 0438 4E5E 4E75 8C4D 7946 696E"            /* 0.Lß.8N^NuŒMyFin */
	$"6446 6F6C 6465 7200 0000 4E56 FFF4 48E7"            /* dFolder...NVÿôHç */
	$"1F30 246E 0008 266E 0010 2C2A 0030 3D6A"            /* .0$n..&n..,*.0=j */
	$"0016 FFFA 3A3C F061 486E FFF6 2F3C 6D61"            /* ..ÿú:<ğaHnÿö/<ma */
	$"6373 3F2E FFFA 4EBA FF60 4A40 4FEF 000A"            /* cs?.ÿúNºÿ`J@Oï.. */
	$"660E BCAE FFF6 6608 3A3C F071 6000 00E0"            /* f.¼®ÿöf.:<ğq`..à */
	$"7002 B0AA 0064 664A 7E05 7600 603C 486E"            /* p.°ª.dfJ~.v.`<Hn */
	$"FFFC 3043 2008 E788 41EC 0224 2F30 0800"            /* ÿü0C .çˆAì.$/0.. */
	$"3F2E FFFA 4EBA FF22 3800 4FEF 000A 6618"            /* ?.ÿúNºÿ"8.Oï..f. */
	$"BCAE FFFC 6612 3043 2A08 E78D 41EC 0224"            /* ¼®ÿüf.0C*.çAì.$ */
	$"2A30 5804 6000 0098 5243 B647 6DC0 6000"            /* *0X.`..˜RC¶GmÀ`. */
	$"008E 202E FFF6 B0AA 0064 6646 7E1A 7600"            /* . .ÿö°ª.dfF~.v. */
	$"603A 486E FFFC 3043 2008 E788 41EC 0154"            /* `:Hnÿü0C .çˆAì.T */
	$"2F30 0800 3F2E FFFA 4EBA FECE 3800 4FEF"            /* /0..?.ÿúNºşÎ8.Oï */
	$"000A 6616 BCAE FFFC 6610 3043 2A08 E78D"            /* ..f.¼®ÿüf.0C*.ç */
	$"41EC 0154 2A30 5804 6044 5243 B647 6DC2"            /* Aì.T*0X.`DRC¶GmÂ */
	$"603C 7001 B0AA 0064 6606 3A3C F07C 602E"            /* `<p.°ª.df.:<ğ|`. */
	$"102A 001E 0240 0008 6706 3A3C F077 601E"            /* .*...@..g.:<ğw`. */
	$"102A 001E 0240 0020 6706 3A3C F076 600E"            /* .*...@. g.:<ğv`. */
	$"102A 001E 0240 0004 6704 3A3C F074 2F2E"            /* .*...@..g.:<ğt/. */
	$"000C 2F3C 6630 6C64 3045 2F08 4EBA 0A22"            /* ../<f0ld0E/.Nº." */
	$"2688 4FEF 000C 6704 7800 606C 554F A994"            /* &ˆOï..g.x.`lUO©” */
	$"301F 3D40 FFF4 4267 A998 554F 2F0B 3F05"            /* 0.=@ÿôBg©˜UO/.?. */
	$"2F2E 000C 1F3C 0002 4EBA 02E2 301F 3800"            /* /....<..Nº.â0.8. */
	$"6720 0C45 F061 671A 3A3C F061 554F 2F0B"            /* g .Eğag.:<ğaUO/. */
	$"3F05 2F2E 000C 1F3C 0002 4EBA 02C0 301F"            /* ?./....<..Nº.À0. */
	$"3800 3F2E FFF4 A998 4A44 661C 4A93 6718"            /* 8.?.ÿô©˜JDf.J“g. */
	$"2F13 2F2E 000C 2F3C 6630 6C64 3045 2F08"            /* /./.../<f0ld0E/. */
	$"4EBA 0A60 4FEF 0010 3004 4CDF 0CF8 4E5E"            /* Nº.`Oï..0.Lß.øN^ */
	$"4E75 9647 6574 5F6E 6F72 6D61 6C5F 666F"            /* Nu–Get_normal_fo */
	$"6C64 6572 5F69 636F 6E00 0000 4E56 FFBA"            /* lder_icon...NVÿº */
	$"2F03 4A2C 0134 660A 486C 0134 4EBA 042A"            /* /.J,.4f.Hl.4Nº.* */
	$"584F 554F 3F2E 0008 2F2E 000A 486C 0134"            /* XOUO?.../...Hl.4 */
	$"486E FFBA 7001 AA52 301F 3600 6616 2F2E"            /* Hnÿºp.ªR0.6.f./. */
	$"0012 2F2E 000E 486E FFBA 4EBA FCDC 3600"            /* ../...HnÿºNºüÜ6. */
	$"4FEF 000C 3003 261F 4E5E 4E75 9647 6574"            /* Oï..0.&.N^Nu–Get */
	$"5F63 7573 746F 6D5F 666F 6C64 6572 5F69"            /* _custom_folder_i */
	$"636F 6E00 0000 4E56 FE32 48E7 1830 266E"            /* con...NVş2Hç.0&n */
	$"000A 4293 42AE FF98 3D6E 0008 FF9C 426E"            /* ..B“B®ÿ˜=n..ÿœBn */
	$"FFA2 41EE FF86 A207 3600 6600 00DA 554F"            /* ÿ¢Aîÿ†¢.6.f..ÚUO */
	$"3F2E FFCA 486E FE32 4EBA 1342 301F 3600"            /* ?.ÿÊHnş2Nº.B0.6. */
	$"6600 00C4 554F 486E FE32 486C 012E 1F3C"            /* f..ÄUOHnş2Hl...< */
	$"0001 4227 4EBA 0B36 101F 672C 554F A994"            /* ..B'Nº.6..g,UO©” */
	$"301F 3800 4267 A998 554F 2F0B 3F3C F062"            /* 0.8.Bg©˜UO/.?<ğb */
	$"4878 FFFF 1F3C 0001 4EBA 0192 301F 3600"            /* Hxÿÿ.<..Nº.’0.6. */
	$"3F04 A998 6000 0080 3D6E FFCA FF4E 3D6E"            /* ?.©˜`..€=nÿÊÿN=n */
	$"FFC8 FF4C 45EE FF36 45EA 001C 4292 3D7C"            /* ÿÈÿLEîÿ6Eê..B’=| */
	$"0016 FF50 41EE FF36 A004 3600 6604 4A92"            /* ..ÿPAîÿ6 .6.f.J’ */
	$"6E0E 3D7C 0015 FF50 41EE FF36 A004 3600"            /* n.=|..ÿPAîÿ6 .6. */
	$"4A43 6642 4A92 6F3E 554F 2F0B 303C 0207"            /* JCfBJ’o>UO/.0<.. */
	$"ABC9 301F 3600 662E 554F 2F12 486E FF32"            /* «É0.6.f.UO/.Hnÿ2 */
	$"4878 0100 4EBA 0B16 301F 3600 6618 554F"            /* Hx..Nº..0.6.f.UO */
	$"2F2E FF32 2F13 2F3C 4943 4E23 303C 0608"            /* /.ÿ2/./<ICN#0<.. */
	$"ABC9 301F 3600 3003 4CDF 0C18 4E5E 4E75"            /* «É0.6.0.Lß..N^Nu */
	$"8F47 6574 5F76 6F6C 756D 655F 6963 6F6E"            /* Get_volume_icon */
	$"0000 4E56 FFFC 48E7 1F20 2A2E 0008 246E"            /* ..NVÿüHç. *...$n */
	$"000C 383C F060 14BC 0002 203C 6170 7072"            /* ..8<ğ`.¼.. <appr */
	$"43EE FFFC A1AD 2288 3E00 6638 7001 C0AE"            /* Cîÿü¡­"ˆ>.f8p.À® */
	$"FFFC 6730 7C0B 3606 5343 6022 3043 2008"            /* ÿüg0|.6.SC`"0C . */
	$"E788 41EC 0006 BAB0 0800 6610 3043 2808"            /* çˆAì..º°..f.0C(. */
	$"E78C 41EC 0006 2830 4804 603A 5343 4A43"            /* çŒAì..(0H.`:SCJC */
	$"6CDA 6032 7C07 3606 5343 6026 3043 2008"            /* lÚ`2|.6.SC`&0C . */
	$"E788 41EC 005E BAB0 0800 6614 3043 2808"            /* çˆAì.^º°..f.0C(. */
	$"E78C 41EC 005E 2830 4804 14BC 0001 6006"            /* çŒAì.^(0H..¼..`. */
	$"5343 4A43 6CD6 0C44 F060 662E 7C13 3606"            /* SCJClÖ.Dğ`f.|.6. */
	$"5343 6022 3043 2008 E788 41EC 0096 BAB0"            /* SC`"0C .çˆAì.–º° */
	$"0800 6610 3043 2808 E78C 41EC 0096 2830"            /* ..f.0C(.çŒAì.–(0 */
	$"4804 6006 5343 4A43 6CDA 3004 4CDF 04F8"            /* H.`.SCJClÚ0.Lß.ø */
	$"4E5E 4E75 9446 696E 645F 6765 6E65 7269"            /* N^Nu”Find_generi */
	$"635F 6963 6F6E 5F69 6400 0000 4E56 FFF2"            /* c_icon_id...NVÿò */
	$"48E7 1030 246E 0010 486E FFF6 486E FFF2"            /* Hç.0$n..HnÿöHnÿò */
	$"2F2E 000A 4EBA 0574 2F0A 303C 0207 ABC9"            /* /...Nº.t/.0<..«É */
	$"301F 3600 4FEF 000A 6600 0086 3D6E 000E"            /* 0.6.Oï..f..†=n.. */
	$"FFFA 1D7C 0001 FFFC 1D7C 0001 FFFD 1D6E"            /* ÿú.|..ÿü.|..ÿı.n */
	$"0008 FFFE 47FA 008E 554F 2F12 2F2E FFF2"            /* ..ÿşGú.UO/./.ÿò */
	$"2F0B 486E FFFA 303C 080A ABC9 301F 3600"            /* /.Hnÿú0<..«É0.6. */
	$"662A 4AAE FFF6 6724 4A2E FFFC 671E 4A2E"            /* f*J®ÿög$J.ÿüg.J. */
	$"FFFD 6718 554F 2F12 2F2E FFF6 2F0B 486E"            /* ÿıg.UO/./.ÿö/.Hn */
	$"FFFA 303C 080A ABC9 301F 3600 4A43 6620"            /* ÿú0<..«É0.6.JCf  */
	$"4A2E FFFC 671A 4A2E FFFD 6714 363C FC18"            /* J.ÿüg.J.ÿıg.6<ü. */
	$"554F 2F12 4227 303C 0302 ABC9 301F 4292"            /* UO/.B'0<..«É0.B’ */
	$"3F43 002E 4CDF 0C08 4E5E 205F 4FEF 000C"            /* ?C..Lß..N^ _Oï.. */
	$"4ED0 8F46 495F 4745 5449 434F 4E53 5549"            /* NĞFI_GETICONSUI */
	$"5445 0000 4E56 FFFA 48E7 1F30 262E 0010"            /* TE..NVÿúHç.0&... */
	$"266E 000C 246E 0008 7800 7A01 7C00 7E01"            /* &n..$n..x.z.|.~. */
	$"0C83 6963 6C38 670A 0C83 6963 6C34 6702"            /* .ƒicl8g..ƒicl4g. */
	$"7E00 4A47 6708 4A2A 0002 6702 7C01 4A46"            /* ~.JGg.J*..g.|.JF */
	$"6638 426E FFFE 3D7C 0001 FFFC 0C83 6963"            /* f8Bnÿş=|..ÿü.ƒic */
	$"7338 670C 0C83 6963 7334 6704 426E FFFC"            /* s8g..ƒics4g.Bnÿü */
	$"4A6E FFFC 670C 4A2A 0003 6706 3D7C 0001"            /* Jnÿüg.J*..g.=|.. */
	$"FFFE 4A6E FFFE 6602 7A00 1805 665A 0C2A"            /* ÿşJnÿşf.z...fZ.* */
	$"0001 0004 660E 594F 2F03 3F12 A81F 205F"            /* ....f.YO/.?.¨. _ */
	$"2688 600C 594F 2F03 3F12 A9A0 205F 2688"            /* &ˆ`.YO/.?.©  _&ˆ */
	$"4A93 6716 554F 2F0B 4EBA 085C 301F 3D40"            /* J“g.UO/.Nº.\0.=@ */
	$"FFFA 4A6E FFFA 6702 4293 4A93 671A 0C83"            /* ÿúJnÿúg.B“J“g..ƒ */
	$"4943 4E23 6606 422A 0002 600C 0C83 6963"            /* ICN#f.B*..`..ƒic */
	$"7323 6604 422A 0003 426F 0036 4CDF 0CF8"            /* s#f.B*..Bo.6Lß.ø */
	$"4E5E 205F 4FEF 000C 4ED0 8A47 4554 5F31"            /* N^ _Oï..NĞŠGET_1 */
	$"5F49 434F 4E00 0000 4E56 FEFA 48E7 1820"            /* _ICON...NVşúHç.  */
	$"246E 0008 422E FF00 554F A994 301F 3800"            /* $n..B.ÿ.UO©”0.8. */
	$"554F 3F3C 8000 2F3C 6D61 6373 4227 486E"            /* UO?<€./<macsB'Hn */
	$"FEFE 486E FEFA 7000 A823 301F 4227 A99B"            /* şşHnşúp.¨#0.B'©› */
	$"554F 3F2E FEFE 2F2E FEFA 4878 02E0 1F3C"            /* UO?.şş/.şúHx.à.< */
	$"0001 A81A 301F 3600 1F3C 0001 A99B 0C43"            /* ..¨.0.6..<..©›.C */
	$"FFFF 672A 486E FF00 2F3C 0005 2BF2 4EBA"            /* ÿÿg*Hnÿ./<..+òNº */
	$"07D8 4A2E FF00 660E 486E FF00 2F3C 0005"            /* .ØJ.ÿ.f.Hnÿ./<.. */
	$"1194 4EBA 07C4 3F03 A99A 3F04 A998 0C2E"            /* .”Nº.Ä?.©š?.©˜.. */
	$"0020 FF00 641A 4A2E FF00 6714 41EE FF00"            /* . ÿ.d.J.ÿ.g.Aîÿ. */
	$"224A 7000 102E FF00 5240 48C0 A22E 600A"            /* "Jp...ÿ.R@HÀ¢.`. */
	$"41EC 0000 224A 7006 A22E 4CDF 0418 4E5E"            /* Aì.."Jp.¢.Lß..N^ */
	$"4E75 9247 6574 5F69 636F 6E5F 6669 6C65"            /* Nu’Get_icon_file */
	$"5F6E 616D 6500 0000 4E56 FF86 2F04 2F03"            /* _name...NVÿ†/./. */
	$"42AE FF98 3D6E 0008 FF9C 426E FFA2 41EE"            /* B®ÿ˜=n..ÿœBnÿ¢Aî */
	$"FF86 A207 3800 7600 4A44 6608 4A6E FFCA"            /* ÿ†¢.8.v.JDf.JnÿÊ */
	$"6F02 7601 1003 261F 281F 4E5E 4E75 8E49"            /* o.v...&.(.N^NuI */
	$"735F 766F 6C5F 656A 6563 7465 6400 0000"            /* s_vol_ejected... */
	$"4E56 FFBA 2F03 41EE FFBA 2D48 FFEE 7014"            /* NVÿº/.Aîÿº-Hÿîp. */
	$"2D40 FFF2 3D6E 0008 FFE4 42AE FFE0 41EE"            /* -@ÿò=n..ÿäB®ÿàAî */
	$"FFCE 7030 A260 4AAE FFC4 57C0 4400 1600"            /* ÿÎp0¢`J®ÿÄWÀD... */
	$"1003 261F 4E5E 4E75 8F49 735F 6C6F 6361"            /* ..&.N^NuIs_loca */
	$"6C5F 766F 6C75 6D65 0000 4E56 0000 2F03"            /* l_volume..NV../. */
	$"202E 0008 0480 4943 4E23 6722 0480 2020"            /*  ....€ICN#g".€   */
	$"1E11 671E 5980 671E 0480 0000 06EB 671A"            /* ..g.Y€g..€...ëg. */
	$"0480 0000 0011 6716 5980 6716 6018 7601"            /* .€....g.Y€g.`.v. */
	$"6016 7602 6012 7603 600E 7604 600A 7605"            /* `.v.`.v.`.v.`.v. */
	$"6006 7606 6002 7600 3003 261F 4E5E 4E75"            /* `.v.`.v.0.&.N^Nu */
	$"8F52 6573 4963 6F6E 546F 4454 4963 6F6E"            /* ResIconToDTIcon */
	$"0000 4E56 FFF8 48E7 1F20 282E 0010 246E"            /* ..NVÿøHç. (...$n */
	$"0008 7600 7A00 7E01 426E FFFE 3D7C 0001"            /* ..v.z.~.Bnÿş=|.. */
	$"FFFC 0C84 6963 6C38 670C 0C84 6963 6C34"            /* ÿü.„icl8g..„icl4 */
	$"6704 426E FFFC 4A6E FFFC 670C 4A2A 000A"            /* g.BnÿüJnÿüg.J*.. */
	$"6706 3D7C 0001 FFFE 4A6E FFFE 6638 426E"            /* g.=|..ÿşJnÿşf8Bn */
	$"FFFA 3D7C 0001 FFF8 0C84 6963 7338 670C"            /* ÿú=|..ÿø.„ics8g. */
	$"0C84 6963 7334 6704 426E FFF8 4A6E FFF8"            /* .„ics4g.BnÿøJnÿø */
	$"670C 4A2A 000B 6706 3D7C 0001 FFFA 4A6E"            /* g.J*..g.=|..ÿúJn */
	$"FFFA 6602 7E00 1A07 2F04 4EBA FF0E 3C00"            /* ÿúf.~.../.Nºÿ.<. */
	$"57C0 4400 4880 8A00 584F 6646 554F 42A7"            /* WÀD.H€Š.XOfFUOB§ */
	$"3F2A 0008 3F06 2F12 2F2A 0004 2F2E 000C"            /* ?*..?././*...... */
	$"4EBA 0AF0 301F 3600 661A 0C84 4943 4E23"            /* Nº.ğ0.6.f..„ICN# */
	$"6606 422A 000A 600C 0C84 6963 7323 6604"            /* f.B*..`..„ics#f. */
	$"422A 000B 0C43 EC6C 6706 0C43 FFCE 6602"            /* B*...Cìlg..CÿÎf. */
	$"7600 3F43 0034 4CDF 04F8 4E5E 205F 4FEF"            /* v.?C.4Lß.øN^ _Oï */
	$"000C 4ED0 8C41 4444 4F4E 4544 5449 434F"            /* ..NĞŒADDONEDTICO */
	$"4E00 0000 4E56 FFEC 48E7 1030 266E 0008"            /* N...NVÿìHç.0&n.. */
	$"486E FFF0 486E FFEC 2F2E 0014 4EBA 00DC"            /* HnÿğHnÿì/...Nº.Ü */
	$"02AE FF00 FFFF FFEC 02AE FF00 FFFF FFF0"            /* .®ÿ.ÿÿÿì.®ÿ.ÿÿÿğ */
	$"2F0B 303C 0207 ABC9 301F 3600 4FEF 000A"            /* /.0<..«É0.6.Oï.. */
	$"6600 0094 45FA FEBC 200A 6604 7694 6062"            /* f..”Eúş¼ .f.v”`b */
	$"1D7C 0001 FFFE 1D7C 0001 FFFF 2D6E 0010"            /* .|..ÿş.|..ÿÿ-n.. */
	$"FFF4 2D6E 000C FFF8 3D6E 0018 FFFC 554F"            /* ÿô-n..ÿø=n..ÿüUO */
	$"2F13 2F2E FFEC 2F0A 486E FFF4 303C 080A"            /* /./.ÿì/.Hnÿô0<.. */
	$"ABC9 301F 3600 662A 4AAE FFF0 6724 4A2E"            /* «É0.6.f*J®ÿğg$J. */
	$"FFFE 671E 4A2E FFFF 6718 554F 2F13 2F2E"            /* ÿşg.J.ÿÿg.UO/./. */
	$"FFF0 2F0A 486E FFF4 303C 080A ABC9 301F"            /* ÿğ/.Hnÿô0<..«É0. */
	$"3600 4A43 6620 4A2E FFFE 671A 4A2E FFFF"            /* 6.JCf J.ÿşg.J.ÿÿ */
	$"6714 363C FC18 554F 2F13 4227 303C 0302"            /* g.6<ü.UO/.B'0<.. */
	$"ABC9 301F 4293 3F43 003A 4CDF 0C08 4E5E"            /* «É0.B“?C.:Lß..N^ */
	$"205F 4FEF 0012 4ED0 8E44 5447 4554 4943"            /*  _Oï..NĞDTGETIC */
	$"4F4E 5355 4954 4500 0000 4E56 0000 202E"            /* ONSUITE...NV.. . */
	$"0008 226E 000C 206E 0010 0C80 8000 FF00"            /* .."n.. n...€€.ÿ. */
	$"660E 22BC 0000 FF00 20BC 0000 00FF 6030"            /* f."¼..ÿ. ¼...ÿ`0 */
	$"0C80 8000 00FF 660E 22BC 0000 00FF 20BC"            /* .€€..ÿf."¼...ÿ ¼ */
	$"0000 FF00 601A 0C80 8000 0400 660E 22BC"            /* ..ÿ.`..€€...f."¼ */
	$"0000 0500 20BC 0000 00FF 6004 2280 4290"            /* .... ¼...ÿ`."€B */
	$"4E5E 4E75 9245 7870 616E 644D 6574 6153"            /* N^Nu’ExpandMetaS */
	$"656C 6563 746F 7200 0000 4E56 0000 7400"            /* elector...NV..t. */
	$"6052 7014 C1C2 41EC 0250 42B0 0800 7014"            /* `Rp.ÁÂAì.PB°..p. */
	$"C1C2 41EC 0250 42B0 0804 7014 C1C2 41EC"            /* ÁÂAì.PB°..p.ÁÂAì */
	$"0250 42B0 0808 7014 C1C2 41EC 0250 42B0"            /* .PB°..p.ÁÂAì.PB° */
	$"080C 3002 5340 7214 C3C2 41EC 0250 3180"            /* ..0.S@r.ÃÂAì.P1€ */
	$"1810 3002 5240 7214 C3C2 41EC 0250 3180"            /* ..0.R@r.ÃÂAì.P1€ */
	$"1812 5242 0C42 0014 6DA8 397C 0013 024C"            /* ..RB.B..m¨9|...L */
	$"4E5E 4E75 8B46 4949 6E69 7443 6163 6865"            /* N^Nu‹FIInitCache */
	$"0000 4E56 0000 2F03 362E 0008 B66C 024E"            /* ..NV../.6...¶l.N */
	$"6776 7014 C1C3 41EC 0250 7214 C3C3 43EC"            /* gvp.ÁÃAì.Pr.ÃÃCì */
	$"0250 7414 C5F1 1810 43EC 0250 33B0 0812"            /* .Pt.Åñ..Cì.P3°.. */
	$"2812 B66C 024C 6610 7014 C1C3 41EC 0250"            /* (.¶l.Lf.p.ÁÃAì.P */
	$"3970 0810 024C 6020 7014 C1C3 41EC 0250"            /* 9p...L` p.ÁÃAì.P */
	$"7214 C3C3 43EC 0250 7414 C5F1 1812 43EC"            /* r.ÃÃCì.Pt.Åñ..Cì */
	$"0250 33B0 0810 2810 7014 C1C3 41EC 0250"            /* .P3°..(.p.ÁÃAì.P */
	$"31AC 024E 0812 7014 C1EC 024E 41EC 0250"            /* 1¬.N..p.Áì.NAì.P */
	$"3183 0810 3943 024E 261F 4E5E 4E75 8F46"            /* 1ƒ..9C.N&.N^NuF */
	$"494D 616B 6543 656C 6C46 6972 7374 0000"            /* IMakeCellFirst.. */
	$"4E56 FFFC 48E7 1E00 2C2E 0008 2A2E 000C"            /* NVÿüHç..,...*... */
	$"282E 0010 42AE FFFC 302C 024C B06C 024E"            /* (...B®ÿü0,.L°l.N */
	$"6604 4EBA FEC6 362C 024E 7014 C1C3 41EC"            /* f.NºşÆ6,.Np.ÁÃAì */
	$"0250 BCB0 0800 662C 7014 C1C3 41EC 0250"            /* .P¼°..f,p.ÁÃAì.P */
	$"BAB0 0804 661E 7014 C1C3 41EC 0250 B8B0"            /* º°..f.p.ÁÃAì.P¸° */
	$"0808 6610 7014 C1C3 41EC 0250 2D70 080C"            /* ..f.p.ÁÃAì.P-p.. */
	$"FFFC 6014 B66C 024C 670E 7014 C1C3 41EC"            /* ÿü`.¶l.Lg.p.ÁÃAì */
	$"0250 3630 0812 60B2 4AAE FFFC 6716 4A84"            /* .P60..`²J®ÿüg.J„ */
	$"670A 486E FFFC 4EBA 018C 584F 3F03 4EBA"            /* g.HnÿüNº.ŒXO?.Nº */
	$"FED2 544F 206E FFFC 4CDF 0078 4E5E 4E75"            /* şÒTO nÿüLß.xN^Nu */
	$"8F46 495F 6361 6368 655F 7365 6172 6368"            /* FI_cache_search */
	$"0000 4E56 0000 2F04 2F03 282E 0010 302C"            /* ..NV.././.(...0, */
	$"024C B06C 024E 6604 4EBA FE20 4A84 670E"            /* .L°l.Nf.Nºş J„g. */
	$"486E 0014 4EBA 013E 3600 584F 6002 7600"            /* Hn..Nº.>6.XO`.v. */
	$"4A43 6600 0086 7014 C1EC 024C 41EC 0250"            /* JCf..†p.Áì.LAì.P */
	$"4AB0 080C 672C 7014 C1EC 024C 41EC 0250"            /* J°..g,p.Áì.LAì.P */
	$"4AB0 0808 671C 554F 7014 C1EC 024C 41EC"            /* J°..g.UOp.Áì.LAì */
	$"0250 2F30 080C 1F3C 0001 303C 0302 ABC9"            /* .P/0...<..0<..«É */
	$"301F 7014 C1EC 024C 41EC 0250 21AE 0014"            /* 0.p.Áì.LAì.P!®.. */
	$"080C 7014 C1EC 024C 41EC 0250 21AE 0008"            /* ..p.Áì.LAì.P!®.. */
	$"0800 7014 C1EC 024C 41EC 0250 21AE 000C"            /* ..p.Áì.LAì.P!®.. */
	$"0804 7014 C1EC 024C 41EC 0250 2184 0808"            /* ..p.Áì.LAì.P!„.. */
	$"3F2C 024C 4EBA FDFC 544F 261F 281F 4E5E"            /* ?,.LNºıüTO&.(.N^ */
	$"4E75 9146 495F 7374 6F72 655F 696E 5F63"            /* Nu‘FI_store_in_c */
	$"6163 6865 0000 4E56 0000 2F0A 2F03 246E"            /* ache..NV.././.$n */
	$"000C 4A92 671A 2052 4A90 6604 2F12 A9A2"            /* ..J’g. RJf./.©¢ */
	$"554F 2F0A 4EBA 0120 301F 3600 6702 4292"            /* UO/.Nº. 0.6.g.B’ */
	$"426F 001C 261F 245F 4E5E 205F 4FEF 000C"            /* Bo..&.$_N^ _Oï.. */
	$"4ED0 8D43 4F50 595F 4F4E 455F 4943 4F4E"            /* NĞCOPY_ONE_ICON */
	$"0000 4E56 0000 2F0A 2F03 45FA FFAA 554F"            /* ..NV.././.EúÿªUO */
	$"2F2E 0008 4878 FFFF 2F0A 42A7 303C 080A"            /* /...Hxÿÿ/.B§0<.. */
	$"ABC9 301F 3600 3003 261F 245F 4E5E 4E75"            /* «É0.6.0.&.$_N^Nu */
	$"9146 495F 636F 7079 5F65 6163 685F 6963"            /* ‘FI_copy_each_ic */
	$"6F6E 0000 4E56 0000 2F0A 2F03 246E 0008"            /* on..NV.././.$n.. */
	$"554F 2F0A 4EBA 00A0 301F 3600 6620 2F12"            /* UO/.Nº. 0.6.f /. */
	$"4EBA FFA0 3600 584F 6716 554F 2F12 1F3C"            /* Nºÿ 6.XOg.UO/..< */
	$"0001 303C 0302 ABC9 301F 4292 6002 4292"            /* ..0<..«É0.B’`.B’ */
	$"3003 261F 245F 4E5E 4E75 8E46 495F 636C"            /* 0.&.$_N^NuFI_cl */
	...
	$"1F40 0010 205F 4FEF 000C 4ED0 205F 301F"            /* .@.. _Oï..NĞ _0. */
	$"4297 4640 B078 01D2 640A E548 2278 011C"            /* B—F@°x.Òd.åH"x.. */
	$"2EB1 0000 4ED0 206F 0004 2050 A9E1 226F"            /* .±..NĞ o.. P©á"o */
	$"0004 2288 3F40 0008 2E9F 4E75 206F 000C"            /* .."ˆ?@...ŸNu o.. */
	$"202F 0004 A9E3 3F40 0010 226F 0008 2288"            /*  /..©ã?@.."o.."ˆ */
	$"205F 4FEF 000C 4ED0 4E56 0000 594F 2F3C"            /*  _Oï..NĞNV..YO/< */
	...
	$"1010 5240 A02E 4E5E 205F 508F 4ED0 4E56"            /* ..R@ .N^ _PNĞNV */
	$"FF86 48E7 1C00 2D6E 000A FF98 3D6E 0008"            /* ÿ†Hç..-n..ÿ˜=n.. */
	$"FF9C 422E FFA0 7801 7A00 7002 2D40 FFB6"            /* ÿœB.ÿ x.z.p.-@ÿ¶ */
	$"3D44 FFA2 41EE FF86 A20C 3600 6616 0CAE"            /* =Dÿ¢Aîÿ†¢.6.f..® */
	$"464E 4452 FFA6 660C 0CAE 4552 494B FFAA"            /* FNDRÿ¦f..®ERIKÿª */
	$"6602 7A01 5244 4A43 6604 4A05 67CC 3003"            /* f.z.RDJCf.J.gÌ0. */
	$"4CDF 0038 4E5E 4E75 9247 6574 4465 736B"            /* Lß.8N^Nu’GetDesk */
	$"746F 7046 696C 654E 616D 6500 0000 4E56"            /* topFileName...NV */
	$"FF80 48E7 1C30 266E 0012 382E 0010 2A2E"            /* ÿ€Hç.0&n..8...*. */
	$"000C 246E 0008 7014 2D40 FF80 554F 2F0B"            /* ..$n..p.-@ÿ€UO/. */
	$"3F04 486E FF84 486E FF80 4EBA 0566 301F"            /* ?.Hnÿ„Hnÿ€Nº.f0. */
	$"3600 6648 202E FF86 0280 0000 1000 673A"            /* 6.fH .ÿ†.€....g: */
	$"2D4B FFAA 3D44 FFAE 41EE FF98 702E A060"            /* -Kÿª=Dÿ®Aîÿ˜p. ` */
	$"3600 7001 C0AE FFB4 4A80 57C0 4400 1480"            /* 6.p.À®ÿ´J€WÀD..€ */
	$"0C43 FFCE 660C 41EE FF98 7020 A260 3600"            /* .CÿÎf.Aîÿ˜p ¢`6. */
	$"4212 2045 30AE FFB0 6002 76CE 3F43 00AA"            /* B. E0®ÿ°`.vÎ?C.ª */
	$"4CDF 0C38 4E5E 205F 4FEF 000E 4ED0 8644"            /* Lß.8N^ _Oï..NĞ†D */
	$"544F 5045 4E00 0000 4E56 0000 48E7 1E30"            /* TOPEN...NV..Hç.0 */
	$"2C2E 0008 266E 000C 383C EC6C 554F 2F3C"            /* ,...&n..8<ìlUO/< */
	$"424E 444C A80D 301F 3A00 7601 4293 6030"            /* BNDL¨.0.:.v.B“`0 */
	$"594F 2F3C 424E 444C 3F03 A80E 205F 2448"            /* YO/<BNDL?.¨. _$H */
	$"200A 671A 2052 BC90 6614 2052 4A68 0006"            /*  .g. R¼f. RJh.. */
	$"6D0C 2052 4A68 000C 6D04 268A 7800 5243"            /* m. RJh..m.&Šx.RC */
	$"B645 6E04 4A93 67C8 3004 4CDF 0C78 4E5E"            /* ¶En.J“gÈ0.Lß.xN^ */
	$"4E75 9646 696E 6442 756E 646C 6547 6976"            /* Nu–FindBundleGiv */
	$"656E 4372 6561 746F 7200 0000 4E56 0000"            /* enCreator...NV.. */
	$"48E7 0610 2C2E 0008 2A2E 000C 266E 0010"            /* Hç..,...*...&n.. */
	$"343C EC6C 2245 2251 5089 7200 4293 6020"            /* 4<ìl"E"QP‰r.B“`  */
	$"BC91 660C 4A69 0004 6D06 2689 7400 6010"            /* ¼‘f.Ji..m.&‰t.`. */
	$"3029 0004 5240 48C0 E588 5C80 D3C0 5241"            /* 0)..R@HÀåˆ\€ÓÀRA */
	$"2045 2050 3028 0006 5240 B240 6C04 4A93"            /*  E P0(..R@²@l.J“ */
	$"67CE 3002 4CDF 0860 4E5E 4E75 9046 696E"            /* gÎ0.Lß.`N^NuFin */
	$"6454 7970 6549 6E42 756E 646C 6500 0000"            /* dTypeInBundle... */
	$"4E56 0000 48E7 1F30 2C2E 0008 2E2E 000C"            /* NV..Hç.0,....... */
	$"262E 0010 3A3C EC6C 7800 2646 5C8B 2043"            /* &...:<ìlx.&F\‹ C */
	$"4250 602A 594F 2F3C 4652 4546 3F2B 0002"            /* BP`*YO/<FREF?+.. */
	$"A81F 205F 2448 200A 6710 2052 BE90 660A"            /* ¨. _$H .g. R¾f. */
	$"2052 2243 32A8 0004 7A00 588B 5244 2046"            /*  R"C2¨..z.X‹RD F */
	$"B868 0004 6E06 2043 4A50 67C8 3005 4CDF"            /* ¸h..n. CJPgÈ0.Lß */
	$"0CF8 4E5E 4E75 9247 6574 4C6F 6361 6C49"            /* .øN^Nu’GetLocalI */
	$"4446 726F 6D46 5245 4600 0000 4E56 0000"            /* DFromFREF...NV.. */
	$"2F0B 2F06 242E 0008 3C2E 000C 266E 000E"            /* /./.$...<...&n.. */
	$"323C EC6C 7000 2242 5C89 4253 600E BC51"            /* 2<ìlp."B\‰BS`.¼Q */
	$"6606 36A9 0002 7200 5889 5240 2042 B068"            /* f.6©..r.X‰R@ B°h */
	$"0004 6E04 4A53 67E6 3001 2C1F 265F 4E5E"            /* ..n.JSgæ0.,.&_N^ */
	$"4E75 9847 6574 4963 6F6E 5273 7263 4944"            /* Nu˜GetIconRsrcID */
	$"4672 6F6D 4C6F 6361 6C49 4400 0000 4E56"            /* FromLocalID...NV */
	$"0000 2F03 302E 0008 0C40 0006 6248 D040"            /* ../.0....@..bHĞ@ */
	$"303B 0006 4EFB 0002 003E 000E 0016 001E"            /* 0;..Nû...>...... */
	...
	$"8F44 5449 636F 6E54 6F52 6573 4963 6F6E"            /* DTIconToResIcon */
	$"0000 4E56 FEEE 48E7 1F20 246E 0018 42AE"            /* ..NVşîHç. $n..B® */
	$"FFFC 4292 554F 2F2E 0008 3F2E 000C 486E"            /* ÿüB’UO/...?...Hn */
	$"FFF2 4EBA 035E 301F 3600 6600 0142 486E"            /* ÿòNº.^0.6.f..BHn */
	$"FEF2 3F2E FFF2 4EBA FC76 3600 5C4F 6600"            /* şò?.ÿòNºüv6.\Of. */
	$"0120 554F A994 301F 3C00 4227 A99B 554F"            /* . UO©”0.<.B'©›UO */
	$"3F2E FFF2 4878 0002 486E FEF2 1F3C 0001"            /* ?.ÿòHx..Hnşò.<.. */
	$"A81A 301F 3800 1F3C 0001 A99B 0C44 FFFF"            /* ¨.0.8..<..©›.Dÿÿ */
	$"6700 00E6 486E FFFC 2F2E 0010 4EBA FD3A"            /* g..æHnÿü/...Nºı: */
	$"3600 504F 6600 00C8 206E FFFC A069 1E00"            /* 6.POf..È nÿü i.. */
	$"206E FFFC A029 486E FFF8 2F2E FFFC 2F3C"            /*  nÿü )Hnÿø/.ÿü/< */
	$"4652 4546 4EBA FD96 3600 4FEF 000C 6600"            /* FREFNºı–6.Oï..f. */
	$"0096 486E FEF0 2F2E 0014 2F2E FFF8 4EBA"            /* .–Hnşğ/.../.ÿøNº */
	$"FDF0 3600 4FEF 000C 667C 486E FFF8 2F2E"            /* ığ6.Oï..f|Hnÿø/. */
	$"FFFC 2F3C 4943 4E23 4EBA FD62 3600 4FEF"            /* ÿü/<ICN#Nºıb6.Oï */
	$"000C 6662 486E FEEE 3F2E FEF0 2F2E FFF8"            /* ..fbHnşî?.şğ/.ÿø */
	$"4EBA FE3A 3600 4FEF 000A 664A 3F2E 000E"            /* Nºş:6.Oï..fJ?... */
	$"4EBA FE8C 2A00 544F 673C 594F 2F05 3F2E"            /* NºşŒ*.TOg<YO/.?. */
	$"FEEE A81F 205F 2D48 FFF4 4AAE FFF4 6722"            /* şî¨. _-HÿôJ®ÿôg" */
	$"554F 486E FFF4 4EBA FB0E 301F 554F 3EB8"            /* UOHnÿôNºû.0.UO>¸ */
	$"0220 301F 6606 24AE FFF4 600A 363C EC6C"            /* . 0.f.$®ÿô`.6<ìl */
	$"6004 363C EC6C 206E FFFC 1007 A06A 3F06"            /* `.6<ìl nÿü.. j?. */
	$"A998 3F04 A99A 6008 554F A9AF 301F 3600"            /* ©˜?.©š`.UO©¯0.6. */
	$"4A43 670A 0C43 FF94 6704 363C EC6C 3003"            /* JCg..Cÿ”g.6<ìl0. */
	$"4CDF 04F8 4E5E 4E75 9647 6574 4963 6F6E"            /* Lß.øN^Nu–GetIcon */
	$"4672 6F6D 4465 736B 746F 7046 696C 6500"            /* FromDesktopFile. */
	$"0000 4E56 FF94 48E7 1F30 266E 0018 3A2E"            /* ..NVÿ”Hç.0&n..:. */
	$"0014 2E2E 0010 2C2E 000C 246E 0008 4292"            /* ......,...$n..B’ */
	$"554F 2F0B 3F2E 0016 486E FF96 486E FF95"            /* UO/.?...Hnÿ–Hnÿ• */
	$"4EBA FB5C 301F 3800 6600 00B2 4A2E FF95"            /* Nºû\0.8.f..²J.ÿ• */
	$"6600 00A4 3005 0C40 0006 6244 D040 303B"            /* f..¤0..@..bDĞ@0; */
	$"0006 4EFB 0002 003A 000E 0016 001E 0026"            /* ..Nû...:.......& */
	$"002A 0032 263C 0000 0100 6028 263C 0000"            /* .*.2&<....`(&<.. */
	$"0200 6020 263C 0000 0400 6018 7640 6014"            /* ..` &<....`.v@`. */
	$"263C 0000 0080 600C 263C 0000 0100 6004"            /* &<...€`.&<....`. */
	$"7A00 7600 4A83 674A 2003 A122 2488 673E"            /* z.v.JƒgJ .¡"$ˆg> */
	$"2052 A029 3D6E FF96 FFB0 42AE FFB4 2052"            /*  R )=nÿ–ÿ°B®ÿ´ R */
	$"2D50 FFB8 2D43 FFBC 1D45 FFC5 2D47 FFCC"            /* -Pÿ¸-Cÿ¼.EÿÅ-GÿÌ */
	$"2D46 FFD0 41EE FF98 7023 A260 3800 2052"            /* -FÿĞAîÿ˜p#¢`8. R */
	$"A02A 4A44 672E 2052 A023 4292 6026 7894"            /*  *JDg. R #B’`&x” */
	$"6022 78CE 601E 383C EC6C 6018 2F0A 2F06"            /* `"xÎ`.8<ìl`././. */
	$"2F07 3F05 3F2E 0016 2F0B 4EBA FD76 3800"            /* /.?.?.../.Nºıv8. */
	$"4FEF 0014 3F44 00A4 4CDF 0CF8 4E5E 205F"            /* Oï..?D.¤Lß.øN^ _ */
	$"4FEF 0014 4ED0 8944 5447 4554 4943 4F4E"            /* Oï..NĞ‰DTGETICON */
	$"0000 4E56 FF86 2F0A 2F03 246E 0008 2D6E"            /* ..NVÿ†/./.$n..-n */
	$"0012 FF98 3D6E 0010 FF9C 2D6E 000C FFA6"            /* ..ÿ˜=n..ÿœ-n..ÿ¦ */
	$"2D52 FFAA 41EE FF86 7030 A260 3600 6604"            /* -RÿªAîÿ†p0¢`6.f. */
	$"24AE FFAE 3F43 0098 261F 245F 4E5E 205F"            /* $®ÿ®?C.˜&.$_N^ _ */
	$"4FEF 000E 4ED0 8C48 4745 5456 4F4C 5041"            /* Oï..NĞŒHGETVOLPA */
	$"524D 5300 0000 4E56 FF00 48E7 1030 266E"            /* RMS...NVÿ.Hç.0&n */
	$"000E 246E 0008 200A 673E 356E 000C 0016"            /* ..$n.. .g>5n.... */
	$"200B 660A 42AA 0012 426A 001C 601E 204B"            /*  .f.Bª..Bj..`. K */
	$"43EE FF00 7000 1013 5240 48C0 A22E 41EE"            /* Cîÿ.p...R@HÀ¢.Aî */
	$"FF00 2548 0012 357C FFFF 001C 204A A207"            /* ÿ.%H..5|ÿÿ.. J¢. */
	$"3600 42AA 0012 6002 76CE 3F43 011E 4CDF"            /* 6.Bª..`.vÎ?C..Lß */
	$"0C08 4E5E 205F 4FEF 000A 4ED0 9347 4554"            /* ..N^ _Oï..NĞ“GET */
	$"564F 4C55 4D45 494E 464F 4E4F 4E41 4D45"            /* VOLUMEINFONONAME */
	$"0000 4E56 FF86 2F03 554F 2F2E 000E 3F2E"            /* ..NVÿ†/.UO/...?. */
	$"000C 486E FF86 4EBA FF6E 301F 3600 6608"            /* ..Hnÿ†Nºÿn0.6.f. */
	$"206E 0008 30AE FF9C 3F43 0090 261F 4E5E"            /*  n..0®ÿœ?C.&.N^ */
	$"205F 4FEF 000A 4ED0 9044 4554 4552 4D49"            /*  _Oï..NĞDETERMI */
	$"4E45 5652 4546 4E55 4D00 0000 4E56 0000"            /* NEVREFNUM...NV.. */
	$"48E7 1830 282E 0008 594F 3F2E 000C 4EBA"            /* Hç.0(...YO?...Nº */
	$"F83C 205F 2448 200A 672E 2052 3028 0004"            /* ø< _$H .g. R0(.. */
	$"0240 0040 6708 2052 2050 2650 6004 2052"            /* .@.@g. R P&P`. R */
	$"2650 41EB 0012 2244 7000 102B 0012 5240"            /* &PAë.."Dp..+..R@ */
	$"48C0 A22E 7600 6006 2044 4210 76EB 3F43"            /* HÀ¢.v.`. DB.vë?C */
	$"001E 4CDF 0C18 4E5E 205F 5C4F 4ED0 8D47"            /* ..Lß..N^ _\ONĞG */
	$"4554 4452 4956 4552 4E41 4D45 0000 0549"            /* ETDRIVERNAME...I */
	$"636F 6E0D 6966 696C FFFF F11F 6666 696C"            /* con.ifilÿÿñ.ffil */
	...
	$"FFFF F126 636C 7075 FFFF F128 6966 696C"            /* ÿÿñ&clpuÿÿñ(ifil */
	...
	$"0000 399E 6664 7270 FFFF F061 7472 7368"            /* ..9fdrpÿÿğatrsh */
	$"FFFF F067 6661 7379 FFFF F071 494E 4954"            /* ÿÿğgfasyÿÿğqINIT */
	$"FFFF BFE1 4150 504C FFFF F064 6466 696C"            /* ÿÿ¿áAPPLÿÿğddfil */
	$"FFFF F069 7072 6566 FFFF F07D 6661 616D"            /* ÿÿğiprefÿÿğ}faam */
	$"FFFF F072 6661 6374 FFFF F078 6661 6578"            /* ÿÿğrfactÿÿğxfaex */
	$"FFFF F07B 6661 7066 FFFF F07A 6661 7374"            /* ÿÿğ{fapfÿÿğzfast */
	$"FFFF F073 6164 7270 FFFF F064 6661 6574"            /* ÿÿğsadrpÿÿğdfaet */
	$"FFFF F074 6661 6472 FFFF F075 6661 7368"            /* ÿÿğtfadrÿÿğufash */
	$"FFFF F076 6661 6D6E FFFF F077 7468 6E67"            /* ÿÿğvfamnÿÿğwthng */
	$"FFFF BFE1 7368 6C62 FFFF F081 052E 536F"            /* ÿÿ¿áshlbÿÿğ..So */
	$"6E79 0000 0000 0000 0000 0000 0000 0000"            /* ny.............. */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 6578 746E FFFF F07B 6374 726C FFFF"            /* ..extnÿÿğ{ctrlÿÿ */
	$"F078 666F 6E74 FFFF F080 7072 6566 FFFF"            /* ğxfontÿÿğ€prefÿÿ */
	$"F07A 616D 6E75 FFFF F072 7072 6E74 FFFF"            /* ğzamnuÿÿğrprntÿÿ */
	$"F079 7374 7274 FFFF F073 7368 6466 FFFF"            /* ğystrtÿÿğsshdfÿÿ */
	$"F073 7364 6576 FFFF F086 C473 6372 FFFF"            /* ğssdevÿÿğ†Äscrÿÿ */
	$"F089 C46E 6574 FFFF F08A C470 7264 FFFF"            /* ğ‰ÄnetÿÿğŠÄprdÿÿ */
	$"F08E 7070 6466 FFFF F08F 6374 7244 FFFF"            /* ğppdfÿÿğctrDÿÿ */
	$"F091 6578 7444 FFFF F092 7374 7244 FFFF"            /* ğ‘extDÿÿğ’strDÿÿ */
	$"F093 636D 6E75 FFFF F09A 7368 6444 FFFF"            /* ğ“cmnuÿÿğšshdDÿÿ */
	$"F094 6173 7570 FFFF F098 6D61 6344 FFFF"            /* ğ”asupÿÿğ˜macDÿÿ */
	$"F095 636D 6E75 FFFF F09A C476 6F63 FFFF"            /* ğ•cmnuÿÿğšÄvocÿÿ */
	$"F090 C474 6578 FFFF F08D C46C 6962 FFFF"            /* ğÄtexÿÿğÄlibÿÿ */
	$"F08C C468 6C70 FFFF F088 C473 6E64 FFFF"            /* ğŒÄhlpÿÿğˆÄsndÿÿ */
	$"F087 6465 736B FFFF F068 7472 7368 FFFF"            /* ğ‡deskÿÿğhtrshÿÿ */
	$"F067 6173 74C4 FFFF F096 7574 69C4 FFFF"            /* ğgastÄÿÿğ–utiÄÿÿ */
	$"F097 6D6F 72C4 FFFF F085 0000 0000 0000"            /* ğ—morÄÿÿğ…...... */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	...
	$"7077 7063 0000 0001 B368 F2D0 0000 0000"            /* pwpc....³hòĞ.... */
	$"0000 0000 0000 0000 0003 0002 0000 0000"            /* ................ */
	$"FFFF FFFF 0000 0000 0000 313C 0000 313C"            /* ÿÿÿÿ......1<..1< */
	$"0000 313C 0000 0490 0004 0400 FFFF FFFF"            /* ..1<.......ÿÿÿÿ */
	$"0000 0000 0000 0504 0000 0504 0000 0504"            /* ................ */
	$"0000 35D0 0101 0400 FFFF FFFF 0000 0000"            /* ..5Ğ....ÿÿÿÿ.... */
	...
	$"0200 00F0 0200 00FC 0200 0109 0200 011A"            /* ...ğ...ü........ */
	...
	$"0200 0269 8200 0275 8200 0284 8200 029A"            /* ...i‚..u‚..„‚..š */
	...
	$"9001 0008 9421 FEC0 7C7E 1B79 3B84 0000"            /* ...”!şÀ|~.y;„.. */
	$"3B65 0000 3BA6 0000 3BE0 0000 3800 0000"            /* ;e..;¦..;à..8... */
	$"9006 0000 4182 0020 A87E 0000 4800 140D"            /* ...A‚. ¨~..H... */
	$"6000 0000 5460 063F 4182 000C 3BE0 FFCB"            /* `...T`.?A‚..;àÿË */
	$"4800 0288 281C 0000 4082 0058 387E 0006"            /* H..ˆ(...@‚.X8~.. */
	$"3881 0050 38A0 0020 4800 2C5D 8041 0014"            /* 8.P8 . H.,]€A.. */
	$"A81E 0000 B001 00CE 801E 0002 9001 00E8"            /* ¨...°..Î€.....è */
	$"3801 0050 9001 00CA 3800 0000 B001 00D4"            /* 8..P..Ê8...°..Ô */
	$"3861 00B8 4800 2C49 8041 0014 3BE3 0000"            /* 8a.¸H.,I€A..;ã.. */
	$"7FE0 0735 4082 0234 3B81 00B8 4800 0038"            /* .à.5@‚.4;.¸H..8 */
	$"807C 0012 3881 0070 80BC 0012 88A5 0000"            /* €|..8.p€¼..ˆ¥.. */
	$"38A5 0001 3884 0006 4800 2BFD 8041 0014"            /* 8¥..8„..H.+ı€A.. */
	$"801C 0064 9001 0072 A81C 0016 B001 0070"            /* €..d..r¨...°..p */
	$"3BC1 0070 3C60 6963 3863 6F6E 3881 004C"            /* ;Á.p<`ic8con8.L */
	$"4800 2C05 8041 0014 7C60 0735 4082 00DC"            /* H.,.€A..|`.5@‚.Ü */
	$"8001 004C 5400 077B 4182 00D0 387B 0000"            /* €..LT..{A‚.Ğ8{.. */
	$"3881 0040 38A1 003C 4800 1799 6000 0000"            /* 8.@8¡.<H..™`... */
	$"387E 0000 3881 0048 38A1 0044 4800 2BE1"            /* 8~..8.H8¡.DH.+á */
	$"8041 0014 3BE3 0000 7FE0 0735 4082 009C"            /* €A..;ã...à.5@‚.œ */
	$"8061 0048 8081 0040 8001 003C 7C84 0378"            /* €a.H€.@€..<|„.x */
	$"38A1 0038 4800 2BD1 8041 0014 3BE3 0000"            /* 8¡.8H.+Ñ€A..;ã.. */
	$"7FE0 0735 4082 0068 8061 0038 8081 0040"            /* .à.5@‚.h€a.8€.@ */
	$"38BD 0000 4800 2BC9 8041 0014 3BE3 0000"            /* 8½..H.+É€A..;ã.. */
	$"7FE0 0735 4082 003C 807D 0000 4800 01DD"            /* .à.5@‚.<€}..H..İ */
	$"5460 063F 4182 002C 807D 0000 3880 0001"            /* T`.?A‚.,€}..8€.. */
	$"4800 2BFD 8041 0014 8061 0038 8081 003C"            /* H.+ı€A..€a.8€.< */
	$"38BD 0000 4800 2B89 8041 0014 3BE3 0000"            /* 8½..H.+‰€A..;ã.. */
	$"8061 0038 4800 2BF1 8041 0014 8061 0048"            /* €a.8H.+ñ€A..€a.H */
	$"4800 2BFD 8041 0014 801D 0000 2800 0000"            /* H.+ı€A..€...(... */
	$"4082 00D0 881C 001E 5400 06F7 4082 0048"            /* @‚.Ğˆ...T..÷@‚.H */
	$"A01C 0028 5400 056B 4182 0020 387E 0000"            /*  ..(T..kA‚. 8~.. */
	$"389B 0000 38BD 0000 4800 0549 6000 0000"            /* 8›..8½..H..I`... */
	$"3BE3 0000 4800 009C 387C 0000 389B 0000"            /* ;ã..H..œ8|..8›.. */
	$"38BD 0000 4800 0275 6000 0000 3BE3 0000"            /* 8½..H..u`...;ã.. */
	$"4800 0080 A01C 0028 5400 056B 4182 0024"            /* H..€ ..(T..kA‚.$ */
	$"A87E 0000 809C 0030 38BB 0000 38DD 0000"            /* ¨~..€œ.08»..8İ.. */
	$"4800 099D 6000 0000 7C60 0735 4182 0054"            /* H..`...|`.5A‚.T */
	$"801C 0030 2C00 0002 4082 0030 A87E 0000"            /* €..0,...@‚.0¨~.. */
	$"4800 1CD9 6000 0000 5460 063F 4182 001C"            /* H..Ù`...T`.?A‚.. */
	$"A87E 0000 389D 0000 4800 0FD1 6000 0000"            /* ¨~..8..H..Ñ`... */
	$"3BE3 0000 4800 001C 387C 0000 389B 0000"            /* ;ã..H...8|..8›.. */
	$"38BD 0000 4800 0699 6000 0000 3BE3 0000"            /* 8½..H..™`...;ã.. */
	$"801D 0000 2800 0000 4182 0040 807D 0000"            /* €...(...A‚.@€}.. */
	$"A01C 0028 5400 073C 7C04 0E70 4800 2E61"            /*  ..(T..<|..pH..a */
	$"8041 0014 4800 0024 801E 0002 2C00 0001"            /* €A..H..$€...,... */
	$"4082 0018 A87E 0000 389D 0000 4800 0F6D"            /* @‚..¨~..8..H..m */
	$"6000 0000 3BE3 0000 387F 0000 8001 0148"            /* `...;ã..8...€..H */
	$"3821 0140 7C08 03A6 BB61 FFEC 4E80 0020"            /* 8!.@|..¦»aÿìN€.  */
	$"0000 0000 0000 2041 8005 0000 0000 0308"            /* ...... A€....... */
	$"000A 2E46 696E 645F 6963 6F6E 8004 0000"            /* ...Find_icon€... */
	$"2800 0000 4182 000C 3800 0001 9805 0000"            /* (...A‚..8...˜... */
	...
	$"9001 0008 9421 FFB0 9061 0068 3800 0000"            /* ...”!ÿ°a.h8... */
	$"9801 0038 8062 00C4 3880 0FE0 38A0 0001"            /* ˜..8€b.Ä8€.à8 .. */
	$"4800 29C5 8041 0014 3BE3 0000 8061 0068"            /* H.)Å€A..;ã..€a.h */
	$"3880 FFFF 38BF 0000 38C1 0038 4800 29C1"            /* 8€ÿÿ8¿..8Á.8H.)Á */
	$"8041 0014 387F 0000 4800 29CD 8041 0014"            /* €A..8...H.)Í€A.. */
	$"8801 0038 7C00 0034 5403 D97E 8001 0058"            /* ˆ..8|..4T.Ù~€..X */
	$"3821 0050 7C08 03A6 83E1 FFFC 4E80 0020"            /* 8!.P|..¦ƒáÿüN€.  */
	$"0000 0000 0000 2041 8001 0000 0000 0078"            /* ...... A€......x */
	$"000D 2E49 7353 7569 7465 456D 7074 7900"            /* ...IsSuiteEmpty. */
	$"7C08 02A6 93E1 FFFC 9001 0008 9421 FF70"            /* |..¦“áÿü...”!ÿp */
	$"B061 00AA 3801 006C 9001 0058 3800 0014"            /* °a.ª8..l..X8... */
	$"9001 005C A801 00AA B001 004E 3800 0000"            /* ..\¨..ª°..N8... */
	$"9001 004A 3861 0038 4800 2AFD 8041 0014"            /* ..J8a.8H.*ı€A.. */
	$"3BE3 0000 3860 0000 7FE0 0735 4082 0010"            /* ;ã..8`...à.5@‚.. */
	$"8001 0076 2C00 0000 4082 0008 3860 0001"            /* €..v,...@‚..8`.. */
	...
	$"389B 0000 38BC 0000 4800 1641 6000 0000"            /* 8›..8¼..H..A`... */
	$"907E 0000 801E 0000 2800 0000 4182 000C"            /* ~..€...(...A‚.. */
	$"3860 0000 4800 0230 387D 0000 3881 007E"            /* 8`..H..08}..8.~ */
	$"4800 07C1 6000 0000 3B03 0000 4800 28E9"            /* H..Á`...;...H.(é */
	$"8041 0014 3AC3 0000 8801 007E 2800 0001"            /* €A..:Ã..ˆ..~(... */
	$"4082 00A8 3860 8000 3C80 6D61 38A0 0000"            /* @‚.¨8`€.<€ma8 .. */
	$"38C1 007C 38E1 0078 3884 6373 4800 29C1"            /* 8Á.|8á.x8„csH.)Á */
	$"8041 0014 3860 0000 4800 28C5 8041 0014"            /* €A..8`..H.(Å€A.. */
	$"4800 29C5 8041 0014 38A3 0000 A861 007C"            /* H.)Å€A..8£..¨a.| */
	$"8081 0078 38C0 0001 4800 29C5 8041 0014"            /* €.x8À..H.)Å€A.. */
	$"3B43 0000 3860 0001 4800 2895 8041 0014"            /* ;C..8`..H.(•€A.. */
	$"7F40 0734 2C00 FFFF 4082 0014 4800 28B1"            /* .@.4,.ÿÿ@‚..H.(± */
	$"8041 0014 3BE3 0000 4800 0150 387E 0000"            /* €A..;ã..H..P8~.. */
	$"3898 0000 38BC 0000 38C0 0001 4800 0889"            /* 8˜..8¼..8À..H..‰ */
	$"6000 0000 3BE3 0000 387A 0000 4800 28F9"            /* `...;ã..8z..H.(ù */
	$"8041 0014 4800 0124 3C1D 9E9C 2800 7270"            /* €A..H..$<.œ(.rp */
	$"4082 000C 3FA0 4150 3BBD 504C AB37 0016"            /* @‚..? AP;½PL«7.. */
	$"3879 0000 389C 0000 38BB 0000 38DD 0000"            /* 8y..8œ..8»..8İ.. */
	$"38FE 0000 4800 1121 6000 0000 3BE3 0000"            /* 8ş..H..!`...;ã.. */
	$"7FE0 0735 4182 008C 3800 0000 9001 004A"            /* .à.5A‚.Œ8.....J */
	$"3800 0001 B001 0054 4800 0064 3861 0038"            /* 8...°..TH..d8a.8 */
	$"A863 0016 7F20 0734 7C03 0000 4182 0044"            /* ¨c... .4|...A‚.D */
	$"3861 0038 A863 0016 4BFF FDD9 5460 063F"            /* 8a.8¨c..KÿıÙT`.? */
	$"4182 0030 3861 0038 A863 0016 389C 0000"            /* A‚.08a.8¨c..8œ.. */
	$"38BB 0000 38DD 0000 38FE 0000 4800 10B9"            /* 8»..8İ..8ş..H..¹ */
	$"6000 0000 3BE3 0000 7FE0 0735 4182 0024"            /* `...;ã...à.5A‚.$ */
	$"A861 0054 3803 0001 B001 0054 3861 0038"            /* ¨a.T8...°..T8a.8 */
	$"4800 29FD 8041 0014 7C60 0735 4182 FF90"            /* H.)ı€A..|`.5A‚ÿ */
	$"7FE0 0735 4182 0054 3860 0000 4800 2831"            /* .à.5A‚.T8`..H.(1 */
	$"8041 0014 387E 0000 3898 0000 38BC 0000"            /* €A..8~..8˜..8¼.. */
	$"38C0 0001 4800 0781 6000 0000 3BE3 0000"            /* 8À..H..`...;ã.. */
	$"801E 0000 2800 0000 4082 0020 387E 0000"            /* €...(...@‚. 8~.. */
	$"3880 F060 38BC 0000 38C0 0001 4800 0759"            /* 8€ğ`8¼..8À..H..Y */
	$"6000 0000 3BE3 0000 3876 0000 4800 27E1"            /* `...;ã..8v..H.'á */
	$"8041 0014 7FE0 0735 4082 0028 801E 0000"            /* €A...à.5@‚.(€... */
	$"2800 0000 4182 001C 387D 0000 389B 0000"            /* (...A‚..8}..8›.. */
	$"38BC 0000 80DE 0000 4800 1525 6000 0000"            /* 8¼..€Ş..H..%`... */
	$"387F 0000 8001 00B8 3821 00B0 7C08 03A6"            /* 8...€..¸8!.°|..¦ */
	$"BAC1 FFD8 4E80 0020 0000 0000 0000 2041"            /* ºÁÿØN€. ...... A */
	$"800A 0000 0000 0290 0015 2E47 6574 5F6E"            /* €.........Get_n */
	$"6F72 6D61 6C5F 6669 6C65 5F69 636F 6E00"            /* ormal_file_icon. */
	$"7C08 02A6 BF61 FFEC 9001 0008 9421 FFB0"            /* |..¦¿aÿì...”!ÿ° */
	$"9061 0068 3B64 0000 3B85 0000 4800 2679"            /* a.h;d..;…..H.&y */
	$"8041 0014 3BA3 0000 3860 0000 4800 2681"            /* €A..;£..8`..H.& */
	$"8041 0014 8061 0068 3880 0001 4800 2689"            /* €A..€a.h8€..H.&‰ */
	$"8041 0014 3BC3 0000 3860 0001 4800 2661"            /* €A..;Ã..8`..H.&a */
	$"8041 0014 7FC0 0734 2C00 FFFF 4082 0014"            /* €A...À.4,.ÿÿ@‚.. */
	$"4800 267D 8041 0014 3BE3 0000 4800 0060"            /* H.&}€A..;ã..H..` */
	$"387C 0000 3880 BFB9 38BB 0000 38C0 0001"            /* 8|..8€¿¹8»..8À.. */
	$"4800 0655 6000 0000 3BE3 0000 7FE0 0734"            /* H..U`...;ã...à.4 */
	$"2C00 FC18 4082 0020 387C 0000 3880 BF90"            /* ,.ü.@‚. 8|..8€¿ */
	$"38BB 0000 38C0 0001 4800 062D 6000 0000"            /* 8»..8À..H..-`... */
	$"3BE3 0000 387E 0000 4800 269D 8041 0014"            /* ;ã..8~..H.&€A.. */
	$"387D 0000 4800 26A9 8041 0014 387F 0000"            /* 8}..H.&©€A..8... */
	$"8001 0058 3821 0050 7C08 03A6 BB61 FFEC"            /* €..X8!.P|..¦»aÿì */
	$"4E80 0020 0000 0000 0000 2041 8005 0000"            /* N€. ...... A€... */
	$"0000 00E4 0015 2E47 6574 5F63 7573 746F"            /* ...ä...Get_custo */
	$"6D5F 6669 6C65 5F69 636F 6E00 7C08 02A6"            /* m_file_icon.|..¦ */
	$"93E1 FFFC 93C1 FFF8 93A1 FFF4 9381 FFF0"            /* “áÿü“Áÿø“¡ÿô“ÿğ */
	$"9001 0008 9421 FFB0 3B83 0000 3BA4 0000"            /* ...”!ÿ°;ƒ..;¤.. */
	$"3BE5 0000 3BC0 0000 387D 0000 7F84 0734"            /* ;å..;À..8}...„.4 */
	$"38A0 0000 4800 1275 6000 0000 907F 0000"            /* 8 ..H..u`...... */
	$"801F 0000 2C00 0000 4082 0050 387C 0000"            /* €...,...@‚.P8|.. */
	$"389D 0000 38A0 0000 38C1 0038 38FF 0000"            /* 8..8 ..8Á.88ÿ.. */
	$"4800 262D 8041 0014 3BC3 0000 7FC0 0735"            /* H.&-€A..;Ã...À.5 */
	$"4182 0010 3800 0000 901F 0000 4800 001C"            /* A‚..8......H... */
	$"387D 0000 7F84 0734 38A0 0000 80DF 0000"            /* 8}...„.48 ..€ß.. */
	$"4800 133D 6000 0000 387E 0000 8001 0058"            /* H..=`...8~..€..X */
	$"3821 0050 7C08 03A6 83E1 FFFC 83C1 FFF8"            /* 8!.P|..¦ƒáÿüƒÁÿø */
	$"83A1 FFF4 8381 FFF0 4E80 0020 0000 0000"            /* ƒ¡ÿôƒÿğN€. .... */
	$"0000 2041 8004 0000 0000 00C0 000D 2E4D"            /* .. A€......À...M */
	$"7946 696E 6446 6F6C 6465 7200 7C08 02A6"            /* yFindFolder.|..¦ */
	$"BE81 FFD0 9001 0008 9421 FF90 3AE3 0000"            /* ¾ÿĞ...”!ÿ:ã.. */
	$"3AA4 0000 3AC5 0000 3B02 014C 3B22 0124"            /* :¤..:Å..;..L;".$ */
	$"8383 0030 AB43 0016 3BA0 F061 387A 0000"            /* ƒƒ.0«C..; ğa8z.. */
	$"3C80 6D61 3884 6373 38A1 003C 4BFF FEE1"            /* <€ma8„cs8¡.<Kÿşá */
	$"7C60 0735 4082 0018 8001 003C 7C00 E000"            /* |`.5@‚..€..<|.à. */
	$"4082 000C 3BA0 F071 4800 013C 8017 0064"            /* @‚..; ğqH..<€..d */
	$"2C00 0002 4082 006C 3B60 0005 3BE0 0000"            /* ,...@‚.l;`..;à.. */
	$"4800 004C 387A 0000 7FE0 0734 5400 1838"            /* H..L8z...à.4T..8 */
	$"7C99 002E 38A1 0038 4BFF FE95 3BC3 0000"            /* |™..8¡.8Kÿş•;Ã.. */
	$"7FC0 0735 4082 0024 8001 0038 7C00 E000"            /* .À.5@‚.$€..8|.à. */
	$"4082 0018 7FE0 0734 5403 1838 3803 0004"            /* @‚...à.4T..88... */
	$"7FB9 002E 4800 00E0 3BFF 0001 7FE3 0734"            /* .¹..H..à;ÿ...ã.4 */
	$"7F60 0734 7C03 0000 4180 FFAC 4800 00C8"            /* .`.4|...A€ÿ¬H..È */
	$"8061 003C 8017 0064 7C03 0000 4082 006C"            /* €a.<€..d|...@‚.l */
	$"3B60 001A 3BE0 0000 4800 004C 387A 0000"            /* ;`..;à..H..L8z.. */
	$"7FE0 0734 5400 1838 7C98 002E 38A1 0038"            /* .à.4T..8|˜..8¡.8 */
	$"4BFF FE1D 3BC3 0000 7FC0 0735 4082 0024"            /* Kÿş.;Ã...À.5@‚.$ */
	$"8001 0038 7C00 E000 4082 0018 7FE0 0734"            /* €..8|.à.@‚...à.4 */
	$"5403 1838 3803 0004 7FB8 002E 4800 0068"            /* T..88....¸..H..h */
	$"3BFF 0001 7FE3 0734 7F60 0734 7C03 0000"            /* ;ÿ...ã.4.`.4|... */
	$"4180 FFAC 4800 0050 8017 0064 2C00 0001"            /* A€ÿ¬H..P€..d,... */
	$"4082 000C 3BA0 F07C 4800 003C 8817 001E"            /* @‚..; ğ|H..<ˆ... */
	$"5400 0739 4182 000C 3BA0 F077 4800 0028"            /* T..9A‚..; ğwH..( */
	$"8817 001E 5400 06B5 4182 000C 3BA0 F076"            /* ˆ...T..µA‚..; ğv */
	$"4800 0014 8817 001E 5400 077B 4182 0008"            /* H...ˆ...T..{A‚.. */
	$"3BA0 F074 7FA3 0734 3C80 6630 38B5 0000"            /* ; ğt.£.4<€f08µ.. */
	$"3884 6C64 4800 1025 6000 0000 9076 0000"            /* 8„ldH..%`...v.. */
	$"8016 0000 2800 0000 4182 000C 3BC0 0000"            /* €...(...A‚..;À.. */
	$"4800 00A8 4800 22E1 8041 0014 3A83 0000"            /* H..¨H."á€A..:ƒ.. */
	$"3860 0000 4800 23A9 8041 0014 3876 0000"            /* 8`..H.#©€A..8v.. */
	$"389D 0000 38B5 0000 38C0 0002 4800 02F9"            /* 8..8µ..8À..H..ù */
	$"6000 0000 3BC3 0000 7FC0 0735 4182 0030"            /* `...;Ã...À.5A‚.0 */
	$"7FA0 0734 2C00 F061 4182 0024 3BA0 F061"            /* . .4,.ğaA‚.$; ğa */
	$"3876 0000 389D 0000 38B5 0000 38C0 0002"            /* 8v..8..8µ..8À.. */
	$"4800 02C5 6000 0000 3BC3 0000 3874 0000"            /* H..Å`...;Ã..8t.. */
	$"4800 234D 8041 0014 7FC0 0735 4082 002C"            /* H.#M€A...À.5@‚., */
	$"8016 0000 2800 0000 4182 0020 7FA3 0734"            /* €...(...A‚. .£.4 */
	$"3C80 6630 38B5 0000 80D6 0000 3884 6C64"            /* <€f08µ..€Ö..8„ld */
	$"4800 108D 6000 0000 387E 0000 8001 0078"            /* H..`...8~..€..x */
	$"3821 0070 7C08 03A6 BA81 FFD0 4E80 0020"            /* 8!.p|..¦ºÿĞN€.  */
	$"0000 0000 0000 2041 800C 0000 0000 0284"            /* ...... A€......„ */
	$"0017 2E47 6574 5F6E 6F72 6D61 6C5F 666F"            /* ...Get_normal_fo */
	$"6C64 6572 5F69 636F 6E00 0000 7C08 02A6"            /* lder_icon...|..¦ */
	$"93E1 FFFC 93C1 FFF8 9001 0008 9421 FF70"            /* “áÿü“Áÿø...”!ÿp */
	$"B061 00AA 9081 00AC 90A1 00B0 90C1 00B4"            /* °a.ª.¬¡.°Á.´ */
	$"3BC2 021C 881E 0000 2800 0000 4082 0010"            /* ;Â..ˆ...(...@‚.. */
	$"387E 0000 4800 04C5 6000 0000 A861 00AA"            /* 8~..H..Å`...¨a.ª */
	$"8081 00AC 38BE 0000 38C1 0038 4800 2461"            /* €.¬8¾..8Á.8H.$a */
	$"8041 0014 3BE3 0000 7FE0 0735 4082 001C"            /* €A..;ã...à.5@‚.. */
	$"3861 0038 8081 00B0 80A1 00B4 4BFF FAF5"            /* 8a.8€.°€¡.´Kÿúõ */
	$"6000 0000 3BE3 0000 387F 0000 8001 0098"            /* `...;ã..8...€..˜ */
	$"3821 0090 7C08 03A6 83E1 FFFC 83C1 FFF8"            /* 8!.|..¦ƒáÿüƒÁÿø */
	$"4E80 0020 0000 0000 0000 2041 8002 0000"            /* N€. ...... A€... */
	$"0000 0098 0017 2E47 6574 5F63 7573 746F"            /* ...˜...Get_custo */
	$"6D5F 666F 6C64 6572 5F69 636F 6E00 0000"            /* m_folder_icon... */
	$"7C08 02A6 BEE1 FFDC 9001 0008 9421 FF90"            /* |..¦¾áÿÜ...”!ÿ */
	$"3BA3 0000 3B24 0000 3B42 023C 3B62 02D4"            /* ;£..;$..;B.<;b.Ô */
	$"3B82 030C 3BC0 F060 3800 0002 9804 0000"            /* ;‚..;Àğ`8...˜... */
	$"3C60 6170 3863 7072 3881 0038 4800 2009"            /* <`ap8cpr8.8H. . */
	$"8041 0014 3AE3 0000 7EE0 0735 4082 0054"            /* €A..:ã..~à.5@‚.T */
	$"8001 0038 5400 07FF 4182 0048 3B00 000B"            /* €..8T..ÿA‚.H;... */
	$"3BF8 FFFF 4800 0030 7FE0 0734 5400 1838"            /* ;øÿÿH..0.à.4T..8 */
	$"7C1C 002E 7C1D 0040 4082 0018 7FE0 0734"            /* |...|..@@‚...à.4 */
	$"5403 1838 3803 0004 7FDC 002E 4800 005C"            /* T..88....Ü..H..\ */
	$"3BFF FFFF 7FE0 0735 4080 FFD0 4800 004C"            /* ;ÿÿÿ.à.5@€ÿĞH..L */
	$"3B00 0007 3BF8 FFFF 4800 0038 7FE0 0734"            /* ;...;øÿÿH..8.à.4 */
	$"5400 1838 7C1B 002E 7C1D 0040 4082 0020"            /* T..8|...|..@@‚.  */
	$"7FE0 0734 5403 1838 3803 0004 7FDB 002E"            /* .à.4T..88....Û.. */
	$"3800 0001 9819 0000 4800 0010 3BFF FFFF"            /* 8...˜...H...;ÿÿÿ */
	$"7FE0 0735 4080 FFC8 7FC0 0734 2C00 F060"            /* .à.5@€ÿÈ.À.4,.ğ` */
	$"4082 0044 3B00 0013 3BF8 FFFF 4800 0030"            /* @‚.D;...;øÿÿH..0 */
	$"7FE0 0734 5400 1838 7C1A 002E 7C1D 0040"            /* .à.4T..8|...|..@ */
	$"4082 0018 7FE0 0734 5403 1838 3803 0004"            /* @‚...à.4T..88... */
	$"7FDA 002E 4800 0010 3BFF FFFF 7FE0 0735"            /* .Ú..H...;ÿÿÿ.à.5 */
	$"4080 FFD0 387E 0000 8001 0078 3821 0070"            /* @€ÿĞ8~..€..x8!.p */
	$"7C08 03A6 BAE1 FFDC 4E80 0020 0000 0000"            /* |..¦ºáÿÜN€. .... */
	$"0000 2041 8009 0000 0000 014C 0015 2E46"            /* .. A€......L...F */
	$"696E 645F 6765 6E65 7269 635F 6963 6F6E"            /* ind_generic_icon */
	$"5F69 6400 7C08 02A6 93E1 FFFC 93C1 FFF8"            /* _id.|..¦“áÿü“Áÿø */
	$"93A1 FFF4 9001 0008 9421 FFA0 3BC3 0000"            /* “¡ÿô...”!ÿ ;Ã.. */
	$"B081 007E 90A1 0080 98C1 0087 8061 0080"            /* °.~¡.€˜Á.‡€a.€ */
	$"3881 003C 38A1 0038 4800 0A59 6000 0000"            /* 8.<8¡.8H..Y`... */
	$"387E 0000 4800 1FE1 8041 0014 3BE3 0000"            /* 8~..H..á€A..;ã.. */
	$"7FE0 0735 4082 00E8 A801 007E B001 0040"            /* .à.5@‚.è¨..~°..@ */
	$"3800 0001 9801 0042 3800 0001 9801 0043"            /* 8...˜..B8...˜..C */
	$"8801 0087 9801 0044 8062 00E0 3880 0FE0"            /* ˆ..‡˜..D€b.à8€.à */
	$"38A0 0001 4800 1EB1 8041 0014 3BA3 0000"            /* 8 ..H..±€A..;£.. */
	$"807E 0000 8081 003C 38BD 0000 38C1 0040"            /* €~..€.<8½..8Á.@ */
	$"4800 1EAD 8041 0014 3BE3 0000 7FE0 0735"            /* H..­€A..;ã...à.5 */
	$"4082 0044 8001 0038 2800 0000 4182 0038"            /* @‚.D€..8(...A‚.8 */
	$"8801 0042 2800 0000 4182 002C 8801 0043"            /* ˆ..B(...A‚.,ˆ..C */
	$"2800 0000 4182 0020 807E 0000 8081 0038"            /* (...A‚. €~..€.8 */
	$"38BD 0000 38C1 0040 4800 1E65 8041 0014"            /* 8½..8Á.@H..e€A.. */
	$"3BE3 0000 387D 0000 4800 1E6D 8041 0014"            /* ;ã..8}..H..m€A.. */
	$"7FE0 0735 4082 0038 8801 0042 2800 0000"            /* .à.5@‚.8ˆ..B(... */
	$"4182 002C 8801 0043 2800 0000 4182 0020"            /* A‚.,ˆ..C(...A‚.  */
	$"3BE0 FC18 807E 0000 3880 0000 4800 1E51"            /* ;àü.€~..8€..H..Q */
	$"8041 0014 3800 0000 901E 0000 387F 0000"            /* €A..8......8... */
	$"8001 0068 3821 0060 7C08 03A6 83E1 FFFC"            /* €..h8!.`|..¦ƒáÿü */
	$"83C1 FFF8 83A1 FFF4 4E80 0020 0000 0000"            /* ƒÁÿøƒ¡ÿôN€. .... */
	$"0000 2041 8003 0000 0000 0158 0010 2E46"            /* .. A€......X...F */
	$"495F 4765 7449 636F 6E53 7569 7465 0000"            /* I_GetIconSuite.. */
	$"7C08 02A6 BF61 FFEC 9001 0008 9421 FFB0"            /* |..¦¿aÿì...”!ÿ° */
	$"3BE3 0000 3BA4 0000 3BC5 0000 3B80 0000"            /* ;ã..;¤..;Å..;€.. */
	$"3C1F 969D 2800 6C38 4182 0010 3C1F 969D"            /* <.–(.l8A‚..<.– */
	$"2800 6C34 4082 0010 881E 0002 2800 0000"            /* (.l4@‚..ˆ...(... */
	$"4082 0028 3C1F 969D 2800 7338 4182 0010"            /* @‚.(<.–(.s8A‚.. */
	$"3C1F 969D 2800 7334 4082 0014 881E 0003"            /* <.–(.s4@‚..ˆ... */
	$"2800 0000 4182 0008 3B80 0001 5780 063F"            /* (...A‚..;€..W€.? */
	$"4082 00A0 881E 0004 2800 0001 4082 001C"            /* @‚. ˆ...(...@‚.. */
	$"387F 0000 A89E 0000 4800 1E35 8041 0014"            /* 8...¨..H..5€A.. */
	$"907D 0000 4800 0018 387F 0000 A89E 0000"            /* }..H...8...¨.. */
	$"4800 1E35 8041 0014 907D 0000 801D 0000"            /* H..5€A..}..€... */
	$"2800 0000 4182 0024 387D 0000 4800 1E31"            /* (...A‚.$8}..H..1 */
	$"8041 0014 3B63 0000 7F60 0735 4182 000C"            /* €A..;c...`.5A‚.. */
	$"3800 0000 901D 0000 801D 0000 2800 0000"            /* 8......€...(... */
	$"4182 0030 3C1F B6BD 2800 4E23 4082 0010"            /* A‚.0<.¶½(.N#@‚.. */
	$"3800 0000 981E 0002 4800 0018 3C1F 969D"            /* 8...˜...H...<.– */
	$"2800 7323 4082 000C 3800 0000 981E 0003"            /* (.s#@‚..8...˜... */
	$"3860 0000 8001 0058 3821 0050 7C08 03A6"            /* 8`..€..X8!.P|..¦ */
	$"BB61 FFEC 4E80 0020 0000 0000 0000 2041"            /* »aÿìN€. ...... A */
	$"8005 0000 0000 0128 000B 2E47 6574 5F31"            /* €......(...Get_1 */
	$"5F69 636F 6E00 0000 7C08 02A6 93E1 FFFC"            /* _icon...|..¦“áÿü */
	$"93C1 FFF8 93A1 FFF4 9001 0008 9421 FEB0"            /* “Áÿø“¡ÿô...”!ş° */
	$"3BA3 0000 3800 0000 9801 0038 4800 1CD9"            /* ;£..8...˜..8H..Ù */
	$"8041 0014 3BC3 0000 3860 8000 3C80 6D61"            /* €A..;Ã..8`€.<€ma */
	$"38A0 0000 38C1 013C 38E1 0138 3884 6373"            /* 8 ..8Á.<8á.88„cs */
	$"4800 1DBD 8041 0014 3860 0000 4800 1CC1"            /* H..½€A..8`..H..Á */
	$"8041 0014 4800 1DC1 8041 0014 38A3 0000"            /* €A..H..Á€A..8£.. */
	$"A861 013C 8081 0138 38C0 0001 4800 1DC1"            /* ¨a.<€.88À..H..Á */
	$"8041 0014 3BE3 0000 3860 0001 4800 1C91"            /* €A..;ã..8`..H..‘ */
	$"8041 0014 7FE0 0734 2C00 FFFF 4182 0050"            /* €A...à.4,.ÿÿA‚.P */
	$"3861 0038 3880 2BF2 38A0 0005 4800 1EF9"            /* 8a.88€+ò8 ..H..ù */
	$"8041 0014 8801 0038 2800 0000 4082 0018"            /* €A..ˆ..8(...@‚.. */
	$"3861 0038 3880 1194 38A0 0005 4800 1ED9"            /* 8a.88€.”8 ..H..Ù */
	$"8041 0014 387F 0000 4800 1CED 8041 0014"            /* €A..8...H..í€A.. */
	$"387E 0000 4800 1CF9 8041 0014 8801 0038"            /* 8~..H..ù€A..ˆ..8 */
	$"2800 0020 4080 002C 8801 0038 2800 0000"            /* (.. @€.,ˆ..8(... */
	$"4182 0020 3861 0038 389D 0000 88A1 0038"            /* A‚. 8a.88..ˆ¡.8 */
	$"38A5 0001 4800 1AD1 8041 0014 4800 0018"            /* 8¥..H..Ñ€A..H... */
	$"3862 0364 389D 0000 38A0 0006 4800 1AB9"            /* 8b.d8..8 ..H..¹ */
	$"8041 0014 8001 0158 3821 0150 7C08 03A6"            /* €A..€..X8!.P|..¦ */
	$"83E1 FFFC 83C1 FFF8 83A1 FFF4 4E80 0020"            /* ƒáÿüƒÁÿøƒ¡ÿôN€.  */
	$"0000 0000 0000 2041 8003 0000 0000 0148"            /* ...... A€......H */
	$"0013 2E47 6574 5F69 636F 6E5F 6669 6C65"            /* ...Get_icon_file */
	$"5F6E 616D 6500 0000 7C08 02A6 93E1 FFFC"            /* _name...|..¦“áÿü */
	$"93C1 FFF8 93A1 FFF4 9381 FFF0 9001 0008"            /* “Áÿø“¡ÿô“ÿğ... */
	$"9421 FDE0 B061 023A 3BA4 0000 3800 0000"            /* ”!ıà°a.:;¤..8... */
	$"9004 0000 3800 0000 9001 019E A801 023A"            /* ...8.....¨..: */
	$"B001 01A2 3800 0000 B001 01A8 3861 018C"            /* °..¢8...°..¨8a.Œ */
	$"4800 1A0D 8041 0014 3BE3 0000 7FE0 0735"            /* H...€A..;ã...à.5 */
	$"4082 0150 3861 018C A863 0044 3881 0038"            /* @‚.P8a.Œ¨c.D8.8 */
	$"4800 191D 6000 0000 3BE3 0000 7FE0 0735"            /* H...`...;ã...à.5 */
	$"4082 0130 3861 0038 3882 036A 38A0 0001"            /* @‚.08a.88‚.j8 .. */
	$"38C0 0000 4800 1DE9 8041 0014 5460 063F"            /* 8À..H..é€A..T`.? */
	$"4182 0048 4800 1AF1 8041 0014 3B83 0000"            /* A‚.HH..ñ€A..;ƒ.. */
	$"3860 0000 4800 1BB9 8041 0014 387D 0000"            /* 8`..H..¹€A..8}.. */
	$"3880 F062 38A0 FFFF 38C0 0001 4BFF FB09"            /* 8€ğb8 ÿÿ8À..Kÿû. */
	$"6000 0000 3BE3 0000 387C 0000 4800 1B91"            /* `...;ã..8|..H..‘ */
	$"8041 0014 4800 00CC A801 01D0 B001 0154"            /* €A..H..Ì¨..Ğ°..T */
	$"A801 01CE B001 0152 3BC1 013C 3800 0000"            /* ¨..Î°..R;Á.<8... */
	$"941E 001C 3800 0016 B001 0156 3861 013C"            /* ”...8...°..V8a.< */
	$"4800 1D85 8041 0014 3BE3 0000 7FE0 0735"            /* H..…€A..;ã...à.5 */
	$"4082 0010 801E 0000 2C00 0000 4181 001C"            /* @‚..€...,...A.. */
	$"3800 0015 B001 0156 3861 013C 4800 1D59"            /* 8...°..V8a.<H..Y */
	$"8041 0014 3BE3 0000 7FE0 0735 4082 0064"            /* €A..;ã...à.5@‚.d */
	$"801E 0000 2C00 0000 4081 0058 387D 0000"            /* €...,...@.X8}.. */
	$"4800 1A95 8041 0014 3BE3 0000 7FE0 0735"            /* H..•€A..;ã...à.5 */
	$"4082 0040 807E 0000 3881 0138 38A0 0100"            /* @‚.@€~..8.88 .. */
	$"4800 1D2D 8041 0014 3BE3 0000 7FE0 0735"            /* H..-€A..;ã...à.5 */
	$"4082 0020 8061 0138 809D 0000 3CA0 4943"            /* @‚. €a.8€..< IC */
	$"38A5 4E23 4800 1D21 8041 0014 3BE3 0000"            /* 8¥N#H..!€A..;ã.. */
	$"387F 0000 8001 0228 3821 0220 7C08 03A6"            /* 8...€..(8!. |..¦ */
	$"83E1 FFFC 83C1 FFF8 83A1 FFF4 8381 FFF0"            /* ƒáÿüƒÁÿøƒ¡ÿôƒÿğ */
	$"4E80 0020 0000 0000 0000 2041 8004 0000"            /* N€. ...... A€... */
	$"0000 01CC 0010 2E47 6574 5F76 6F6C 756D"            /* ...Ì...Get_volum */
	$"655F 6963 6F6E 0000 7C08 02A6 93E1 FFFC"            /* e_icon..|..¦“áÿü */
	$"9001 0008 9421 FF40 B061 00DA 3800 0000"            /* ...”!ÿ@°a.Ú8... */
	$"9001 004A A801 00DA B001 004E 3800 0000"            /* ..J¨..Ú°..N8... */
	$"B001 0054 3861 0038 4800 1835 8041 0014"            /* °..T8a.8H..5€A.. */
	$"3BE3 0000 3860 0000 7FE0 0735 4082 0014"            /* ;ã..8`...à.5@‚.. */
	$"A801 007C 2C00 0000 4081 0008 3860 0001"            /* ¨..|,...@..8`.. */
	$"8001 00C8 3821 00C0 7C08 03A6 83E1 FFFC"            /* €..È8!.À|..¦ƒáÿü */
	$"4E80 0020 0000 0000 0000 2041 8001 0000"            /* N€. ...... A€... */
	$"0000 006C 000F 2E49 735F 766F 6C5F 656A"            /* ...l...Is_vol_ej */
	$"6563 7465 6400 0000 93E1 FFFC 3C80 6963"            /* ected...“áÿü<€ic */
	$"3884 7323 7C03 2000 4182 0084 4080 0040"            /* 8„s#|. .A‚.„@€.@ */
	$"3C80 6963 3884 6C34 7C03 2000 4182 0060"            /* <€ic8„l4|. .A‚.` */
	$"4080 0018 3C80 4943 3884 4E23 7C03 2000"            /* @€..<€IC8„N#|. . */
	$"4182 0044 4800 0070 3C80 6963 3884 6C38"            /* A‚.DH..p<€ic8„l8 */
	$"7C03 2000 4182 0040 4800 005C 3C80 6963"            /* |. .A‚.@H..\<€ic */
	$"3884 7338 7C03 2000 4182 0044 4080 0048"            /* 8„s8|. .A‚.D@€.H */
	$"3C80 6963 3884 7334 7C03 2000 4182 0028"            /* <€ic8„s4|. .A‚.( */
	$"4800 0034 3BE0 0001 4800 0030 3BE0 0002"            /* H..4;à..H..0;à.. */
	$"4800 0028 3BE0 0003 4800 0020 3BE0 0004"            /* H..(;à..H.. ;à.. */
	$"4800 0018 3BE0 0005 4800 0010 3BE0 0006"            /* H...;à..H...;à.. */
	$"4800 0008 3BE0 0000 387F 0000 83E1 FFFC"            /* H...;à..8...ƒáÿü */
	$"4E80 0020 0000 0000 0000 2040 0001 0000"            /* N€. ...... @.... */
	$"0000 00BC 0010 2E52 6573 4963 6F6E 546F"            /* ...¼...ResIconTo */
	$"4454 4963 6F6E 0000 7C08 02A6 BF61 FFEC"            /* DTIcon..|..¦¿aÿì */
	$"9001 0008 9421 FFB0 3BA3 0000 9081 006C"            /* ...”!ÿ°;£...l */
	$"3BC5 0000 3BE0 0000 3B80 0000 3C1D 969D"            /* ;Å..;à..;€..<.– */
	$"2800 6C38 4182 0010 3C1D 969D 2800 6C34"            /* (.l8A‚..<.–(.l4 */
	$"4082 0010 881E 000A 2800 0000 4082 0028"            /* @‚..ˆ...(...@‚.( */
	$"3C1D 969D 2800 7338 4182 0010 3C1D 969D"            /* <.–(.s8A‚..<.– */
	$"2800 7334 4082 0014 881E 000B 2800 0000"            /* (.s4@‚..ˆ...(... */
	$"4182 0008 3B80 0001 387D 0000 4BFF FEAD"            /* A‚..;€..8}..Kÿş­ */
	$"3B63 0000 7F63 0734 3800 0000 7C00 0734"            /* ;c...c.48...|..4 */
	$"7C03 0050 7C00 0034 5400 D97E 7F9C 0378"            /* |..P|..4T.Ù~.œ.x */
	$"5780 063F 4082 0078 3860 0000 A89E 0008"            /* W€.?@‚.x8`..¨.. */
	$"38BB 0000 80DE 0000 80FE 0004 8101 006C"            /* 8»..€Ş..€ş....l */
	$"4800 11A9 6000 0000 3BE3 0000 7FE0 0735"            /* H..©`...;ã...à.5 */
	$"4082 0030 3C1D B6BD 2800 4E23 4082 0010"            /* @‚.0<.¶½(.N#@‚.. */
	$"3800 0000 981E 000A 4800 0018 3C1D 969D"            /* 8...˜...H...<.– */
	$"2800 7323 4082 000C 3800 0000 981E 000B"            /* (.s#@‚..8...˜... */
	$"7FE0 0734 2C00 EC6C 4182 0010 7FE0 0734"            /* .à.4,.ìlA‚...à.4 */
	$"2C00 FFCE 4082 0008 3BE0 0000 387F 0000"            /* ,.ÿÎ@‚..;à..8... */
	$"8001 0058 3821 0050 7C08 03A6 BB61 FFEC"            /* €..X8!.P|..¦»aÿì */
	$"4E80 0020 0000 0000 0000 2041 8005 0000"            /* N€. ...... A€... */
	$"0000 012C 000D 2E41 6464 4F6E 6544 5449"            /* ...,...AddOneDTI */
	$"636F 6E00 7C08 02A6 93E1 FFFC 93C1 FFF8"            /* con.|..¦“áÿü“Áÿø */
	$"93A1 FFF4 9001 0008 9421 FFA0 B061 007A"            /* “¡ÿô...”!ÿ °a.z */
	$"9081 007C 90A1 0080 90C1 0084 3BA7 0000"            /* .|¡.€Á.„;§.. */
	$"8061 007C 3881 003C 38A1 0038 4800 0175"            /* €a.|8.<8¡.8H..u */
	$"6000 0000 8001 003C 5400 040E 9001 003C"            /* `...€..<T.....< */
	$"8001 0038 5400 040E 9001 0038 387D 0000"            /* €..8T.....88}.. */
	$"4800 16E5 8041 0014 3BE3 0000 7FE0 0735"            /* H..å€A..;ã...à.5 */
	$"4082 00FC 8062 00EC 3880 0FE0 38A0 0001"            /* @‚.ü€b.ì8€.à8 .. */
	$"4800 15D5 8041 0014 7C7E 1B79 4082 000C"            /* H..Õ€A..|~.y@‚.. */
	$"3BE0 FF94 4800 009C 3800 0001 9801 004A"            /* ;àÿ”H..œ8...˜..J */
	$"3800 0001 9801 004B 8001 0080 9001 0040"            /* 8...˜..K€..€..@ */
	$"8001 0084 9001 0044 A801 007A B001 0048"            /* €..„..D¨..z°..H */
	$"807D 0000 8081 003C 38BE 0000 38C1 0040"            /* €}..€.<8¾..8Á.@ */
	$"4800 159D 8041 0014 3BE3 0000 7FE0 0735"            /* H..€A..;ã...à.5 */
	$"4082 0044 8001 0038 2800 0000 4182 0038"            /* @‚.D€..8(...A‚.8 */
	$"8801 004A 2800 0000 4182 002C 8801 004B"            /* ˆ..J(...A‚.,ˆ..K */
	$"2800 0000 4182 0020 807D 0000 8081 0038"            /* (...A‚. €}..€.8 */
	$"38BE 0000 38C1 0040 4800 1555 8041 0014"            /* 8¾..8Á.@H..U€A.. */
	$"3BE3 0000 387E 0000 4800 155D 8041 0014"            /* ;ã..8~..H..]€A.. */
	$"7FE0 0735 4082 0038 8801 004A 2800 0000"            /* .à.5@‚.8ˆ..J(... */
	$"4182 002C 8801 004B 2800 0000 4182 0020"            /* A‚.,ˆ..K(...A‚.  */
	$"3BE0 FC18 807D 0000 3880 0000 4800 1541"            /* ;àü.€}..8€..H..A */
	$"8041 0014 3800 0000 901D 0000 387F 0000"            /* €A..8......8... */
	$"8001 0068 3821 0060 7C08 03A6 83E1 FFFC"            /* €..h8!.`|..¦ƒáÿü */
	$"83C1 FFF8 83A1 FFF4 4E80 0020 0000 0000"            /* ƒÁÿøƒ¡ÿôN€. .... */
	$"0000 2041 8003 0000 0000 0188 000F 2E44"            /* .. A€......ˆ...D */
	$"5447 6574 4963 6F6E 5375 6974 6500 0000"            /* TGetIconSuite... */
	$"3C03 8000 2800 FF00 4082 001C 3CC0 0001"            /* <.€.(.ÿ.@‚..<À.. */
	$"38C6 FF00 90C4 0000 3800 00FF 9005 0000"            /* 8Æÿ.Ä..8..ÿ... */
	$"4E80 0020 3C03 8000 2800 00FF 4082 001C"            /* N€. <.€.(..ÿ@‚.. */
	$"3800 00FF 9004 0000 3CC0 0001 38C6 FF00"            /* 8..ÿ...<À..8Æÿ. */
	$"90C5 0000 4E80 0020 3C03 8000 2800 0400"            /* Å..N€. <.€.(... */
	$"4082 0018 3800 0500 9004 0000 3800 00FF"            /* @‚..8......8..ÿ */
	$"9005 0000 4E80 0020 9064 0000 3800 0000"            /* ...N€. d..8... */
	$"9005 0000 4E80 0020 0000 0000 0000 2040"            /* ...N€. ...... @ */
	$"0000 0000 0000 0078 0013 2E45 7870 616E"            /* .......x...Expan */
	$"644D 6574 6153 656C 6563 746F 7200 0000"            /* dMetaSelector... */
	$"93E1 FFFC 93C1 FFF8 3BC2 0370 3BE0 0000"            /* “áÿü“Áÿø;Â.p;à.. */
	$"4800 007C 3860 0000 7FE0 0734 1C00 0014"            /* H..|8`...à.4.... */
	$"7C7E 012E 3880 0000 7FE0 0734 1C60 0014"            /* |~..8€...à.4.`.. */
	$"3803 0004 7C9E 012E 3880 0000 7FE0 0734"            /* 8...|..8€...à.4 */
	$"1C60 0014 3803 0008 7C9E 012E 3880 0000"            /* .`..8...|..8€.. */
	$"7FE0 0734 1C60 0014 3803 000C 7C9E 012E"            /* .à.4.`..8...|.. */
	$"389F FFFF 7FE0 0734 1C60 0014 3803 0010"            /* 8Ÿÿÿ.à.4.`..8... */
	$"7C9E 032E 389F 0001 7FE0 0734 1C60 0014"            /* |..8Ÿ...à.4.`.. */
	$"3803 0012 7C9E 032E 3BFF 0001 7FE0 0734"            /* 8...|..;ÿ...à.4 */
	$"2C00 0014 4180 FF80 3800 0013 B002 00F8"            /* ,...A€ÿ€8...°..ø */
	$"83E1 FFFC 83C1 FFF8 4E80 0020 0000 0000"            /* ƒáÿüƒÁÿøN€. .... */
	$"0000 2040 0002 0000 0000 00AC 000C 2E46"            /* .. @.......¬...F */
	$"4949 6E69 7443 6163 6865 0000 93E1 FFFC"            /* IInitCache..“áÿü */
	$"3BE2 0370 7C64 0734 A802 00FA 7C04 0000"            /* ;â.p|d.4¨..ú|... */
	$"4182 00AC 7C60 0734 1C80 0014 3804 0012"            /* A‚.¬|`.4.€..8... */
	$"7CBF 02AE 7C60 0734 1C80 0014 3804 0010"            /* |¿.®|`.4.€..8... */
	$"7C1F 02AE 1C80 0014 3804 0012 7CBF 032E"            /* |..®.€..8...|¿.. */
	$"7C64 0734 A802 00F8 7C04 0000 4082 001C"            /* |d.4¨..ø|...@‚.. */
	$"7C60 0734 1C80 0014 3804 0010 7C1F 02AE"            /* |`.4.€..8...|..® */
	$"B002 00F8 4800 0030 7C60 0734 1C80 0014"            /* °..øH..0|`.4.€.. */
	$"3804 0010 7CBF 02AE 7C60 0734 1C80 0014"            /* 8...|¿.®|`.4.€.. */
	$"3804 0012 7C1F 02AE 1C80 0014 3804 0010"            /* 8...|..®.€..8... */
	$"7CBF 032E A8A2 00FA 7C60 0734 1C80 0014"            /* |¿..¨¢.ú|`.4.€.. */
	$"3804 0012 7CBF 032E A802 00FA 1C80 0014"            /* 8...|¿..¨..ú.€.. */
	$"3804 0010 7C7F 032E B062 00FA 83E1 FFFC"            /* 8...|...°b.úƒáÿü */
	$"4E80 0020 0000 0000 0000 2040 0001 0000"            /* N€. ...... @.... */
	$"0000 00C8 0010 2E46 494D 616B 6543 656C"            /* ...È...FIMakeCel */
	$"6C46 6972 7374 0000 7C08 02A6 BF61 FFEC"            /* lFirst..|..¦¿aÿì */
	$"9001 0008 9421 FFA0 3B63 0000 3B84 0000"            /* ...”!ÿ ;c..;„.. */
	$"3BA5 0000 3BC2 0370 3800 0000 9001 0038"            /* ;¥..;Â.p8.....8 */
	$"A862 00F8 A802 00FA 7C03 0000 4082 0008"            /* ¨b.ø¨..ú|...@‚.. */
	$"4BFF FE11 ABE2 00FA 7FE0 0734 1C00 0014"            /* Kÿş.«â.ú.à.4.... */
	$"7C1E 002E 7C1B 0040 4082 004C 7FE0 0734"            /* |...|..@@‚.L.à.4 */
	$"1C60 0014 3803 0004 7C1E 002E 7C1C 0040"            /* .`..8...|...|..@ */
	$"4082 0034 7FE0 0734 1C60 0014 3803 0008"            /* @‚.4.à.4.`..8... */
	$"7C1E 002E 7C1D 0040 4082 001C 7FE0 0734"            /* |...|..@@‚...à.4 */
	$"1C60 0014 3803 000C 7C1E 002E 9001 0038"            /* .`..8...|.....8 */
	$"4800 0028 7FE3 0734 A802 00F8 7C03 0000"            /* H..(.ã.4¨..ø|... */
	$"4182 0018 7FE0 0734 1C60 0014 3803 0012"            /* A‚...à.4.`..8... */
	$"7FFE 02AE 4BFF FF84 8001 0038 2800 0000"            /* .ş.®Kÿÿ„€..8(... */
	$"4182 0020 281D 0000 4182 0010 3861 0038"            /* A‚. (...A‚..8a.8 */
	$"4800 02C5 6000 0000 387F 0000 4BFF FE31"            /* H..Å`...8...Kÿş1 */
	$"8061 0038 8001 0068 3821 0060 7C08 03A6"            /* €a.8€..h8!.`|..¦ */
	$"BB61 FFEC 4E80 0020 0000 0000 0000 2041"            /* »aÿìN€. ...... A */
	$"8005 0000 0000 0100 0010 2E46 495F 6361"            /* €..........FI_ca */
	$"6368 655F 7365 6172 6368 0000 7C08 02A6"            /* che_search..|..¦ */
	$"93E1 FFFC 93C1 FFF8 93A1 FFF4 9001 0008"            /* “áÿü“Áÿø“¡ÿô... */
	$"9421 FFB0 9061 0068 9081 006C 3BA5 0000"            /* ”!ÿ°a.h.l;¥.. */
	$"90C1 0074 3BE2 0370 A862 00F8 A802 00FA"            /* Á.t;â.p¨b.ø¨..ú */
	$"7C03 0000 4082 0008 4BFF FCE9 281D 0000"            /* |...@‚..Kÿüé(... */
	$"4182 0018 3861 0074 4800 022D 6000 0000"            /* A‚..8a.tH..-`... */
	$"3BC3 0000 4800 0008 3BC0 0000 7FC0 0735"            /* ;Ã..H...;À...À.5 */
	$"4082 00A0 A802 00F8 1C60 0014 3803 000C"            /* @‚. ¨..ø.`..8... */
	$"7C1F 002E 2800 0000 4182 0038 A802 00F8"            /* |...(...A‚.8¨..ø */
	$"1C60 0014 3803 0008 7C1F 002E 2800 0000"            /* .`..8...|...(... */
	$"4182 0020 A802 00F8 1C60 0014 3803 000C"            /* A‚. ¨..ø.`..8... */
	$"7C7F 002E 3880 0001 4800 10C5 8041 0014"            /* |...8€..H..Å€A.. */
	$"8081 0074 A802 00F8 1C60 0014 3803 000C"            /* €.t¨..ø.`..8... */
	$"7C9F 012E 8061 0068 A802 00F8 1C00 0014"            /* |Ÿ..€a.h¨..ø.... */
	$"7C7F 012E 8081 006C A802 00F8 1C60 0014"            /* |...€.l¨..ø.`.. */
	$"3803 0004 7C9F 012E A802 00F8 1C60 0014"            /* 8...|Ÿ..¨..ø.`.. */
	$"3803 0008 7FBF 012E A862 00F8 4BFF FCF1"            /* 8....¿..¨b.øKÿüñ */
	$"8001 0058 3821 0050 7C08 03A6 83E1 FFFC"            /* €..X8!.P|..¦ƒáÿü */
	$"83C1 FFF8 83A1 FFF4 4E80 0020 0000 0000"            /* ƒÁÿøƒ¡ÿôN€. .... */
	$"0000 2041 8003 0000 0000 0120 0012 2E46"            /* .. A€...... ...F */
	$"495F 7374 6F72 655F 696E 5F63 6163 6865"            /* I_store_in_cache */
	$"7C08 02A6 93E1 FFFC 93C1 FFF8 9001 0008"            /* |..¦“áÿü“Áÿø... */
	$"9421 FFC0 3BE4 0000 8004 0000 2800 0000"            /* ”!ÿÀ;ä..€...(... */
	$"4182 0040 807F 0000 8003 0000 2800 0000"            /* A‚.@€...€...(... */
	$"4082 0010 807F 0000 4800 112D 8041 0014"            /* @‚..€...H..-€A.. */
	$"387F 0000 4800 10D9 8041 0014 3BC3 0000"            /* 8...H..Ù€A..;Ã.. */
	$"7FC0 0735 4182 000C 3800 0000 901F 0000"            /* .À.5A‚..8...... */
	$"3860 0000 8001 0048 3821 0040 7C08 03A6"            /* 8`..€..H8!.@|..¦ */
	$"83E1 FFFC 83C1 FFF8 4E80 0020 0000 0000"            /* ƒáÿüƒÁÿøN€. .... */
	$"0000 2041 8002 0000 0000 007C 000E 2E43"            /* .. A€......|...C */
	$"6F70 795F 6F6E 655F 6963 6F6E 7C08 02A6"            /* opy_one_icon|..¦ */
	$"93E1 FFFC 93C1 FFF8 9001 0008 9421 FFC0"            /* “áÿü“Áÿø...”!ÿÀ */
	$"9061 0058 8062 00F4 3880 0FE0 38A0 0001"            /* a.X€b.ô8€.à8 .. */
	$"4800 0F25 8041 0014 3BE3 0000 8061 0058"            /* H..%€A..;ã..€a.X */
	$"3880 FFFF 38BF 0000 38C0 0000 4800 0F21"            /* 8€ÿÿ8¿..8À..H..! */
	$"8041 0014 3BC3 0000 387F 0000 4800 0F29"            /* €A..;Ã..8...H..) */
	$"8041 0014 387E 0000 8001 0048 3821 0040"            /* €A..8~..€..H8!.@ */
	$"7C08 03A6 83E1 FFFC 83C1 FFF8 4E80 0020"            /* |..¦ƒáÿüƒÁÿøN€.  */
	$"0000 0000 0000 2041 8002 0000 0000 0074"            /* ...... A€......t */
	$"0012 2E46 495F 636F 7079 5F65 6163 685F"            /* ...FI_copy_each_ */
	$"6963 6F6E 7C08 02A6 93E1 FFFC 93C1 FFF8"            /* icon|..¦“áÿü“Áÿø */
	$"9001 0008 9421 FFC0 3BC3 0000 4800 0FD1"            /* ...”!ÿÀ;Ã..H..Ñ */
	$"8041 0014 3BE3 0000 7FE0 0735 4082 0034"            /* €A..;ã...à.5@‚.4 */
	$"807E 0000 4BFF FF39 3BE3 0000 7FE0 0735"            /* €~..Kÿÿ9;ã...à.5 */
	$"4182 0028 807E 0000 3880 0001 4800 0EB1"            /* A‚.(€~..8€..H..± */
	$"8041 0014 3800 0000 901E 0000 4800 000C"            /* €A..8......H... */
	$"3800 0000 901E 0000 387F 0000 8001 0048"            /* 8......8...€..H */
	$"3821 0040 7C08 03A6 83E1 FFFC 83C1 FFF8"            /* 8!.@|..¦ƒáÿüƒÁÿø */
	$"4E80 0020 0000 0000 0000 2041 8002 0000"            /* N€. ...... A€... */
	$"0000 0080 000F 2E46 495F 636C 6F6E 655F"            /* ...€...FI_clone_ */
	$"7375 6974 6500 0000 7C08 02A6 93E1 FFFC"            /* suite...|..¦“áÿü */
	$"9001 0008 9421 FF70 B061 00AA 3801 0038"            /* ...”!ÿp°a.ª8..8 */
	$"9001 006C 3800 0014 9001 0070 A801 00AA"            /* ..l8.....p¨..ª */
	$"B001 0062 3800 0000 9001 005E 3861 004C"            /* °..b8.....^8a.L */
	$"4800 0FB5 8041 0014 3861 0038 8063 000A"            /* H..µ€A..8a.8€c.. */
	$"3800 0000 7C03 0050 7C00 0034 541F D97E"            /* 8...|..P|..4T.Ù~ */
	$"387F 0000 8001 0098 3821 0090 7C08 03A6"            /* 8...€..˜8!.|..¦ */
	$"83E1 FFFC 4E80 0020 0000 0000 0000 2041"            /* ƒáÿüN€. ...... A */
	$"8001 0000 0000 0070 0010 2E49 735F 6C6F"            /* €......p...Is_lo */
	$"6361 6C5F 766F 6C75 6D65 0000 7C08 02A6"            /* cal_volume..|..¦ */
	$"93E1 FFFC 93C1 FFF8 93A1 FFF4 9001 0008"            /* “áÿü“Áÿø“¡ÿô... */
	$"9421 FF30 B061 00EA 9081 00EC 8001 00EC"            /* ”!ÿ0°a.ê.ì€..ì */
	$"9001 004A A801 00EA B001 004E 3800 0000"            /* ..J¨..ê°..N8... */
	$"9801 0052 3BC0 0001 3BA0 0000 3800 0002"            /* ˜..R;À..; ..8... */
	$"9001 0068 B3C1 0054 3861 0038 4800 0FB1"            /* ..h³Á.T8a.8H..± */
	$"8041 0014 3BE3 0000 7FE0 0735 4082 0030"            /* €A..;ã...à.5@‚.0 */
	$"3861 0038 8063 0020 3C03 B9B2 2800 4452"            /* 8a.8€c. <.¹²(.DR */
	$"4082 001C 3861 0038 8063 0024 3C03 BAAE"            /* @‚..8a.8€c.$<.º® */
	$"2800 494B 4082 0008 3BA0 0001 7FE0 0735"            /* (.IK@‚..; ...à.5 */
	$"3BDE 0001 4082 000C 57A0 063F 4182 FFA0"            /* ;Ş..@‚..W .?A‚ÿ  */
	$"387F 0000 8001 00D8 3821 00D0 7C08 03A6"            /* 8...€..Ø8!.Ğ|..¦ */
	$"83E1 FFFC 83C1 FFF8 83A1 FFF4 4E80 0020"            /* ƒáÿüƒÁÿøƒ¡ÿôN€.  */
	$"0000 0000 0000 2041 8003 0000 0000 00C4"            /* ...... A€......Ä */
	$"0013 2E47 6574 4465 736B 746F 7046 696C"            /* ...GetDesktopFil */
	$"654E 616D 6500 0000 7C08 02A6 93E1 FFFC"            /* eName...|..¦“áÿü */
	$"93C1 FFF8 93A1 FFF4 9381 FFF0 9001 0008"            /* “Áÿø“¡ÿô“ÿğ... */
	$"9421 FF30 3B83 0000 3BA4 0000 90A1 00F0"            /* ”!ÿ0;ƒ..;¤..¡.ğ */
	$"3BC6 0000 3800 0014 9001 00A0 38A1 00A4"            /* ;Æ..8..... 8¡.¤ */
	$"38C1 00A0 4800 08DD 6000 0000 3BE3 0000"            /* 8Á. H..İ`...;ã.. */
	$"7FE0 0735 4082 007C 8001 00A6 5400 04E7"            /* .à.5@‚.|€..¦T..ç */
	$"4182 006C 9381 004A B3A1 004E 3861 0038"            /* A‚.l“.J³¡.N8a.8 */
	$"4800 0E1D 8041 0014 3BE3 0000 8001 0054"            /* H...€A..;ã..€..T */
	$"5403 07FE 3800 0000 7C03 0050 7C00 0034"            /* T..ş8...|..P|..4 */
	$"5400 D97E 981E 0000 7FE0 0734 2C00 FFCE"            /* T.Ù~˜....à.4,.ÿÎ */
	$"4082 001C 3861 0038 4800 0DFD 8041 0014"            /* @‚..8a.8H..ı€A.. */
	$"3BE3 0000 3800 0000 981E 0000 A801 0050"            /* ;ã..8...˜...¨..P */
	$"8061 00F0 B003 0000 4800 0008 3BE0 FFCE"            /* €a.ğ°...H...;àÿÎ */
	$"387F 0000 8001 00D8 3821 00D0 7C08 03A6"            /* 8...€..Ø8!.Ğ|..¦ */
	$"83E1 FFFC 83C1 FFF8 83A1 FFF4 8381 FFF0"            /* ƒáÿüƒÁÿøƒ¡ÿôƒÿğ */
	$"4E80 0020 0000 0000 0000 2041 8004 0000"            /* N€. ...... A€... */
	...
	$"3863 444C 4800 0E01 8041 0014 3B63 0000"            /* 8cDLH...€A..;c.. */
	$"3BC0 0001 3800 0000 901D 0000 4800 005C"            /* ;À..8......H..\ */
	$"3C60 424E 389E 0000 3863 444C 4800 0DF1"            /* <`BN8..8cDLH..ñ */
	$"8041 0014 7C7F 1B79 4182 003C 807F 0000"            /* €A..|..yA‚.<€... */
	$"8003 0000 7C00 D040 4082 002C 807F 0000"            /* €...|.Ğ@@‚.,€... */
	$"A803 0006 2C00 0000 4180 001C 807F 0000"            /* ¨...,...A€..€... */
	$"A803 000C 2C00 0000 4180 000C 93FD 0000"            /* ¨...,...A€..“ı.. */
	$"3B80 0000 3BDE 0001 7FC3 0734 7F60 0734"            /* ;€..;Ş...Ã.4.`.4 */
	$"7C03 0000 4181 0010 801D 0000 2800 0000"            /* |...A..€...(... */
	$"4182 FF90 387C 0000 8001 0058 3821 0050"            /* A‚ÿ8|..€..X8!.P */
	...
	$"7FE0 FA14 3BFF 0006 3BDE 0001 7FC7 0734"            /* .àú.;ÿ..;Ş...Ç.4 */
	$"80C4 0000 A8C6 0006 3806 0001 7C07 0000"            /* €Ä..¨Æ..8...|... */
	$"4080 0010 8005 0000 2800 0000 4182 FFA4"            /* @€..€...(...A‚ÿ¤ */
	$"387D 0000 83E1 FFFC 83C1 FFF8 83A1 FFF4"            /* 8}..ƒáÿüƒÁÿøƒ¡ÿô */
	...
	$"A89D 0002 3863 4546 4800 0A95 8041 0014"            /* ¨..8cEFH..•€A.. */
	$"7C7F 1B79 4182 0024 807F 0000 8003 0000"            /* |..yA‚.$€...€... */
	$"7C00 C840 4082 0014 807F 0000 A803 0004"            /* |.È@@‚..€...¨... */
	$"B01C 0000 3B60 0000 3BBD 0004 3BDE 0001"            /* °...;`..;½..;Ş.. */
	$"7FC3 0734 A81A 0004 7C03 0000 4181 0010"            /* .Ã.4¨...|...A.. */
	$"A81C 0000 2C00 0000 4182 FFA4 387B 0000"            /* ¨...,...A‚ÿ¤8{.. */
	...
	$"3BDE 0001 7FC6 0734 A803 0004 7C06 0000"            /* ;Ş...Æ.4¨...|... */
	...
	$"9001 0008 9421 FE90 9061 0188 B081 018E"            /* ...”!şa.ˆ°. */
	$"B0A1 0192 90C1 0194 90E1 0198 3B48 0000"            /* °¡.’Á.”á.˜;H.. */
	$"3800 0000 9001 0044 3800 0000 9008 0000"            /* 8.....D8...... */
	$"8061 0188 A881 018E 38A1 0148 4800 0561"            /* €a.ˆ¨.8¡.HH..a */
	$"6000 0000 3BE3 0000 7FE0 0735 4082 01C8"            /* `...;ã...à.5@‚.È */
	$"A861 0148 3881 0048 4BFF F9C5 3BE3 0000"            /* ¨a.H8.HKÿùÅ;ã.. */
	$"7FE0 0735 4082 0198 4800 07BD 8041 0014"            /* .à.5@‚.˜H..½€A.. */
	$"3B83 0000 3860 0000 4800 07C5 8041 0014"            /* ;ƒ..8`..H..Å€A.. */
	$"A861 0148 3880 0002 38A1 0048 38C0 0001"            /* ¨a.H8€..8¡.H8À.. */
	$"4800 08CD 8041 0014 3BC3 0000 3860 0001"            /* H..Í€A..;Ã..8`.. */
	$"4800 079D 8041 0014 7FC0 0734 2C00 FFFF"            /* H..€A...À.4,.ÿÿ */
	$"4182 0140 8061 0194 3881 0044 4BFF FB55"            /* A‚.@€a.”8.DKÿûU */
	$"3BE3 0000 7FE0 0735 4082 010C 8061 0044"            /* ;ã...à.5@‚..€a.D */
	$"4800 0995 8041 0014 3B63 0000 8061 0044"            /* H..•€A..;c..€a.D */
	$"4800 08F5 8041 0014 3C60 4652 8081 0044"            /* H..õ€A..<`FR€.D */
	...
	$"4BFF FD4D 3BE3 0000 7FE0 0735 4082 0068"            /* KÿıM;ã...à.5@‚.h */
	$"A861 0192 4BFF FDDD 7C7D 1B79 4182 0058"            /* ¨a.’Kÿıİ|}.yA‚.X */
	$"387D 0000 A881 003C 4800 0725 8041 0014"            /* 8}..¨.<H..%€A.. */
	$"9061 0038 8001 0038 2800 0000 4182 0034"            /* a.8€..8(...A‚.4 */
	$"3861 0038 4800 0739 8041 0014 4800 08E1"            /* 8a.8H..9€A..H..á */
	$"8041 0014 7C60 0735 4082 0010 8001 0038"            /* €A..|`.5@‚..€..8 */
	$"901A 0000 4800 0010 3BE0 EC6C 4800 0008"            /* ...H...;àìlH... */
	$"3BE0 EC6C 8061 0044 389B 0000 4800 08C9"            /* ;àìl€a.D8›..H..É */
	$"8041 0014 387C 0000 4800 0725 8041 0014"            /* €A..8|..H..%€A.. */
	$"387E 0000 4800 0701 8041 0014 4800 0010"            /* 8~..H...€A..H... */
	$"4800 067D 8041 0014 3BE3 0000 7FE0 0735"            /* H..}€A..;ã...à.5 */
	$"4182 0014 7FE0 0734 2C00 FF94 4182 0008"            /* A‚...à.4,.ÿ”A‚.. */
	$"3BE0 EC6C 387F 0000 8001 0178 3821 0170"            /* ;àìl8...€..x8!.p */
	$"7C08 03A6 BB41 FFE8 4E80 0020 0000 0000"            /* |..¦»AÿèN€. .... */
	...
	$"4BFF F879 3BC3 0000 7FC0 0735 4082 0130"            /* Kÿøy;Ã...À.5@‚.0 */
	$"8801 0038 2800 0000 4082 011C 7F80 0734"            /* ˆ..8(...@‚...€.4 */
	...
	$"4182 009C 387F 0000 4800 0695 8041 0014"            /* A‚.œ8...H..•€A.. */
	$"907D 0000 801D 0000 2800 0000 4182 0078"            /* }..€...(...A‚.x */
	$"807D 0000 4800 0691 8041 0014 A801 003A"            /* €}..H..‘€A..¨..: */
	$"B001 0054 3800 0000 9001 0058 807D 0000"            /* °..T8.....X€}.. */
	$"8003 0000 9001 005C 93E1 0060 9B81 0069"            /* €.....\“á.`›.i */
	$"9341 0070 9361 0074 3861 003C 4800 0671"            /* “A.p“a.t8a.<H..q */
	$"8041 0014 3BC3 0000 807D 0000 4800 0679"            /* €A..;Ã..€}..H..y */
	$"8041 0014 7FC0 0735 4182 0054 807D 0000"            /* €A...À.5A‚.T€}.. */
	$"4800 0455 8041 0014 3800 0000 901D 0000"            /* H..U€A..8...... */
	$"4800 003C 3BC0 FF94 4800 0034 3BC0 FFCE"            /* H..<;Àÿ”H..4;ÀÿÎ */
	$"4800 002C 3BC0 EC6C 4800 0024 3878 0000"            /* H..,;ÀìlH..$8x.. */
	$"3899 0000 38BC 0000 38DA 0000 38FB 0000"            /* 8™..8¼..8Ú..8û.. */
	$"391D 0000 4BFF FC15 3BC3 0000 387E 0000"            /* 9...Kÿü.;Ã..8~.. */
	$"8001 00D8 3821 00D0 7C08 03A6 BB01 FFE0"            /* €..Ø8!.Ğ|..¦».ÿà */
	$"4E80 0020 0000 0000 0000 2041 8008 0000"            /* N€. ...... A€... */
	$"0000 01AC 000A 2E44 5447 6574 4963 6F6E"            /* ...¬...DTGetIcon */
	$"7C08 02A6 93E1 FFFC 93C1 FFF8 9001 0008"            /* |..¦“áÿü“Áÿø... */
	$"9421 FF40 9061 00D8 B081 00DE 90A1 00E0"            /* ”!ÿ@a.Ø°.Ş¡.à */
	$"3BC6 0000 8001 00D8 9001 004A A801 00DE"            /* ;Æ..€..Ø..J¨..Ş */
	$"B001 004E 8001 00E0 9001 0058 8006 0000"            /* °..N€..à..X€... */
	$"9001 005C 3861 0038 4800 050D 8041 0014"            /* ..\8a.8H...€A.. */
	$"3BE3 0000 7FE0 0735 4082 000C 8001 0060"            /* ;ã...à.5@‚..€..` */
	$"901E 0000 387F 0000 8001 00C8 3821 00C0"            /* ...8...€..È8!.À */
	$"7C08 03A6 83E1 FFFC 83C1 FFF8 4E80 0020"            /* |..¦ƒáÿüƒÁÿøN€.  */
	...
	$"9001 0008 9421 FEB0 3BA3 0000 B081 016E"            /* ...”!ş°;£..°.n */
	$"7CBF 2B79 4182 006C A801 016E B01F 0016"            /* |¿+yA‚.l¨..n°... */
	$"281D 0000 4082 0018 3800 0000 901F 0012"            /* (...@‚..8...... */
	$"3800 0000 B01F 001C 4800 002C 387D 0000"            /* 8...°...H..,8}.. */
	$"3881 0038 88BD 0000 38A5 0001 4800 01E9"            /* 8.8ˆ½..8¥..H..é */
	$"8041 0014 3801 0038 901F 0012 3800 FFFF"            /* €A..8..8...8.ÿÿ */
	$"B01F 001C 387F 0000 4800 01B5 8041 0014"            /* °...8...H..µ€A.. */
	$"3BC3 0000 3800 0000 901F 0012 4800 0008"            /* ;Ã..8......H... */
	$"3BC0 FFCE 387E 0000 8001 0158 3821 0150"            /* ;ÀÿÎ8~..€..X8!.P */
	...
	$"93E1 FFFC 9001 0008 9421 FF40 9061 00D8"            /* “áÿü...”!ÿ@a.Ø */
	$"B081 00DE 90A1 00E0 8061 00D8 A881 00DE"            /* °.Ş¡.à€a.Ø¨.Ş */
	$"38A1 0038 4BFF FEFD 3BE3 0000 7FE0 0735"            /* 8¡.8Kÿşı;ã...à.5 */
	$"4082 0010 A801 004E 8061 00E0 B003 0000"            /* @‚..¨..N€a.à°... */
	$"387F 0000 8001 00C8 3821 00C0 7C08 03A6"            /* 8...€..È8!.À|..¦ */
	$"83E1 FFFC 4E80 0020 0000 0000 0000 2041"            /* ƒáÿüN€. ...... A */
	$"8001 0000 0000 005C 0011 2E44 6574 6572"            /* €......\...Deter */
	$"6D69 6E65 5652 6566 4E75 6D00 7C08 02A6"            /* mineVRefNum.|..¦ */
	$"93E1 FFFC 93C1 FFF8 93A1 FFF4 9381 FFF0"            /* “áÿü“Áÿø“¡ÿô“ÿğ */
	$"9001 0008 9421 FFB0 B061 006A 3B84 0000"            /* ...”!ÿ°°a.j;„.. */
	$"A861 006A 4800 04B1 8041 0014 7C7F 1B79"            /* ¨a.jH..±€A..|..y */
	$"4182 004C 807F 0000 A803 0004 5400 0673"            /* A‚.L€...¨...T..s */
	$"4182 0014 807F 0000 8063 0000 83C3 0000"            /* A‚..€...€c..ƒÃ.. */
	$"4800 000C 807F 0000 83C3 0000 387E 0012"            /* H...€...ƒÃ..8~.. */
	$"389C 0000 88BE 0012 38A5 0001 4800 0079"            /* 8œ..ˆ¾..8¥..H..y */
	$"8041 0014 3BA0 0000 4800 0010 3800 0000"            /* €A..; ..H...8... */
	$"981C 0000 3BA0 FFEB 387D 0000 8001 0058"            /* ˜...; ÿë8}..€..X */
	$"3821 0050 7C08 03A6 83E1 FFFC 83C1 FFF8"            /* 8!.P|..¦ƒáÿüƒÁÿø */
	$"83A1 FFF4 8381 FFF0 4E80 0020 0000 0000"            /* ƒ¡ÿôƒÿğN€. .... */
	$"0000 2041 8004 0000 0000 00B0 000E 2E47"            /* .. A€......°...G */
	$"6574 4472 6976 6572 4E61 6D65 8182 0068"            /* etDriverName‚.h */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0060 9041 0014 800C 0000"            /* N€. ‚.`A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 003C"            /* €L..|..¦N€. ‚.< */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0070 9041 0014 800C 0000"            /* N€. ‚.pA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 00C0"            /* €L..|..¦N€. ‚.À */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 00BC 9041 0014 800C 0000"            /* N€. ‚.¼A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 00B8"            /* €L..|..¦N€. ‚.¸ */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 004C 9041 0014 800C 0000"            /* N€. ‚.LA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0050"            /* €L..|..¦N€. ‚.P */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0000 9041 0014 800C 0000"            /* N€. ‚..A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0048"            /* €L..|..¦N€. ‚.H */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0010 9041 0014 800C 0000"            /* N€. ‚..A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 00B4"            /* €L..|..¦N€. ‚.´ */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 006C 9041 0014 800C 0000"            /* N€. ‚.lA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0008"            /* €L..|..¦N€. ‚.. */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 008C 9041 0014 800C 0000"            /* N€. ‚.ŒA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0024"            /* €L..|..¦N€. ‚.$ */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0044 9041 0014 800C 0000"            /* N€. ‚.DA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 005C"            /* €L..|..¦N€. ‚.\ */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 00B0 9041 0014 800C 0000"            /* N€. ‚.°A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 007C"            /* €L..|..¦N€. ‚.| */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 00A0 9041 0014 800C 0000"            /* N€. ‚. A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0034"            /* €L..|..¦N€. ‚.4 */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0014 9041 0014 800C 0000"            /* N€. ‚..A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 000C"            /* €L..|..¦N€. ‚.. */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0054 9041 0014 800C 0000"            /* N€. ‚.TA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0018"            /* €L..|..¦N€. ‚.. */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 00AC 9041 0014 800C 0000"            /* N€. ‚.¬A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0090"            /* €L..|..¦N€. ‚. */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0020 9041 0014 800C 0000"            /* N€. ‚. A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0030"            /* €L..|..¦N€. ‚.0 */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0088 9041 0014 800C 0000"            /* N€. ‚.ˆA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0064"            /* €L..|..¦N€. ‚.d */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 00A8 9041 0014 800C 0000"            /* N€. ‚.¨A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0074"            /* €L..|..¦N€. ‚.t */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 009C 9041 0014 800C 0000"            /* N€. ‚.œA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 00A4"            /* €L..|..¦N€. ‚.¤ */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0080 9041 0014 800C 0000"            /* N€. ‚.€A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0038"            /* €L..|..¦N€. ‚.8 */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0078 9041 0014 800C 0000"            /* N€. ‚.xA..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0094"            /* €L..|..¦N€. ‚.” */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 002C 9041 0014 800C 0000"            /* N€. ‚.,A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0098"            /* €L..|..¦N€. ‚.˜ */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0084 9041 0014 800C 0000"            /* N€. ‚.„A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0040"            /* €L..|..¦N€. ‚.@ */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0028 9041 0014 800C 0000"            /* N€. ‚.(A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 0058"            /* €L..|..¦N€. ‚.X */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 8182 0004 9041 0014 800C 0000"            /* N€. ‚..A..€... */
	$"804C 0004 7C09 03A6 4E80 0420 8182 001C"            /* €L..|..¦N€. ‚.. */
	$"9041 0014 800C 0000 804C 0004 7C09 03A6"            /* A..€...€L..|..¦ */
	$"4E80 0420 0000 0000 0000 0000 0000 0000"            /* N€. ............ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	...
	$"0000 0000 0000 0F98 0000 0000 0000 15B0"            /* .......˜.......° */
	$"0000 0000 0000 1D68 0000 0000 6465 736B"            /* .......h....desk */
	$"FFFF F068 7472 7368 FFFF F067 6173 74C4"            /* ÿÿğhtrshÿÿğgastÄ */
	$"FFFF F096 7574 69C4 FFFF F097 6D6F 72C4"            /* ÿÿğ–utiÄÿÿğ—morÄ */
	$"FFFF F085 6578 746E FFFF F07B 6374 726C"            /* ÿÿğ…extnÿÿğ{ctrl */
	$"FFFF F078 666F 6E74 FFFF F080 7072 6566"            /* ÿÿğxfontÿÿğ€pref */
	$"FFFF F07A 616D 6E75 FFFF F072 7072 6E74"            /* ÿÿğzamnuÿÿğrprnt */
	$"FFFF F079 7374 7274 FFFF F073 7368 6466"            /* ÿÿğystrtÿÿğsshdf */
	$"FFFF F073 7364 6576 FFFF F086 C473 6372"            /* ÿÿğssdevÿÿğ†Äscr */
	$"FFFF F089 C46E 6574 FFFF F08A C470 7264"            /* ÿÿğ‰ÄnetÿÿğŠÄprd */
	$"FFFF F08E 7070 6466 FFFF F08F 6374 7244"            /* ÿÿğppdfÿÿğctrD */
	$"FFFF F091 6578 7444 FFFF F092 7374 7244"            /* ÿÿğ‘extDÿÿğ’strD */
	$"FFFF F093 636D 6E75 FFFF F09A 7368 6444"            /* ÿÿğ“cmnuÿÿğšshdD */
	$"FFFF F094 6173 7570 FFFF F098 6D61 6344"            /* ÿÿğ”asupÿÿğ˜macD */
	$"FFFF F095 636D 6E75 FFFF F09A C476 6F63"            /* ÿÿğ•cmnuÿÿğšÄvoc */
	$"FFFF F090 C474 6578 FFFF F08D C46C 6962"            /* ÿÿğÄtexÿÿğÄlib */
	$"FFFF F08C C468 6C70 FFFF F088 C473 6E64"            /* ÿÿğŒÄhlpÿÿğˆÄsnd */
	$"FFFF F087 0000 0000 0000 0000 0000 0000"            /* ÿÿğ‡............ */
	$"0000 0000 0000 0000 0000 0000 0000 0000"            /* ................ */
	$"0000 0000 6664 7270 FFFF F061 7472 7368"            /* ....fdrpÿÿğatrsh */
	$"FFFF F067 6661 7379 FFFF F071 494E 4954"            /* ÿÿğgfasyÿÿğqINIT */
	$"FFFF BFE1 4150 504C FFFF F064 6466 696C"            /* ÿÿ¿áAPPLÿÿğddfil */
	$"FFFF F069 7072 6566 FFFF F07D 6661 616D"            /* ÿÿğiprefÿÿğ}faam */
	$"FFFF F072 6661 6374 FFFF F078 6661 6578"            /* ÿÿğrfactÿÿğxfaex */
	...
	$"FFFF F074 6661 6472 FFFF F075 6661 7368"            /* ÿÿğtfadrÿÿğufash */
	$"FFFF F076 6661 6D6E FFFF F077 7468 6E67"            /* ÿÿğvfamnÿÿğwthng */
	$"FFFF BFE1 7368 6C62 FFFF F081 6966 696C"            /* ÿÿ¿áshlbÿÿğifil */
	$"0000 30D4 6666 696C 0000 38A4 7366 696C"            /* ..0Ôffil..8¤sfil */
	$"0000 36B0 7466 696C 0000 38A5 4646 494C"            /* ..6°tfil..8¥FFIL */
	$"0000 3C8C 4446 494C 0000 3D86 6B66 696C"            /* ..<ŒDFIL..=†kfil */
	$"0000 399E 6966 696C FFFF F11F 6666 696C"            /* ..9ifilÿÿñ.ffil */
	$"FFFF F121 7366 696C FFFF F11E 7466 696C"            /* ÿÿñ!sfilÿÿñ.tfil */
	$"FFFF F120 4646 494C FFFF F124 4446 494C"            /* ÿÿñ FFILÿÿñ$DFIL */
	$"FFFF F123 6B66 696C FFFF F122 636C 7073"            /* ÿÿñ#kfilÿÿñ"clps */
	$"FFFF F125 636C 7070 FFFF F127 636C 7074"            /* ÿÿñ%clppÿÿñ'clpt */
...
data 'clut' (4001, "Windows 8-bit Colors") {
	...
	$"0000 FF00 FF00 FF00 0000 FE00 FE00 FE00"            /* ..ÿ.ÿ.ÿ...ş.ş.ş. */
