/* Resource fork of software/extras/Iconographer Support/Translations/Iconographer Japanese 2.2/Japanese Resources/ToolPaletteJ.rsrc */
...
resource 'MENU' (624) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"ÉAÉìÉ`ÉGÉCÉäÉAÉX - êÿ", noIcon, noKey, noMark, plain,
		/* [2] */
		"ÉAÉìÉ`ÉGÉCÉäÉAÉX - ì¸", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (625) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"ã´äEê¸Çï`Ç≠", noIcon, noKey, noMark, plain,
		/* [2] */
		"ìhÇËí◊Çµ", noIcon, noKey, noMark, plain
	}
};
...
resource 'STR#' (600, "Tool Balloon Help") {
	{	/* array StringArray: 23 elements */
		...
		"ägëÂÅ^èkè¨ÉcÅ[Éã (Z)",
		/* [17] */
		"ÉâÉCÉìÇÃëæÇ≥\n\nÇ±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ±Ç∆Ç≈ï`"
		"âÊÇ∑ÇÈÉâÉCÉìÇÃëæÇ≥ÇïœçXÇ≈Ç´Ç‹Ç∑ÅB",
		/* [18] */
		"ÉAÉìÉ`ÉGÉCÉäÉAÉX\n\nÇ±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ±Ç∆"
		"Ç≈ï`âÊÇ∑ÇÈÉâÉCÉìÇ…ÉAÉìÉ`ÉGÉCÉäÉAÉXÇÇ©ÇØ"
		"ÇÈÇ©Ç«Ç§Ç©ê›íËÇ≈Ç´Ç‹Ç∑ÅB",
		/* [19] */
		"ìhÇË\n\nÇ±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆å`èÛÇÃì‡ë§Çìh"
		"ÇËÇ¬Ç‘Ç∑Ç©Ç«Ç§Ç©Çê›íËÇ≈Ç´Ç‹Ç∑ÅB",
		/* [20] */
		"ÉpÉ^Å[Éì\n\nåªç›ÇÃï`âÊÉpÉ^Å[ÉìÇ™Ç±Ç±Ç…ï\\é¶"
		"Ç≥ÇÍÇ‹Ç∑ÅBÇ±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆ï`âÊÉpÉ^Å["
		"ÉìÇïœçXèoóàÇ‹Ç∑ÅB",
		/* [21] */
		"êFêÿÇËë÷Ç¶\n\nåªç›ÇÃëOåiêFÇ∆îwåiêFÇ™Ç±Ç±Ç…"
		"ï\\é¶Ç≥ÇÍÇ‹Ç∑ÅBÇ±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆êFÇïœ"
		"çXèoóàÇ‹Ç∑ÅB",
		/* [22] */
		"êFÇÃì¸ÇÍë÷Ç¶ (X)",
		/* [23] */
