/* Resource fork of software/extras/Iconographer Support/Translations/Iconographer 1.1J0131r1/Iconographer 1.1 J1 */
...
resource 'STR#' (162, "Windows Balloon Help", purgeable) {
	{	/* array StringArray: 3 elements */
		...
		"ographer ‚ªƒAƒCƒRƒ“‚ğŠJ‚¢‚½‚Ég—p‚·‚éƒ"
		"pƒŒƒbƒg‚ğ•\\¦^”ñ•\\¦‚·‚é‚½‚ß‚Ég—p‚µ‚Ü‚"
		"·B\n\n—˜—p‰Â”\\‚ÈƒEƒCƒ“ƒhƒE‚ª‘¶İ‚µ‚È‚¢‚Ì‚"
		"Åg—po—ˆ‚Ü‚¹‚ñB",
		/* [3] */
		"F‘I‘ğ‚Ì‚½‚ß‚ÌŠeí‹@”\\‚ğŠÜ‚Şƒtƒ[ƒeƒBƒ“"
		"ƒOƒEƒCƒ“ƒhƒE‚Ì•\\¦^”ñ•\\¦‚ğØ‚è‘Ö‚¦‚é‚½"
		"‚ß‚Ég—p‚µ‚Ü‚·B"
	}
};
...
resource 'STR#' (129, "-Standard Errors", purgeable) {
	{	/* array StringArray: 15 elements */
		...
		"EƒFƒA‚©AƒAƒsƒAƒ‰ƒ“ƒXƒ}ƒl[ƒWƒƒ‚ğƒCƒ“ƒXƒ"
		"g[ƒ‹‚µ‚Ä‰º‚³‚¢BƒAƒbƒvƒ‹’ñ‹Ÿ‚Ì Manager "
		"SDK ‚ğg—p‚µ‚Ä‚¢‚Ü‚·B"
	}
};
...
resource 'mctb' (207, "ƒoƒbƒeƒŠ•\\¦ menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
