/* Resource fork of software/extras/Iconographer Support/Testing/IconographerJ Dev/Iconographer √¨Àô√±{√•√ç√Æ‚âà/Iconographer 1.0.2 J */
resource 'MENU' (128) {
	128,
	textMenuProc,
	0x7FFFFFFB,
	...
	{	/* array: 3 elements */
		/* [1] */
		"Iconographer Ç…Ç¬Ç¢Çƒ...", noIcon, noKey, noMark, plain,
		/* [2] */
		"ìoò^...", noIcon, noKey, noMark, plain,
		/* [3] */
...
resource 'MENU' (130) {
	...
	{	/* array: 3 elements */
		/* [1] */
		"MacOS ÉAÉCÉRÉì...", noIcon, "O", noMark, plain,
		/* [2] */
		"Windows ÉAÉCÉRÉì...", noIcon, "O", noMark, plain,
		/* [3] */
		"MacOS X ÉAÉCÉRÉì...", noIcon, "O", noMark, plain
	}
};
...
resource 'MENU' (132) {
	...
	{	/* array: 4 elements */
		...
		/* [2] */
		"ìØÇ∂êFÇëIë", noIcon, "S", noMark, plain,
		/* [3] */
		"ëIëîÕàÕÇâèú", noIcon, "D", noMark, plain,
		/* [4] */
		"ëIëîÕàÕÇîΩì]", noIcon, "I", noMark, plain
	}
};
...
resource 'MENU' (133) {
	...
	{	/* array: 7 elements */
		/* [1] */
		"éûåvâÒÇËÇ… 90ÅãâÒì]", noIcon, "T", noMark, plain,
		/* [2] */
		"îΩéûåvâÒÇËÇ… 90ÅãâÒì]", noIcon, "T", noMark, plain,
		/* [3] */
		"-", noIcon, noKey, noMark, plain,
		/* [4] */
		"êÖïΩï˚å¸Ç…îΩì]", noIcon, "[", noMark, plain,
		/* [5] */
		"êÇíºï˚å¸Ç…îΩì]", noIcon, "]", noMark, plain,
		/* [6] */
		"-", noIcon, noKey, noMark, plain,
		/* [7] */
		"êFí≤ÇîΩì]", noIcon, "I", noMark, plain
	}
};
...
resource 'MENU' (136) {
	...
	{	/* array: 6 elements */
		/* [1] */
		"ägëÂ", noIcon, "=", noMark, plain,
		/* [2] */
		"èkè¨", noIcon, "-", noMark, plain,
		/* [3] */
		"-", noIcon, noKey, noMark, plain,
		/* [4] */
		"êF", noIcon, hierarchicalMenu, "â", plain,
		/* [5] */
		"-", noIcon, noKey, noMark, plain,
		/* [6] */
		"èÓïÒÇå©ÇÈ...", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (135) {
	...
	{	/* array: 3 elements */
		/* [1] */
		"ïWèÄ", noIcon, "C", noMark, plain,
		/* [2] */
		"ÉAÉCÉRÉìÇ∆É}ÉXÉN", noIcon, "C", noMark, plain,
		/* [3] */
		"äeÉTÉCÉYÇÃÉAÉCÉRÉìÇ∑Ç◊Çƒ", noIcon, "C", noMark, plain
	}
};
...
resource 'MENU' (131) {
	...
	{	/* array: 12 elements */
		/* [1] */
		"éÊÇËè¡Çµ", noIcon, "Z", noMark, plain,
		/* [2] */
		"Ç‚ÇËíºÇµ", noIcon, "Z", noMark, plain,
		/* [3] */
		"-", noIcon, noKey, noMark, plain,
		/* [4] */
		"ÉJÉbÉg", noIcon, "X", noMark, plain,
		/* [5] */
		"ÉRÉsÅ[", noIcon, hierarchicalMenu, "á", plain,
		/* [6] */
		"ÉyÅ[ÉXÉg", noIcon, hierarchicalMenu, "Ü", plain,
		/* [7] */
		"è¡ãé", noIcon, noKey, noMark, plain,
		/* [8] */
		"ëIë", noIcon, hierarchicalMenu, "Ñ", plain,
		/* [9] */
		"ïœä∑...", noIcon, hierarchicalMenu, "Ö", plain,
		/* [10] */
		"êFÇÃí≤êÆ...", noIcon, "U", noMark, plain,
		/* [11] */
		"-", noIcon, noKey, noMark, plain,
		/* [12] */
		"äeéÌê›íË...", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (134) {
	...
	{	/* array: 4 elements */
		/* [1] */
		"ïWèÄ", noIcon, "V", noMark, plain,
		/* [2] */
		"ÉAÉCÉRÉìÇ∆É}ÉXÉN", noIcon, "V", noMark, plain,
		/* [3] */
		"ëIëîÕàÕÇ…ÉyÅ[ÉXÉg", noIcon, "V", noMark, plain,
		/* [4] */
		"äeÉTÉCÉYÇÃÉAÉCÉRÉìÇ∑Ç◊Çƒ", noIcon, "V", noMark, plain
	}
};
...
resource 'MENU' (137) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"MacOS ÉVÉXÉeÉÄêF", noIcon, noKey, noMark, plain,
		/* [2] */
		"Windows ÉVÉXÉeÉÄêF", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (129) {
	...
	{	/* array: 9 elements */
		/* [1] */
		"êVãKÉAÉCÉRÉì", noIcon, "N", noMark, plain,
		/* [2] */
		"äJÇ≠", noIcon, hierarchicalMenu, "Ç", plain,
		/* [3] */
		"ï¬Ç∂ÇÈ", noIcon, "W", noMark, plain,
		/* [4] */
		"-", noIcon, noKey, noMark, plain,
		/* [5] */
		"ï€ë∂", noIcon, "S", noMark, plain,
		/* [6] */
		"ï ñºÇ≈ï€ë∂...", noIcon, noKey, noMark, plain,
		/* [7] */
		"ÉtÉ@ÉCÉãÇ…ÉAÉCÉRÉìÇë}ì¸...", noIcon, noKey, noMark, plain,
		/* [8] */
		"-", noIcon, noKey, noMark, plain,
		/* [9] */
		"èIóπ", noIcon, "Q", noMark, plain
	}
};
...
resource 'MENU' (2000, "Types") {
	...
	{	/* array: 3 elements */
		/* [1] */
		"Macintosh ÉAÉCÉRÉì", noIcon, noKey, noMark, plain,
		/* [2] */
		"Windows ÉAÉCÉRÉì", noIcon, noKey, noMark, plain,
		/* [3] */
		"MacOS X ServerÉAÉCÉRÉì", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (1412) {
	...
	{	/* array: 7 elements */
		/* [1] */
		"ïWèÄ", noIcon, noKey, noMark, plain,
		/* [2] */
		"É{Å[ÉãÉh", noIcon, noKey, noMark, 1,
		/* [3] */
		"éŒëÃ", noIcon, noKey, noMark, 2,
		/* [4] */
		"â∫ê¸", noIcon, noKey, noMark, 4,
		/* [5] */
		"âeïtÇ´", noIcon, noKey, noMark, 16,
		/* [6] */
		"ï∂éöä‘ÇãlÇﬂÇÈ", noIcon, noKey, noMark, 32,
		/* [7] */
		"ï∂éöä‘ÇägÇ∞ÇÈ", noIcon, noKey, noMark, 64
	}
};
...
resource 'MENU' (205) {
	...
	{	/* array: 37 elements */
		/* [1] */
		"Å|20800 Disk Image", noIcon, noKey, noMark, plain,
		/* [2] */
		"Å|20799 Generic PC Card", noIcon, noKey, noMark, plain,
		/* [3] */
		"Å|20794 TrueType Multi Flat Font", noIcon, noKey, noMark, plain,
		/* [4] */
		"Å|20752 Generic Font Scaler", noIcon, noKey, noMark, plain,
		/* [5] */
		"Å|20743 LaserWriter", noIcon, noKey, noMark, plain,
		/* [6] */
		"Å|20732 TrueType Flat Font", noIcon, noKey, noMark, plain,
		/* [7] */
		"Å|16415 Generic Extension", noIcon, noKey, noMark, plain,
		/* [8] */
		"Å|4000 Generic Document", noIcon, noKey, noMark, plain,
		/* [9] */
		"Å|3998 Floppy", noIcon, noKey, noMark, plain,
		/* [10] */
		"Å|3996 Generic App", noIcon, noKey, noMark, plain,
		/* [11] */
		"Å|3995 Apple HD", noIcon, noKey, noMark, plain,
		/* [12] */
		"Å|3991 Generic DA", noIcon, noKey, noMark, plain,
		/* [13] */
		"Å|3989 Edition File", noIcon, noKey, noMark, plain,
		/* [14] */
		"Å|3988 RAM Disk", noIcon, noKey, noMark, plain,
		/* [15] */
		"Å|3987 CD", noIcon, noKey, noMark, plain,
		/* [16] */
		"Å|3985 Stationery", noIcon, noKey, noMark, plain,
		/* [17] */
		"Å|3971 Generic Preferences", noIcon, noKey, noMark, plain,
		/* [18] */
		"Å|3970 Generic Suitcase", noIcon, noKey, noMark, plain,
		/* [19] */
		"Å|3969 Generic DA Document", noIcon, noKey, noMark, plain,
		/* [20] */
		"Å|3967 Shared Library", noIcon, noKey, noMark, plain,
		/* [21] */
		"Å|3851 Generic Control Strip Module", noIcon, noKey, noMark, plain,
		/* [22] */
		"Å|3850 Generic Codec", noIcon, noKey, noMark, plain,
		/* [23] */
		"Å|3832 PC Disk", noIcon, noKey, noMark, plain,
		/* [24] */
		"Å|3831 Apple II Disk", noIcon, noKey, noMark, plain,
		/* [25] */
		"Å|3824 Generic Control Panel", noIcon, noKey, noMark, plain,
		/* [26] */
		"Å|3817 Removable Disk", noIcon, noKey, noMark, plain,
		/* [27] */
		"Å|3810 Sound", noIcon, noKey, noMark, plain,
		/* [28] */
		"Å|3809 International Script", noIcon, noKey, noMark, plain,
		/* [29] */
		"Å|3808 TrueType Font", noIcon, noKey, noMark, plain,
		/* [30] */
		"Å|3807 Bitmap Font", noIcon, noKey, noMark, plain,
		/* [31] */
		"Å|3806 Keyboard Layout", noIcon, noKey, noMark, plain,
		/* [32] */
		"Å|3805 DA Suitcase", noIcon, noKey, noMark, plain,
		/* [33] */
		"Å|3804 Font Suitcase", noIcon, noKey, noMark, plain,
		/* [34] */
		"Å|3803 Sound Clipping", noIcon, noKey, noMark, plain,
		/* [35] */
		"Å|3802 Text Clipping", noIcon, noKey, noMark, plain,
		/* [36] */
		"Å|3801 Picture Clipping", noIcon, noKey, noMark, plain,
		/* [37] */
		"Å|3800 Generic Clipping", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (206) {
	...
	allEnabled,
	enabled,
	"ÉCÉìÉ^Å[ÉlÉbÉgÉAÉCÉRÉì",
	{	/* array: 12 elements */
		/* [1] */
		"Å|20796 AppleTalk Zone", noIcon, noKey, noMark, plain,
		/* [2] */
		"Å|20795 FTP Server", noIcon, noKey, noMark, plain,
		/* [3] */
		"Å|20793 AppleShare Server", noIcon, noKey, noMark, plain,
		/* [4] */
		"Å|20739 Generic Location", noIcon, noKey, noMark, plain,
		/* [5] */
		"Å|20738 Newsgroup Location", noIcon, noKey, noMark, plain,
		/* [6] */
		"Å|20737 E-mail Location", noIcon, noKey, noMark, plain,
		/* [7] */
		"Å|20736 File Location", noIcon, noKey, noMark, plain,
		/* [8] */
		"Å|20735 AppleShare Location", noIcon, noKey, noMark, plain,
		/* [9] */
		"Å|20734 FTP Location", noIcon, noKey, noMark, plain,
		/* [10] */
		"Å|20733 HTTP Location", noIcon, noKey, noMark, plain,
		/* [11] */
		"Å|20731 IP File Server", noIcon, noKey, noMark, plain,
		/* [12] */
		"Å|20726 AppleTalk", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (207) {
	...
	{	/* array: 19 elements */
		/* [1] */
		"Å|20290 Battery Charging Full", noIcon, noKey, noMark, plain,
		/* [2] */
		"Å|20289 Battery Charging 90%", noIcon, noKey, noMark, plain,
		/* [3] */
		"Å|20288 Battery Charging 75%", noIcon, noKey, noMark, plain,
		/* [4] */
		"Å|20287 Battery Charging 60%", noIcon, noKey, noMark, plain,
		/* [5] */
		"Å|20286 Battery Charging 45%", noIcon, noKey, noMark, plain,
		/* [6] */
		"Å|20285 Battery Charging 30%", noIcon, noKey, noMark, plain,
		/* [7] */
		"Å|20284 Battery Charging 15%", noIcon, noKey, noMark, plain,
		/* [8] */
		"Å|20283 Battery Charging Empty", noIcon, noKey, noMark, plain,
		/* [9] */
		"-", noIcon, noKey, noMark, plain,
		/* [10] */
		"Å|20282 Battery In-use Full", noIcon, noKey, noMark, plain,
		/* [11] */
		"Å|20281 Battery In-Use 90%", noIcon, noKey, noMark, plain,
		/* [12] */
		"Å|20280 Battery In-Use 75%", noIcon, noKey, noMark, plain,
		/* [13] */
		"Å|20279 Battery In-Use 60%", noIcon, noKey, noMark, plain,
		/* [14] */
		"Å|20278 Battery In-Use 45%", noIcon, noKey, noMark, plain,
		/* [15] */
		"Å|20277 Battery In-Use 30%", noIcon, noKey, noMark, plain,
		/* [16] */
		"Å|20276 Battery In-Use 15%", noIcon, noKey, noMark, plain,
		/* [17] */
		"Å|20275 Battery In-Use Empty", noIcon, noKey, noMark, plain,
		/* [18] */
		"Å|20274 No Battery", noIcon, noKey, noMark, plain,
		/* [19] */
		"Å|4001 Plugged in (?)", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (208) {
	...
	{	/* array: 5 elements */
		/* [1] */
		"Å|20789 Alias Badge", noIcon, noKey, noMark, plain,
		/* [2] */
		"Å|20788 Mounted Badge", noIcon, noKey, noMark, plain,
		/* [3] */
		"Å|20787 Shared Badge", noIcon, noKey, noMark, plain,
		/* [4] */
		"Å|20786 Locked Badge", noIcon, noKey, noMark, plain,
		/* [5] */
		"Å|20740 Script Badge", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (209) {
	...
	{	/* array: 43 elements */
		/* [1] */
		"Å|16386 Apple Menu Icon", noIcon, noKey, noMark, plain,
		/* [2] */
		"-", noIcon, noKey, noMark, plain,
		/* [3] */
		"Å|20798 Unlocked", noIcon, noKey, noMark, plain,
		/* [4] */
		"Å|3823 Locked", noIcon, noKey, noMark, plain,
		/* [5] */
		"-", noIcon, noKey, noMark, plain,
		/* [6] */
		"Å|20791 Descending Sort Order", noIcon, noKey, noMark, plain,
		/* [7] */
		"Å|20790 Ascending Sort Order", noIcon, noKey, noMark, plain,
		/* [8] */
		"-", noIcon, noKey, noMark, plain,
		/* [9] */
		"Å|20751 Privileges: Writable", noIcon, noKey, noMark, plain,
		/* [10] */
		"Å|20750 Privileges: Uknown", noIcon, noKey, noMark, plain,
		/* [11] */
		"Å|20749 Privileges: N/A", noIcon, noKey, noMark, plain,
		/* [12] */
		"Å|20748 Privileges: Read", noIcon, noKey, noMark, plain,
		/* [13] */
		"Å|20747 Privileges: Read/Write", noIcon, noKey, noMark, plain,
		/* [14] */
		"Å|3784 Privileges: No Folders", noIcon, noKey, noMark, plain,
		/* [15] */
		"Å|3783 Privileges: No Write", noIcon, noKey, noMark, plain,
		/* [16] */
		"Å|3782 Privileges: No Files", noIcon, noKey, noMark, plain,
		/* [17] */
		"-", noIcon, noKey, noMark, plain,
		/* [18] */
		"Å|20746 Snap to Grid", noIcon, noKey, noMark, plain,
		/* [19] */
		"Å|20745 Keep Arranged", noIcon, noKey, noMark, plain,
		/* [20] */
		"-", noIcon, noKey, noMark, plain,
		/* [21] */
		"Å|20741 Backwards Arrow", noIcon, noKey, noMark, plain,
		/* [22] */
		"Å|20742 Forward Arrow Icon", noIcon, noKey, noMark, plain,
		/* [23] */
		"Å|20730 Recent Items Icon", noIcon, noKey, noMark, plain,
		/* [24] */
		"Å|20729 Favorite Items", noIcon, noKey, noMark, plain,
		/* [25] */
		"Å|20728 Shortcut Icon", noIcon, noKey, noMark, plain,
		/* [26] */
		"-", noIcon, noKey, noMark, plain,
		/* [27] */
		"Å|20271 Help Icon", noIcon, noKey, noMark, plain,
		/* [28] */
		"-", noIcon, noKey, noMark, plain,
		/* [29] */
		"Å|16509 Clipboard", noIcon, noKey, noMark, plain,
		/* [30] */
		"Å|16494 System Suitcase", noIcon, noKey, noMark, plain,
		/* [31] */
		"Å|16482 Finder", noIcon, noKey, noMark, plain,
		/* [32] */
		"Å|3828 MacOS Logo", noIcon, noKey, noMark, plain,
		/* [33] */
		"-", noIcon, noKey, noMark, plain,
		/* [34] */
		"Å|3822 Stop Icon", noIcon, noKey, noMark, plain,
		/* [35] */
		"Å|3821 Caution Icon", noIcon, noKey, noMark, plain,
		/* [36] */
		"Å|3820 Note Icon", noIcon, noKey, noMark, plain,
		/* [37] */
		"-", noIcon, noKey, noMark, plain,
		/* [38] */
		"Å|3816 Group", noIcon, noKey, noMark, plain,
		/* [39] */
		"Å|3815 Owner", noIcon, noKey, noMark, plain,
		/* [40] */
		"Å|3813 Guest User", noIcon, noKey, noMark, plain,
		/* [41] */
		"Å|3814 User", noIcon, noKey, noMark, plain,
		/* [42] */
		"-", noIcon, noKey, noMark, plain,
		/* [43] */
...
resource 'MENU' (203) {
	...
	{	/* array: 1 elements */
		/* [1] */
		"Å|16455 Item Icon", noIcon, noKey, noMark, plain
	}
};
...
resource 'MENU' (204) {
	...
	{	/* array: 56 elements */
		/* [1] */
		"Å|20803 Language & Region Support", noIcon, noKey, noMark, plain,
		/* [2] */
		"Å|20801 Internet Search Sites", noIcon, noKey, noMark, plain,
		/* [3] */
		"Å|20797 Scripts", noIcon, noKey, noMark, plain,
		/* [4] */
		"Å|20792 ColorSync Profiles", noIcon, noKey, noMark, plain,
		/* [5] */
		"Å|20744 Internet", noIcon, noKey, noMark, plain,
		/* [6] */
		"Å|20729 Favorites", noIcon, noKey, noMark, plain,
		/* [7] */
		"Å|20724 Speakable Items", noIcon, noKey, noMark, plain,
		/* [8] */
		"Å|20723 Appearance", noIcon, noKey, noMark, plain,
		/* [9] */
		"Å|3999 Generic Folder", noIcon, noKey, noMark, plain,
		/* [10] */
		"Å|3997 Open Folder", noIcon, noKey, noMark, plain,
		/* [11] */
		"Å|3994 Private Folder", noIcon, noKey, noMark, plain,
		/* [12] */
		"Å|3993 Trash Empty", noIcon, noKey, noMark, plain,
		/* [13] */
		"Å|3992 Desktop", noIcon, noKey, noMark, plain,
		/* [14] */
		"Å|3984 Trash Full", noIcon, noKey, noMark, plain,
		/* [15] */
		"Å|3983 System Folder", noIcon, noKey, noMark, plain,
		/* [16] */
		"Å|3982 Apple Menu Items", noIcon, noKey, noMark, plain,
		/* [17] */
		"Å|3981 Startup Items", noIcon, noKey, noMark, plain,
		/* [18] */
		"Å|3980 Shared Folder", noIcon, noKey, noMark, plain,
		/* [19] */
		"Å|3979 Drop Folder", noIcon, noKey, noMark, plain,
		/* [20] */
		"Å|3978 Share Point", noIcon, noKey, noMark, plain,
		/* [21] */
		"Å|3977 Mounted Folder", noIcon, noKey, noMark, plain,
		/* [22] */
		"Å|3976 Control Panels", noIcon, noKey, noMark, plain,
		/* [23] */
		"Å|3975 Print Spool", noIcon, noKey, noMark, plain,
		/* [24] */
		"Å|3974 Preferences", noIcon, noKey, noMark, plain,
		/* [25] */
		"Å|3973 Extensions", noIcon, noKey, noMark, plain,
		/* [26] */
		"Å|3972 File Server", noIcon, noKey, noMark, plain,
		/* [27] */
		"Å|3968 Fonts", noIcon, noKey, noMark, plain,
		/* [28] */
		"Å|3966 Recent Documents", noIcon, noKey, noMark, plain,
		/* [29] */
		"Å|3965 Recent Applications", noIcon, noKey, noMark, plain,
		/* [30] */
		"Å|3964 Recent Servers", noIcon, noKey, noMark, plain,
		/* [31] */
		"Å|3963 MacOS Read Me Files", noIcon, noKey, noMark, plain,
		/* [32] */
		"Å|3962 Control Strip Modules", noIcon, noKey, noMark, plain,
		/* [33] */
		"Å|3961 Sounds", noIcon, noKey, noMark, plain,
		/* [34] */
		"Å|3960 Help", noIcon, noKey, noMark, plain,
		/* [35] */
		"Å|3959 Scripting Additions", noIcon, noKey, noMark, plain,
		/* [36] */
		"Å|3958 Internet Plug-ins", noIcon, noKey, noMark, plain,
		/* [37] */
		"Å|3957 Language Support", noIcon, noKey, noMark, plain,
		/* [38] */
		"Å|3956 Shared Libraries", noIcon, noKey, noMark, plain,
		/* [39] */
		"Å|3955 Text Encodings", noIcon, noKey, noMark, plain,
		/* [40] */
		"Å|3954 Printer Drivers", noIcon, noKey, noMark, plain,
		/* [41] */
		"Å|3953 Printer Descriptions", noIcon, noKey, noMark, plain,
		/* [42] */
		"Å|3952 Voices", noIcon, noKey, noMark, plain,
		/* [43] */
		"Å|3951 Control Panels (Disabled)", noIcon, noKey, noMark, plain,
		/* [44] */
		"Å|3950 Extensions (Disabled)", noIcon, noKey, noMark, plain,
		/* [45] */
		"Å|3949 Startup Items (Disabled)", noIcon, noKey, noMark, plain,
		/* [46] */
		"Å|3948 Shutdown Items (Disabled)", noIcon, noKey, noMark, plain,
		/* [47] */
		"Å|3947 System Extensions (Disabled)", noIcon, noKey, noMark, plain,
		/* [48] */
		"Å|3946 Assistants", noIcon, noKey, noMark, plain,
		/* [49] */
		"Å|3945 Utilities", noIcon, noKey, noMark, plain,
		/* [50] */
		"Å|3944 Application Support", noIcon, noKey, noMark, plain,
		/* [51] */
		"Å|3943 Apple Extras", noIcon, noKey, noMark, plain,
		/* [52] */
		"Å|3942 Contextual Menu Items", noIcon, noKey, noMark, plain,
		/* [53] */
		"Å|3812 Workgroup", noIcon, noKey, noMark, plain,
		/* [54] */
		"Å|3811 User", noIcon, noKey, noMark, plain,
		/* [55] */
		"Å|3774 System Folder (protected)", noIcon, noKey, noMark, plain,
		/* [56] */
		"Å|3773 Applications Folder (protected)", noIcon, noKey, noMark, plain
	}
};
...
resource 'vers' (1) {
	...
	14,
	"1.0.2J",
	"1.0.2 ì˙ñ{åÍî≈ ˝1998-99 Mihai Parparita\n"
	"ì˙ñ{åÍî≈ñ|ñÛé“ÅFYoshi SAKUMA"
};
...
resource 'DITL' (3001, "Select Object", purgeable) {
	{	/* array DITLarray: 11 elements */
		...
		Button {
			enabled,
			"Åg<file name>ÅhÇëIë"
		},
		/* [11] */
		{6, 15, 23, 300},
		StaticText {
			disabled,
			"ÉtÉ@ÉCÉãÅAÉtÉHÉãÉ_ÅAÉfÉBÉXÉNÇëIëÅF"
		}
	}
};
...
resource 'DITL' (1000, "Preferences", purgeable) {
	{	/* array DITLarray: 13 elements */
		...
		CheckBox {
			enabled,
			"ÉAÉCÉRÉìï“èWÉEÉCÉìÉhÉEÇ…ÉOÉäÉbÉhÇï\\é¶"
		},
		/* [7] */
		{55, 8, 71, 313},
		CheckBox {
			enabled,
			"8 bit Ç∆ 1 bit ÇÃÉ}ÉXÉNÇìØä˙Ç≥ÇπÇÈ"
		},
		/* [8] */
		{72, 8, 88, 313},
		CheckBox {
			enabled,
			"êFêîÇ™ïsë´ÇµÇƒÇ¢ÇÈèÍçáÉfÉBÉUÉäÉìÉOÇÇ©ÇØ"
			"ÇÈ"
		},
		/* [9] */
		{128, 13, 144, 235},
		...
		StaticText {
			disabled,
			"ï“èWâÊñ ï\\é¶ÉTÉCÉYÅF"
		},
		/* [13] */
		{89, 8, 105, 313},
		CheckBox {
			enabled,
			"ãåÉ^ÉCÉvÇÃÉAÉCÉRÉìÇê∂ê¨Ç∑ÇÈ"
		}
	}
};
...
resource 'DITL' (300, purgeable) {
	{	/* array DITLarray: 5 elements */
		...
		StaticText {
			disabled,
			"ÉAÉCÉRÉìÉvÉåÉrÉÖÅ[Çå©Ç»Ç™ÇÁÅAÉäÉXÉgÇ©ÇÁ"
			"ï“èWÇ∑ÇÈÉAÉCÉRÉìÇëIëÇµÅAï“èWÇµÇΩÇ¢ÉAÉC"
			"ÉRÉìÇ™å©Ç¬Ç©Ç¡ÇΩÇÁÅgäJÇ≠ÅhÉ{É^ÉìÇâüÇµÇƒ"
			"â∫Ç≥Ç¢ÅB"
		},
		/* [4] */
		{38, 8, 192, 62},
...
resource 'mctb' (207, "ÉoÉbÉeÉäï\\é¶ menu") {
...
resource 'mctb' (203, "ÉAÉCÉeÉÄÉAÉCÉRÉì menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (205, "àÍî ÉAÉCÉRÉì menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (129, "ÉtÉ@ÉCÉã menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (134, "ÉyÅ[ÉXÉg menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (136, "ÉAÉCÉRÉì menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (201, "É}ÉXÉNêFê[ìx menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (1412, "ÉXÉ^ÉCÉã menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (1411, "ÉTÉCÉY menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (206, "ÉCÉìÉ^Å[ÉlÉbÉgÉAÉCÉRÉì menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (208, "í«â¡É}Å[ÉN menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'mctb' (204, "ÉVÉXÉeÉÄÉtÉHÉãÉ_ menu") {
	{	/* array MCTBArray: 1 elements */
		/* [1] */
		mctbLast, 0,
		{	/* array: 4 elements */
...
resource 'STR#' (150, "-App Balloon Help", purgeable) {
	{	/* array StringArray: 1 elements */
		/* [1] */
		"Iconographer\n\nÇ±ÇÃÉAÉvÉäÉPÅ[ÉVÉáÉìÇ≈ÉtÉ@"
		"ÉCÉãÇ‚ÉtÉHÉãÉ_ÇÃÉAÉCÉRÉìÇï“èWÇ∑ÇÈÇ±Ç∆Ç™"
		"èoóàÇ‹Ç∑ÅBï“èWÇ∑ÇÈÉAÉCÉRÉìÇÃä‹Ç‹ÇÍÇΩÉtÉ@"
		"ÉCÉãÇÇ±ÇÃÉAÉCÉRÉìÇ…ÉhÉâÉbÉOÉAÉìÉhÉhÉçÉb"
		"ÉvÇµÇƒâ∫Ç≥Ç¢ÅB"
	}
};
...
resource 'STR#' (151, "-Apple Menu Balloon Help", purgeable) {
	{	/* array StringArray: 4 elements */
		/* [1] */
		"Ç±ÇÃÉoÅ[ÉWÉáÉìÇÃÅgIconographerÅhÇÃèÓïÒÇ"
		"ï\\é¶ÇµÇ‹Ç∑ÅB",
		/* [2] */
		"Ç±ÇÃÉoÅ[ÉWÉáÉìÇÃÅgIconographerÅhÇÃèÓïÒÇ"
		"ï\\é¶ÇµÇ‹Ç∑ÅB\n\nåªç›ÅAèÓïÒÉ{ÉbÉNÉXÇï\\é¶Ç≈"
		"Ç´Ç»Ç¢ÇÃÇ≈óòópèoóàÇ‹ÇπÇÒÅB",
		/* [3] */
		"ÅgIconographerÅhÇÃìoò^Ç™èoóàÇ‹Ç∑ÅB\nìoò^Ç"
		"çœÇ‹ÇπÇÈÇ∆ÉVÉFÉAÉEÉFÉAóøã‡éxï•Ç¢ç√ë£ÉÅÉ"
		"bÉZÅ[ÉWÇÕèoÇ»Ç≠Ç»ÇËÇ‹Ç∑ÅB",
		/* [4] */
		"ÅgIconographerÅhÇÃìoò^Ç™èoóàÇ‹Ç∑ÅB\nìoò^Ç"
		"çœÇ‹ÇπÇÈÇ∆ÉVÉFÉAÉEÉFÉAóøã‡éxï•Ç¢ç√ë£ÉÅÉ"
		"bÉZÅ[ÉWÇÕèoÇ»Ç≠Ç»ÇËÇ‹Ç∑ÅB\n\nåªç›ÅAìoò^É_É"
		"CÉAÉçÉOÉ{ÉbÉNÉXÇï\\é¶Ç≈Ç´Ç»Ç¢ÇÃÇ≈óòópèoó"
		"àÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (155, "-Select Balloon Help", purgeable) {
	{	/* array StringArray: 8 elements */
		/* [1] */
		"ÉAÉCÉRÉìÇ∑Ç◊ÇƒÇëIëÇµÇ‹Ç∑ÅB",
		/* [2] */
		"ÉAÉCÉRÉìÇ∑Ç◊ÇƒÇëIëÇµÇ‹Ç∑ÅB\n\nëIëîÕàÕÇ"
		"çÏê¨Ç≈Ç´Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB",
		/* [3] */
		"åªç›ÇÃëIëîÕàÕÇÃêFÇ∆ìØÇ∂êFÇëIëÇµÇ‹Ç∑ÅB",
		/* [4] */
		"åªç›ÇÃëIëîÕàÕÇÃêFÇ∆ìØÇ∂êFÇëIëÇµÇ‹Ç∑ÅB"
		"\n\nóòópâ¬î\\Ç»ëIëîÕàÕÇ™Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹"
		"ÇπÇÒÅB",
		/* [5] */
		"åªç›ÇÃëIëîÕàÕÇâΩÇ‡ëIëÇµÇƒÇ¢Ç»Ç¢èÛë‘Ç…"
		"ÇµÇ‹Ç∑ÅB",
		/* [6] */
		"åªç›ÇÃëIëîÕàÕÇâΩÇ‡ëIëÇµÇƒÇ¢Ç»Ç¢èÛë‘Ç…"
		"ÇµÇ‹Ç∑ÅB\n\nóòópâ¬î\\Ç»ëIëîÕàÕÇ™Ç»Ç¢ÇÃÇ≈ëI"
		"ëèoóàÇ‹ÇπÇÒÅB",
		/* [7] */
		"åªç›ÇÃëIëîÕàÕÇîΩì]ÇµÇ‹Ç∑ÅB",
		/* [8] */
		"åªç›ÇÃëIëîÕàÕÇîΩì]ÇµÇ‹Ç∑ÅB\n\nóòópâ¬î\\Ç»"
		"ëIëîÕàÕÇ™Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (156, "-Transform Balloon Help", purgeable) {
	{	/* array StringArray: 5 elements */
		/* [1] */
		"åªç›ÇÃëIëîÕàÕÅiÇ‹ÇΩÇÕëIëîÕàÕÇ™Ç»Ç¢èÍçá"
		"Ç…ÇÕâÊëúëSëÃÅjÇ 90ÅãéûåvâÒÇËÇ…âÒì]ÇµÇ‹Ç"
		"∑ÅB",
		/* [2] */
		"åªç›ÇÃëIëîÕàÕÅiÇ‹ÇΩÇÕëIëîÕàÕÇ™Ç»Ç¢èÍçá"
		"Ç…ÇÕâÊëúëSëÃÅjÇ 90ÅãîΩéûåvâÒÇËÇ…âÒì]ÇµÇ"
		"‹Ç∑ÅB",
		/* [3] */
		"åªç›ÇÃëIëîÕàÕÅiÇ‹ÇΩÇÕëIëîÕàÕÇ™Ç»Ç¢èÍçá"
		"Ç…ÇÕâÊëúëSëÃÅjÇêÇíºï˚å¸Ç…îΩì]ÇµÇ‹Ç∑ÅB",
		/* [4] */
		"åªç›ÇÃëIëîÕàÕÅiÇ‹ÇΩÇÕëIëîÕàÕÇ™Ç»Ç¢èÍçá"
		"Ç…ÇÕâÊëúëSëÃÅjÇêÖïΩï˚å¸Ç…îΩì]ÇµÇ‹Ç∑ÅB",
		/* [5] */
		"åªç›ÇÃëIëîÕàÕÅiÇ‹ÇΩÇÕëIëîÕàÕÇ™Ç»Ç¢èÍçá"
		"Ç…ÇÕâÊëúëSëÃÅjÇÃêFÇÃäKí≤ÇîΩì]ÇµÇ‹Ç∑ÅB"
	}
};
...
resource 'STR#' (153, "-Open Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		/* [1] */
		"Finder ÉAÉCÉRÉìÇï“èWÉEÉCÉìÉhÉEÇ…äJÇ´Ç‹Ç"
		"∑ÅB",
		/* [2] */
		"MacOS ÇÃ Finder ÉAÉCÉRÉìÇï“èWÉEÉCÉìÉhÉE"
		"Ç…äJÇ´Ç‹Ç∑ÅB\n\nÇ±ÇÍà»è„ï“èWÉEÉCÉìÉhÉEÇçÏ"
		"ê¨Ç≈Ç´Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB",
		/* [3] */
		"Windows ÉAÉCÉRÉì (.ICO ÉtÉ@ÉCÉã)Çï“èWÉE"
		"ÉCÉìÉhÉEÇ…äJÇ´Ç‹Ç∑ÅB",
		/* [4] */
		"Windows ÉAÉCÉRÉì (.ICO ÉtÉ@ÉCÉã)Çï“èWÉE"
		"ÉCÉìÉhÉEÇ…äJÇ´Ç‹Ç∑ÅB\n\nÇ±ÇÍà»è„ï“èWÉEÉCÉì"
		"ÉhÉEÇçÏê¨Ç≈Ç´Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB",
		/* [5] */
		"MacOS X ÉAÉCÉRÉì (.tiff ÉtÉ@ÉCÉã)Çï“èWÉ"
		"EÉCÉìÉhÉEÇ…äJÇ´Ç‹Ç∑ÅB",
		/* [6] */
		"MacOS X ÉAÉCÉRÉì (.tiff ÉtÉ@ÉCÉã)Çï“èWÉ"
		"EÉCÉìÉhÉEÇ…äJÇ´Ç‹Ç∑ÅB\n\nÇ±ÇÍà»è„ï“èWÉEÉCÉ"
		"ìÉhÉEÇçÏê¨Ç≈Ç´Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (129, "-Standard Errors", purgeable) {
	{	/* array StringArray: 14 elements */
		/* [1] */
		"Ç±ÇÃÉtÉ@ÉCÉãÇÕÇ∑Ç≈Ç…ëºÇÃÉAÉvÉäÉPÅ[ÉVÉáÉì"
		"Ç≈äJÇ©ÇÍÇƒÇ¢Ç‹Ç∑ÅB",
		/* [2] */
		"Ç±ÇÃÉfÉxÉçÉbÉpÅ[ÉoÅ[ÉWÉáÉìÇÃ <app name> "
		"ÇÕ1999îN9åé1ì˙Ç≈égópä˙å¿Ç™êÿÇÍÇƒÇ¢Ç‹Ç∑ÅB"
		"êVÇµÇ¢ÉoÅ[ÉWÉáÉìÇÉ_ÉEÉìÉçÅ[ÉhÇµÇƒâ∫Ç≥Ç¢"
		"ÅB",
		/* [3] */
		"<app name> ÇÃïKóvÇ»ÉäÉ\\Å[ÉXÇ™å©Ç¬Ç©ÇËÇ‹Ç"
		"πÇÒÇ≈ÇµÇΩÅBÉCÉìÉXÉgÅ[ÉãÇµÇ»Ç®ÇµÇƒâ∫Ç≥Ç¢Å"
		"B",
		/* [4] */
		"<app name> ÇÃìÆçÏÇ…ÇÕ äøéöTalk 7.5.3 à»ç"
		"~Ç™ïKóvÇ≈Ç∑ÅB",
		/* [5] */
		"Apple ÉCÉxÉìÉgÇèâä˙âªÇ≈Ç´Ç»Ç©Ç¡ÇΩÇÃÇ≈ <"
		"app name> ÇÕèàóùÇë±ÇØÇÈÇ±Ç∆Ç™èoóàÇ‹ÇπÇÒ"
		"ÅB",
		/* [6] */
		"ÉAÉsÉAÉâÉìÉXÉ}ÉlÅ[ÉWÉÉÇÃèâä˙âªíÜÇ…ÉGÉâÅ["
		"Ç™ãNÇ´ÇΩÇΩÇﬂ <app name> ÇÕèàóùÇë±ÇØÇÈÇ±"
		"Ç∆Ç™èoóàÇ‹ÇπÇÒÅB",
		/* [7] */
		"ÉÅÉjÉÖÅ[ÉoÅ[ÇÃèâä˙âªíÜÇ…ÉGÉâÅ[Ç™ãNÇ´Ç‹Çµ"
		"ÇΩÅB<app name> ÇÃÉäÉ\\Å[ÉXÇ…è·äQÇ™î≠ê∂Ç∑Ç"
		"Èâ¬î\\ê´Ç™Ç†ÇÈÇÃÇ≈ÉCÉìÉXÉgÅ[ÉãÇµÇ»Ç®ÇµÇƒâ"
		"∫Ç≥Ç¢ÅB",
		/* [8] */
		"ÅgÉCÉìÉ^Å[ÉlÉbÉgê›íËã@î\\ägí£ÅhÇ™ÉCÉìÉXÉg"
		"Å[ÉãÇ≥ÇÍÇƒÇ¢Ç»Ç¢ÇÃÇ≈Ç±ÇÃ URL Ç…ê⁄ë±Ç∑ÇÈÇ"
		"±Ç∆Ç™èoóàÇ‹ÇπÇÒÅB",
		/* [9] */
		"êVÇµÇ¢ÉGÉfÉBÉ^ÇçÏê¨Ç≈Ç´Ç‹ÇπÇÒÇ≈ÇµÇΩÅBÇ®"
		"ÇªÇÁÇ≠ÉÅÉÇÉäÅ[Ç™ïsë´ÇµÇƒÇ¢Ç‹Ç∑ÅBäJÇ¢ÇƒÇ¢"
		"ÇÈÇ¢Ç≠Ç¬Ç©ÇÃÉGÉfÉBÉ^Çï¬Ç∂ÇÈÇ©ÅA<app nam"
		"e> ÇÃÉÅÉÇÉääÑÇËìñÇƒÇëùÇ‚ÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [10] */
		"<app name> ÇÃÉÅÉÇÉäÇ™ïsë´ÇµÇƒÇ¢Ç‹Ç∑ÅBÇ±Ç"
		"ÃÉGÉfÉBÉ^Ç≈ï`âÊÇ≥ÇÍÇƒÇ¢ÇÈÇ‡ÇÃÇ™îjä¸Ç≥ÇÍÇ"
		"‹Ç∑ÅB",
		/* [11] */
		"<app name> ÇÕÉÅÉÇÉäÇ™ë´ÇËÇ»Ç≠Ç»ÇËÇ‹ÇµÇΩÅ"
		"BÇªÇÃÇΩÇﬂÇ±ÇÃÉGÉfÉBÉ^ÇÕï¬Ç∂ÇÁÇÍÇ‹Ç∑ÅB",
		/* [12] */
		"Ågìoò^ÅhÉAÉvÉäÉPÅ[ÉVÉáÉìÇ™å©Ç¬Ç©ÇËÇ‹ÇπÇÒ"
		"Ç≈ÇµÇΩÅB<app name> ÇÉCÉìÉXÉgÅ[ÉãÇµÇ»Ç®Ç"
		"µÇƒâ∫Ç≥Ç¢ÅB",
		/* [13] */
		"ì¸óÕÇµÇΩìoò^î‘çÜÇÕä‘à·Ç¡ÇƒÇ¢Ç‹Ç∑ÅBÇ†Ç»ÇΩ"
		"ÇÃéÛÇØéÊÇ¡ÇΩìdéqÉÅÅ[ÉãÇ…èëÇ©ÇÍÇƒÇ¢ÇÈìoò^"
		"î‘çÜÇê≥ämÇ…ì¸óÕÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [14] */
		"<app name> ÇÃÉVÉFÉAÉEÉFÉAìoò^Ç«Ç§Ç‡Ç†ÇËÇ"
		"™Ç∆Ç§"
	}
};
...
resource 'STR#' (154, "-Edit Balloon Help", purgeable) {
	{	/* array StringArray: 22 elements */
		/* [1] */
		"Ågï“èWÅhÉÅÉjÉÖÅ[\n\nÇ±ÇÃÉÅÉjÉÖÅ[ÇÕéÊÇËè¡Çµ"
		"ÅAÇ‚ÇËíºÇµÅAÉJÉbÉgÅAÉyÅ[ÉXÉgÅAÅgIconogra"
		"pherÅhÇÃäeéÌê›íËÇ»Ç«ÇÃëÄçÏÇçsÇ§ÇΩÇﬂÇ…ég"
		"ópÇµÇ‹Ç∑ÅB",
		/* [2] */
		"Ågï“èWÅhÉÅÉjÉÖÅ[\n\nÇ±ÇÃÉÅÉjÉÖÅ[ÇÕéÊÇËè¡Çµ"
		"ÅAÇ‚ÇËíºÇµÅAÉJÉbÉgÅAÉyÅ[ÉXÉgÅAÅgIconogra"
		"pherÅhÇÃäeéÌê›íËÇ»Ç«ÇÃëÄçÏÇçsÇ§ÇΩÇﬂÇ…ég"
		"ópÇµÇ‹Ç∑ÅB\n\nç≈ëOñ Ç…Ç†ÇÈÉEÉCÉìÉhÉEÇ™Ç±ÇÍ"
		"ÇÁÇÃëÄçÏÇéÛÇØïtÇØÇ»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒ"
		"ÅB",
		/* [3] */
		"íºëOÇ…çsÇ»Ç¡ÇΩëÄçÏÇå≥Ç…ñﬂÇµÇ‹Ç∑ÅB",
		/* [4] */
		"íºëOÇ…çsÇ»Ç¡ÇΩëÄçÏÇå≥Ç…ñﬂÇµÇ‹Ç∑ÅB\n\nÇ∑Ç◊"
		"ÇƒÇÃëÄçÏÇ™å≥Ç…ñﬂÇ¡ÇƒÇ¢ÇÈÇ©ÅAç≈å„Ç…çsÇ»Ç¡"
		"ÇΩëÄçÏÇ™å≥Ç…ñﬂÇπÇ»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [5] */
		"å≥Ç…ñﬂÇµÇΩëÄçÏÇÇ‡Ç§àÍìxÇ‚ÇËíºÇµÇ‹Ç∑ÅB",
		/* [6] */
		"å≥Ç…ñﬂÇµÇΩëÄçÏÇÇ‡Ç§àÍìxÇ‚ÇËíºÇµÇ‹Ç∑ÅB\n\n"
		"ëÄçÏÇ™Ç‚ÇËíºÇπÇ»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [7] */
		"åªç›ÇÃëIëîÕàÕÇì‡óeÇçÌèúÇµÇƒÅAÉNÉäÉbÉv"
		"É{Å[Éhì]ëóÇµÇ‹Ç∑ÅB",
		/* [8] */
		"åªç›ÇÃëIëîÕàÕÇì‡óeÇçÌèúÇµÇƒÅAÉNÉäÉbÉv"
		"É{Å[Éhì]ëóÇµÇ‹Ç∑ÅB\n\nâΩÇ‡ëIëÇ≥ÇÍÇƒÇ¢Ç»Ç¢"
		"Ç©ÅAï“èWÉEÉCÉìÉhÉEÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëI"
		"ëèoóàÇ‹ÇπÇÒÅB",
		/* [9] */
		"åªç›ÇÃëIëîÕàÕÇÃì‡óeÇàÍéûìIÇ…ÉNÉäÉbÉvÉ{"
		"Å[ÉhÇ…íuÇ≠Ç±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [10] */
		"åªç›ÇÃëIëîÕàÕÇÃì‡óeÇàÍéûìIÇ…ÉNÉäÉbÉvÉ{"
		"Å[ÉhÇ…íuÇ≠Ç±Ç∆Ç™èoóàÇ‹Ç∑ÅB\n\nâΩÇ‡ëIëÇ≥ÇÍ"
		"ÇƒÇ¢Ç»Ç¢Ç©ÅAï“èWÉEÉCÉìÉhÉEÇ™äJÇ©ÇÍÇƒÇ¢Ç»"
		"Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [11] */
		"ÉNÉäÉbÉvÉ{Å[ÉhÇ…Ç†ÇÈì‡óeÇåªç›égópíÜÇÃï“"
		"èWÉEÉCÉìÉhÉEÇ…ì«Ç›çûÇ›Ç‹Ç∑ÅB",
		/* [12] */
		"ÉNÉäÉbÉvÉ{Å[ÉhÇ…Ç†ÇÈì‡óeÇåªç›égópíÜÇÃï“"
		"èWÉEÉCÉìÉhÉEÇ…ì«Ç›çûÇ›Ç‹Ç∑ÅB\n\nÉNÉäÉbÉvÉ{"
		"Å[ÉhÇ…âÊëúÉfÅ[É^Ç™ä‹Ç‹ÇÍÇƒÇ¢Ç»Ç¢Ç©ÅAï“èW"
		"ÉEÉCÉìÉhÉEÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹"
		"ÇπÇÒÅB",
		/* [13] */
		"åªç›ÇÃëIëîÕàÕÇ…Ç†ÇÈì‡óeÇçÌèúÇµÇ‹Ç∑ÅB",
		/* [14] */
		"åªç›ÇÃëIëîÕàÕÇ…Ç†ÇÈì‡óeÇçÌèúÇµÇ‹Ç∑ÅB\n\n"
		"âΩÇ‡ëIëÇ≥ÇÍÇƒÇ¢Ç»Ç¢Ç©ÅAï“èWÉEÉCÉìÉhÉEÇ™"
		"äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [15] */
		"Ç¢ÇÎÇ¢ÇÎÇ»ëÄçÏÇé¿çsÇµÇ‹Ç∑ÅB",
		/* [16] */
		"Ç¢ÇÎÇ¢ÇÎÇ»ëÄçÏÇé¿çsÇµÇ‹Ç∑ÅB\n\nÉAÉCÉRÉìÇ™"
		"äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [17] */
		"âÊëúÇ…ÇΩÇ¢ÇµÇƒÇ¢ÇÎÇ¢ÇÎÇ»ëÄçÏÇé¿çsÇµÇ‹Ç∑"
		"ÅB\n",
		/* [18] */
		"âÊëúÇ…ÇΩÇ¢ÇµÇƒÇ¢ÇÎÇ¢ÇÎÇ»ëÄçÏÇé¿çsÇµÇ‹Ç∑"
		"ÅB\n\nÉAÉCÉRÉìÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóà"
		"Ç‹ÇπÇÒÅB",
		/* [19] */
		"ÉAÉCÉRÉìÇÃêFÇïœä∑ÇµÇ‹Ç∑ÅB",
		/* [20] */
		"ÉAÉCÉRÉìÇÃêFÇïœä∑ÇµÇ‹Ç∑ÅB\n\nÉAÉCÉRÉìÇ™äJ"
		"Ç©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [21] */
		"ÅgIconographerÅhÇÃëÄçÏÇäeéÌÉJÉXÉ^É}ÉCÉY"
		"Ç∑ÇÈÉ_ÉCÉAÉçÉOÉ{ÉbÉNÉXÇäJÇ≠ÇÃÇ…égópÇµÇ‹"
		"Ç∑ÅB",
		/* [22] */
		"ÅgIconographerÅhÇÃëÄçÏÇäeéÌÉJÉXÉ^É}ÉCÉY"
		"Ç∑ÇÈÉ_ÉCÉAÉçÉOÉ{ÉbÉNÉXÇäJÇ≠ÇÃÇ…égópÇµÇ‹"
		"Ç∑ÅB\n\nåªç›ÅAèâä˙ê›íËÉtÉ@ÉCÉãÇï“èWÇ≈Ç´Ç»"
		"Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (158, "-Copy Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		/* [1] */
		"åªç›ÇÃëIëîÕàÕÇÃâÊëúÇÉNÉäÉbÉvÉ{Å[ÉhÇ…ì]"
		"ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [2] */
		"åªç›ÇÃëIëîÕàÕÇÃâÊëúÇÉNÉäÉbÉvÉ{Å[ÉhÇ…ì]"
		"ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB\n\nâΩÇ‡ëIëÇ≥ÇÍÇƒÇ¢"
		"Ç»Ç¢Ç©ÅAï“èWÉEÉCÉìÉhÉEÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩ"
		"ÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [3] */
		"åªç›ÇÃëIëîÕàÕÇÃÉAÉCÉRÉìâÊëúÇ∆É}ÉXÉNâÊëú"
		"ÇÃóºï˚ÇÉNÉäÉbÉvÉ{Å[ÉhÇ…ì]ëóÇ∑ÇÈÇ±Ç∆Ç™èo"
		"óàÇ‹Ç∑ÅB",
		/* [4] */
		"åªç›ÇÃëIëîÕàÕÇÃÉAÉCÉRÉìâÊëúÇ∆É}ÉXÉNâÊëú"
		"ÇÃóºï˚ÇÉNÉäÉbÉvÉ{Å[ÉhÇ…ì]ëóÇ∑ÇÈÇ±Ç∆Ç™èo"
		"óàÇ‹Ç∑ÅB\n\nâΩÇ‡ÉAÉCÉRÉìÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩ"
		"ÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [5] */
		"ï“èWíÜÇÃÉAÉCÉRÉìÇÃÇ∑Ç◊ÇƒÇÃêFê[ìxÅAÉTÉCÉY"
		"ÇÉNÉäÉbÉvÉ{Å[ÉhÇ…ì]ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑"
		"ÅB",
		/* [6] */
		"ï“èWíÜÇÃÉAÉCÉRÉìÇÃÇ∑Ç◊ÇƒÇÃêFê[ìxÅAÉTÉCÉY"
		"ÇÉNÉäÉbÉvÉ{Å[ÉhÇ…ì]ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑"
		"ÅB\n\nâΩÇ‡ÉAÉCÉRÉìÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIë"
		"èoóàÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (161, "-Registration Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		/* [1] */
		"ïKóvÇ»èÓïÒÇì¸óÕÇµÇΩÇÁÇ±ÇÃÉ{É^ÉìÇâüÇµÇƒ"
		"â∫Ç≥Ç¢ÅBìoò^ì‡óeÇ…ä‘à·Ç¢Ç™Ç»ÇØÇÍÇŒÅgIcon"
		"ographerÅhÇÃìoò^ÇÕäÆóπÇµÇ‹Ç∑ÅB",
		/* [2] */
		"ìoò^ÇÃíÜé~ÇÇµÇ‹Ç∑ÅB",
		/* [3] */
		"Ç±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆Ågìoò^ÅhÉAÉvÉäÉPÅ[ÉV"
		"ÉáÉìÇ™ãNìÆÇµÇ‹Ç∑ÅBïKóvÇ»ì‡óeÇì¸óÕÇµÇƒÅg"
		"KagiÅhÇ…ëóêMÇµÇƒìoò^ÇäÆóπÇ∑ÇÍÇŒÅgIconog"
		"rapherÅhÇ©ÇÁÇÃÉVÉFÉAÉEÉFÉAìoò^ç√ë£ÇÃÉÅÉb"
		"ÉZÅ[ÉWÇÕï\\é¶Ç≥ÇÍÇ»Ç≠Ç»ÇËÇ‹Ç∑ÅB",
		/* [4] */
		"Ç†Ç»ÇΩÇÃñºëOÇÇ±Ç±Ç…ì¸óÕÇµÇƒâ∫Ç≥Ç¢ÅBìoò^"
		"î‘çÜÇ∆àÍèèÇ…éÛÇØéÊÇ¡ÇΩìoò^é“ñºÇê≥ämÇ…ì¸"
		"óÕÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [5] */
		"Ç†Ç»ÇΩÇÃâÔé–ñºÇì¸óÕÇ∑ÇÈèÍçáÇÕÇ±Ç±Ç…ì¸óÕ"
		"ÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [6] */
		"Ç†Ç»ÇΩÇÃéÛÇØéÊÇ¡ÇΩìoò^î‘çÜÇÇ±Ç±Ç…ì¸óÕÇµ"
		"Çƒâ∫Ç≥Ç¢ÅB"
	}
};
...
resource 'STR#' (157, "-Paste Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		/* [1] */
		"ÉNÉäÉbÉvÉ{Å[ÉhÇÃì‡óeÇÉtÉçÅ[ÉgèÛë‘ÇÃëIë"
		"îÕàÕÇ…ì]ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [2] */
		"ÉNÉäÉbÉvÉ{Å[ÉhÇÃì‡óeÇåªç›ï“èWíÜÇÃÉAÉCÉR"
		"ÉìÇÃÉAÉCÉRÉìâÊëúÇ∆É}ÉXÉNâÊëúÇ…ÇÌÇØÇƒì]ëó"
		"Ç∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [3] */
		"ÉNÉäÉbÉvÉ{Å[ÉhÇÃì‡óeÇåªç›ÇÃëIëîÕàÕÇÃëÂ"
		"Ç´Ç≥Ç…çáÇÌÇπÇƒì]ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [4] */
		"ÉNÉäÉbÉvÉ{Å[ÉhÇÃì‡óeÇåªç›ÇÃÇÃëIëîÕàÕÇÃ"
		"ëÂÇ´Ç≥Ç…çáÇÌÇπÇƒì]ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB"
		"\n\nâΩÇ‡ëIëîÕàÕÇ™Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB",
		/* [5] */
		"åªç›ï“èWíÜÇÃÉAÉCÉRÉìÇÃÉAÉCÉRÉìÉtÉ@É~ÉäÅ["
		"Ç∑Ç◊ÇƒÇ…ì]ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [6] */
		"åªç›ï“èWíÜÇÃÉAÉCÉRÉìÇÃÉAÉCÉRÉìÉtÉ@É~ÉäÅ["
		"Ç∑Ç◊ÇƒÇ…ì]ëóÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB\n\nÉNÉäÉb"
		"ÉvÉ{Å[ÉhÇÃì‡óeÇ…ÉAÉCÉRÉìÉtÉ@É~ÉäÅ[Ç™ä‹Ç‹"
		"ÇÍÇƒÇ¢Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (160, "-About Balloon Help", purgeable) {
	{	/* array StringArray: 3 elements */
		/* [1] */
		"Ç±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆çÏé“Ç…ìdéqÉÅÅ[ÉãÇëó"
		"êMÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB(ÉCÉìÉ^Å[ÉlÉbÉgê›í"
		"Ëã@î\\ägí£Ç™ÉCÉìÉXÉgÅ[ÉãÇ≥ÇÍÇƒÇ¢ÇÈïKóvÇ™Ç"
		"†ÇËÇ‹Ç∑ÅB)",
		/* [2] */
		"Ç±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆ Mscape Software ÇÃÉ"
		"zÅ[ÉÄÉyÅ[ÉWÇ…çsÇ≠Ç±Ç∆Ç™èoóàÇ‹Ç∑ÅB(ÉCÉìÉ^"
		"Å[ÉlÉbÉgê›íËã@î\\ägí£Ç™ÉCÉìÉXÉgÅ[ÉãÇ≥ÇÍÇƒ"
		"Ç¢ÇÈïKóvÇ™Ç†ÇËÇ‹Ç∑ÅB)",
		/* [3] */
		"Ç‡ÇµÅAìoò^Ç™äÆóπÇµÇƒÇ¢ÇΩÇÁÅAìoò^Ç«Ç§Ç‡Ç†"
		"ÇËÇ™Ç∆Ç§ÅIÇ‡Çµìoò^Ç™Ç‹ÇæÇ»ÇÁÅAìoò^Çå‰åü"
		"ì¢â∫Ç≥Ç¢ÅB"
	}
};
...
resource 'STR#' (159, "-Icon Balloon Help", purgeable) {
	{	/* array StringArray: 9 elements */
		/* [1] */
		"ÅgÉAÉCÉRÉìÅhÉÅÉjÉÖÅ[\n\nÇ±ÇÃÉÅÉjÉÖÅ[ÇÕç≈ëO"
		"ñ Ç…Ç†ÇÈÉAÉCÉRÉìÇÃäeéÌëÆê´ÇïœçXÇ∑ÇÈÇΩÇﬂ"
		"Ç…égópÇµÇ‹Ç∑ÅB",
		/* [2] */
		"ÅgÉAÉCÉRÉìÅhÉÅÉjÉÖÅ[\n\nÇ±ÇÃÉÅÉjÉÖÅ[ÇÕç≈ëO"
		"ñ Ç…Ç†ÇÈÉAÉCÉRÉìÇÃäeéÌëÆê´ÇïœçXÇ∑ÇÈÇΩÇﬂ"
		"Ç…égópÇµÇ‹Ç∑ÅB\n\nï“èWÉEÉCÉìÉhÉEÇ™äJÇ©ÇÍÇƒ"
		"Ç¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [3] */
		"Ç±ÇÃÉÅÉjÉÖÅ[ÇÕç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìï“èWÉE"
		"ÉCÉìÉhÉEÇÃÉTÉCÉYÇägëÂÇ∑ÇÈÇΩÇﬂÇ…égópÇµÇ‹"
		"Ç∑ÅB",
		/* [4] */
		"Ç±ÇÃÉÅÉjÉÖÅ[ÇÕç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìï“èWÉE"
		"ÉCÉìÉhÉEÇÃÉTÉCÉYÇägëÂÇ∑ÇÈÇΩÇﬂÇ…égópÇµÇ‹"
		"Ç∑ÅB\n\nï“èWíÜÇÃÉAÉCÉRÉìÇÕÇ∑Ç≈Ç…ç≈ëÂÉTÉCÉY"
		"Ç‹Ç≈ägëÂÇ≥ÇÍÇƒÇ¢ÇÈÇ©ÅAÇ‹ÇΩÇÕÉAÉCÉRÉìÇ™äJ"
		"Ç©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [5] */
		"Ç±ÇÃÉÅÉjÉÖÅ[ÇÕç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìï“èWÉE"
		"ÉCÉìÉhÉEÇÃÉTÉCÉYÇèkè¨Ç∑ÇÈÇΩÇﬂÇ…égópÇµÇ‹"
		"Ç∑ÅB",
		/* [6] */
		"Ç±ÇÃÉÅÉjÉÖÅ[ÇÕç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìï“èWÉE"
		"ÉCÉìÉhÉEÇÃÉTÉCÉYÇèkè¨Ç∑ÇÈÇΩÇﬂÇ…égópÇµÇ‹"
		"Ç∑ÅB\n\nï“èWíÜÇÃÉAÉCÉRÉìÇÕÇ∑Ç≈Ç…ç≈è¨ÉTÉCÉY"
		"Ç‹Ç≈èkè¨Ç≥ÇÍÇƒÇ¢ÇÈÇ©ÅAÇ‹ÇΩÇÕÉAÉCÉRÉìÇ™äJ"
		"Ç©ÇÍÇƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [7] */
		"åªç›ï“èWíÜÇÃÉAÉCÉRÉìÇ≈égópÇ≥ÇÍÇƒÇ¢ÇÈÉJÉâ"
		"Å[ÉpÉåÉbÉgÇïœçXÇ∑ÇÈÇΩÇﬂÇ…égópÇµÇ‹Ç∑ÅB\n\n"
		"ï“èWíÜÇÃÉAÉCÉRÉìÇÃêFê[ìxÇ™ëºÇÃêFê[ìxÇÉT"
		"É|Å[ÉgÇµÇƒÇ¢Ç»Ç¢Ç©ÅAÉAÉCÉRÉìÇ™äJÇ©ÇÍÇƒÇ¢"
		"Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [8] */
		"Ç±Ç±ÇëIëÇµÇƒï\\é¶Ç≥ÇÍÇÈÉ_ÉCÉAÉçÉOÇ≈åªç›"
		"ï“èWíÜÇÃÉAÉCÉRÉìÇÃñºèÃÇ‚ëÆê´ÅAID ìôÇïœç"
		"XÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [9] */
		"Ç±Ç±ÇëIëÇµÇƒï\\é¶Ç≥ÇÍÇÈÉ_ÉCÉAÉçÉOÇ≈åªç›"
		"ï“èWíÜÇÃÉAÉCÉRÉìÇÃñºèÃÇ‚ëÆê´ÅAID ìôÇïœç"
		"XÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB\n\nÉAÉCÉRÉìÇ™äJÇ©ÇÍÇ"
		"ƒÇ¢Ç»Ç¢ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (152, "-File Balloon Help", purgeable) {
	{	/* array StringArray: 14 elements */
		/* [1] */
		"ÅgÉtÉ@ÉCÉãÅhÉÅÉjÉÖÅ[\n\nÇ±ÇÃÉÅÉjÉÖÅ[ÇÕÉtÉ@"
		"ÉCÉãÇ‚ÉtÉHÉãÉ_ÇÃëÄçÏÇ…égópÇµÇ‹Ç∑ÅB",
		/* [2] */
		"ÅgÉtÉ@ÉCÉãÅhÉÅÉjÉÖÅ[\n\nÇ±ÇÃÉÅÉjÉÖÅ[ÇÕÉtÉ@"
		"ÉCÉãÇ‚ÉtÉHÉãÉ_ÇÃëÄçÏÇ…égópÇµÇ‹Ç∑ÅB\n\nóòóp"
		"â¬î\\Ç»ÉtÉ@ÉCÉãëÄçÏÇ™Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹Çπ"
		"ÇÒÅB",
		/* [3] */
		"ãÛîíÇÃêVãKÉAÉCÉRÉìï“èWÉEÉCÉìÉhÉEÇçÏê¨Çµ"
		"Ç‹Ç∑ÅB",
		/* [4] */
		"ãÛîíÇÃêVãKÉAÉCÉRÉìï“èWÉEÉCÉìÉhÉEÇçÏê¨Çµ"
		"Ç‹Ç∑ÅB\n\nóòópâ¬î\\Ç»ï“èWÉEÉCÉìÉhÉEÇçÏê¨èo"
		"óàÇ»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB",
		/* [5] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï¬Ç∂Ç‹Ç∑ÅB",
		/* [6] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï¬Ç∂Ç‹Ç∑ÅB\n\nÉAÉCÉR"
		"ÉìÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB",
		/* [7] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï€ë∂ÇµÇ‹Ç∑ÅB",
		/* [8] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï€ë∂ÇµÇ‹Ç∑ÅB\n\nÉAÉC"
		"ÉRÉìÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢Ç©ÅAï€ë∂ÇÃïKóvÇ™Ç»Ç¢"
		"ÇΩÇﬂëIëèoóàÇ‹ÇπÇÒÅB",
		/* [9] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï ñºÇ≈ï€ë∂ÇµÇ‹Ç∑ÅB",
		/* [10] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï ñºÇ≈ï€ë∂ÇµÇ‹Ç∑ÅB"
		"\n\nÉAÉCÉRÉìÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹"
		"ÇπÇÒÅB",
		/* [11] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï ÇÃÉtÉ@ÉCÉãÇ…ë}ì¸"
		"ÇµÇ‹Ç∑ÅB (ÉAÉCÉRÉìà»äOÇÃì‡óeÇÃïœçXÇÕÇµÇ‹"
		"ÇπÇÒ)",
		/* [12] */
		"ç≈ëOñ Ç…Ç†ÇÈÉAÉCÉRÉìÇï ÇÃÉtÉ@ÉCÉãÇ…ë}ì¸"
		"ÇµÇ‹Ç∑ÅB (ÉAÉCÉRÉìà»äOÇÃì‡óeÇ…ïœçXÇÕÇµÇ‹"
		"ÇπÇÒ)\n\nÉAÉCÉRÉìÇ™äJÇ©ÇÍÇƒÇ¢Ç»Ç¢ÇÃÇ≈ëIëè"
		"oóàÇ‹ÇπÇÒÅB",
		/* [13] */
		"ÅgIconographerÅhÇèIóπÇµÇ‹Ç∑ÅBèIóπÇ∑ÇÈëO"
		"Ç…ï€ë∂Ç≥ÇÍÇƒÇ¢Ç»Ç¢ÉAÉCÉRÉìÇï€ë∂Ç∑ÇÈÇ©Ç«"
		"Ç§Ç©ämîFÇµÇ‹Ç∑ÅB",
		/* [14] */
		"ÅgIconographerÅhÇèIóπÇµÇ‹Ç∑ÅBèIóπÇ∑ÇÈëO"
		"Ç…ï€ë∂Ç≥ÇÍÇƒÇ¢Ç»Ç¢ÉAÉCÉRÉìÇï€ë∂Ç∑ÇÈÇ©Ç«"
		"Ç§Ç©ämîFÇµÇ‹Ç∑ÅB\n\nåªç›ÅAÅgIconographerÅh"
		"ÇèIóπÇ≈Ç´Ç»Ç¢ÇÃÇ≈ëIëèoóàÇ‹ÇπÇÒÅB"
	}
};
...
resource 'STR#' (130, "-Prompts", purgeable) {
	{	/* array StringArray: 10 elements */
		/* [1] */
		"ïœçXÇÃÇ†Ç¡ÇΩ<app name>èëóﬁÅg<file name>Å"
		"hÇï¬Ç∂ÇÈëOÇ…ï€ë∂ÇµÇ‹Ç∑Ç©ÅH",
		/* [2] */
		"ï“èWÇµÇΩÇ¢ÉAÉCÉRÉìÇÃÇ†ÇÈÉtÉ@ÉCÉãÇ©ÉtÉHÉã"
		"É_ÇëIëÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [3] */
		"ï€ë∂Ç∑ÇÈÉAÉCÉRÉìÇÃñºëOÇ∆èÍèäÇéwíËÇµÇƒâ∫"
		"Ç≥Ç¢ÅB",
		/* [4] */
		"ÉAÉCÉRÉìÇë}ì¸Ç∑ÇÈÉtÉ@ÉCÉãÇ©ÉtÉHÉãÉ_Çéw"
		"íËÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [5] */
		"ÉAÉCÉRÉìÇë}ì¸",
		/* [6] */
		"ÉAÉCÉRÉìÇäJÇ≠",
		/* [7] */
		"Ç†Ç»ÇΩÇÕ <no of icons> å¬ÇÃÉAÉCÉRÉìÇçÏê"
		"¨Ç∑ÇÈÇÃÇ…<app name>ÇégópÇµÇ‹ÇµÇΩÅBÇ±ÇÃÇ"
		"‹Ç‹égópÇµë±ÇØÇÈÇ»ÇÁÇŒ $15 ÇÃÉVÉFÉAÉEÉFÉA"
		"óøã‡ÇÇ®éxï•Ç¢â∫Ç≥Ç¢ÅBÅgÉIÉìÉâÉCÉììoò^Åh"
		"Ç‚Ç±ÇÃÉ\\ÉtÉgÉEÉFÉAÇ…ä‹Ç‹ÇÍÇÈÅgìoò^ÅhÉAÉv"
		"ÉäÉPÅ[ÉVÉáÉìÇ≈ìoò^Ç™èoóàÇ‹Ç∑ÅB",
		/* [8] */
		"ï“èWÇµÇΩÇ¢ Windows ÉAÉCÉRÉìÉtÉ@ÉCÉãÅy.ic"
		"oÅzÇëIëÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [9] */
		"ï“èWÇµÇΩÇ¢ MacOS X Server ÉAÉCÉRÉìÉtÉ@ÉC"
		"ÉãÅy.tiffÅzÇëIëÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [10] */
		"IDÅF<ID> ÇÃÉAÉCÉRÉìÇÕÅg<file name>ÅhÇ…ÅA"
		"Ç∑Ç≈Ç…ä‹Ç‹ÇÍÇƒÇ¢Ç‹Ç∑ÅBñ{ìñÇ…íuÇ´ä∑Ç¶ÇƒÇ‡"
		"ÇÊÇÎÇµÇ¢Ç≈Ç∑Ç©ÅH"
	}
};
...
resource 'STR#' (200, "-Basic Strings", purgeable) {
	{	/* array StringArray: 9 elements */
		...
		"ñºèÃñ¢ê›íË",
		/* [2] */
		"Ç±ÇÃÉAÉCÉRÉìÇÃ IDÅF<ID> ÇÕÇ∑Ç≈Ç…Ç±ÇÃÉtÉ@"
		"ÉCÉãÇÃíÜÇ≈égÇÌÇÍÇƒÇ¢Ç‹Ç∑ÅBÇ‡ÇµÇ±ÇÃÇ‹Ç‹ëÄ"
		"çÏÇë±ÇØÇÈÇ∆ÅAå√Ç¢ÉAÉCÉRÉìÇ…è„èëÇ´Ç≥ÇÍÇ‹"
		"Ç∑ÅB",
		/* [3] */
		"è„èëÇ´",
		/* [4] */
		"ÉLÉÉÉìÉZÉã",
		/* [5] */
		"ëÂÉTÉCÉY 8 bit Ç∆ 1 bit ÇÃÉ}ÉXÉNÇ™àŸÇ»Ç¡"
		"ÇƒÇ¢Ç‹Ç∑ÅBëÂÉTÉCÉY 1 bit ÇÃÉ}ÉXÉNÇ 8 bi"
		"t ÇÃÉ}ÉXÉNÇ©ÇÁçƒê∂ê¨ÇµÇ‹Ç∑Ç©ÅH",
		/* [6] */
		"è¨ÉTÉCÉY 8 bit Ç∆ 1 bit ÇÃÉ}ÉXÉNÇ™àŸÇ»Ç¡"
		"ÇƒÇ¢Ç‹Ç∑ÅBè¨ÉTÉCÉY 1 bit ÇÃÉ}ÉXÉNÇ 8 bi"
		"t ÇÃÉ}ÉXÉNÇ©ÇÁçƒê∂ê¨ÇµÇ‹Ç∑Ç©ÅH",
		/* [7] */
		"ç≈ëÂÉTÉCÉY 8 bit Ç∆ 1 bit ÇÃÉ}ÉXÉNÇ™àŸÇ»"
		"Ç¡ÇƒÇ¢Ç‹Ç∑ÅBç≈ëÂÉTÉCÉY 1 bit ÇÃÉ}ÉXÉNÇ "
		"8 bit ÇÃÉ}ÉXÉNÇ©ÇÁçƒê∂ê¨ÇµÇ‹Ç∑Ç©ÅH ",
		/* [8] */
		"ÇÕÇ¢",
		/* [9] */
		"Ç¢Ç¢Ç¶"
...
resource 'STR#' (203, "-Editor Balloon Help", purgeable) {
	{	/* array StringArray: 24 elements */
		...
		"ëΩäpå`ï`âÊÉcÅ[Éã (P)",
		/* [13] */
		"ÉOÉâÉfÅ[ÉVÉáÉìï`âÊÉcÅ[Éã (G)",
		/* [14] */
		"ï∂éöï`âÊÉcÅ[Éã (T)",
		/* [15] */
		"ÉÅÉCÉìÇÃï“èWâÊñ Ç≈Ç∑ÅBåªç›ï“èWíÜÇÃÉAÉCÉR"
		"ÉìÇ™ägëÂÇ≥ÇÍÇƒï\\é¶Ç≥ÇÍÇ‹Ç∑ÅB",
		/* [16] */
		"åªç›ÇÃägëÂÉTÉCÉYÇ™Ç±Ç±Ç…ï\\é¶Ç≥ÇÍÇ‹Ç∑ÅBäg"
		"ëÂÉTÉCÉYÇïœçXÇ∑ÇÈÇ…ÇÕÉAÉCÉRÉìÉÅÉjÉÖÅ[Ç©"
		"ÇÁägëÂÅ^èkè¨Ç©ÇÁçsÇ»Ç§Ç©ÅAÉEÉCÉìÉhÉEÉTÉC"
		"ÉYÉ{ÉbÉNÉXÇ≈ï“èWÉEÉCÉìÉhÉEÇÃÉTÉCÉYÇïœçX"
		"ÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [17] */
		"åªç›ï“èWíÜÇÃÉAÉCÉRÉìÇÃñºèÃÇ∆ ID Ç™Ç±Ç±Ç…"
		"ï\\é¶Ç≥ÇÍÇ‹Ç∑ÅBÇ±Ç±ÇÉNÉäÉbÉNÇµÇƒï\\é¶Ç≥ÇÍ"
		"ÇÈÉ_ÉCÉAÉçÉOÇ≈ÉAÉCÉRÉìÇÃñºèÃÇ‚ ID ÅAäeéÌ"
		"ê›íËÇïœçXÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB",
		/* [18] */
		"åªç›ÇÃëOåiêFÇ∆îwåiêFÇ™Ç±Ç±Ç…ï\\é¶Ç≥ÇÍÇ‹Ç∑"
		"ÅBÇ±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆êFÇïœçXèoóàÇ‹Ç∑ÅB",
		/* [19] */
		"åªç›ï“èWíÜÇÃêFê[ìxÇÃÉAÉCÉRÉìÇÃ 3 éÌóﬁÇÃÉ"
		"TÉCÉY (48 x 48ÅA32 x 32ÅA16 x16) ÇÃÉAÉCÉ"
		"RÉìâÊëúÇ™Ç±Ç±Ç…ï\\é¶Ç≥ÇÍÇ‹Ç∑ÅBÇ±Ç±ÇÉNÉäÉ"
		"bÉNÇ∑ÇÈÇ∆ï“èWÇ∑ÇÈÉTÉCÉYÇÃÉAÉCÉRÉìÇïœçXÇ"
		"≈Ç´Ç‹Ç∑ÅBÉTÉCÉYÇÃà·Ç§ÉAÉCÉRÉìÇé©ìÆìIÇ…É"
		"TÉCÉYÇí≤êÆÇµÇƒÉRÉsÅ[Ç∑ÇÈÇ±Ç∆Ç‡èoóàÇ‹Ç∑Å"
		"B",
		/* [20] */
		"Ç±ÇÃÉ|ÉbÉvÉAÉbÉvÉÅÉjÉÖÅ[ÇÕÉAÉCÉRÉìÇÃêFê["
		"ìxÇïœçXÇ∑ÇÈÇΩÇﬂÇ…égópÇµÇ‹Ç∑ÅBÉIÉvÉVÉáÉì"
		"ÉLÅ[ÇâüÇµÇ»Ç™ÇÁÅAà·Ç§êFê[ìxÇ…ïœçXÇ∑ÇÈÇ±"
		"Ç∆Ç…ÇÊÇ¡Çƒåªç›ÇÃÉAÉCÉRÉìÇÉRÉsÅ[Ç∑ÇÈÇ±Ç∆"
		"Ç™èoóàÇ‹Ç∑ÅB",
		/* [21] */
		"åªç›ï“èWíÜÇÃêFê[ìxÇÃÉAÉCÉRÉìÇÃ 3 éÌóﬁÇÃÉ"
		"TÉCÉY (48 x 48ÅA32 x 32ÅA16 x16) ÇÃÉ}ÉXÉ"
		"NâÊëúÇ™Ç±Ç±Ç…ï\\é¶Ç≥ÇÍÇ‹Ç∑ÅBÇ±Ç±ÇÉNÉäÉbÉ"
		"NÇ∑ÇÈÇ∆ï“èWÇ∑ÇÈÉTÉCÉYÇÃÉ}ÉXÉNÇïœçXÇ≈Ç´Ç"
		"‹Ç∑ÅBÉTÉCÉYÇÃà·Ç§É}ÉXÉNÇé©ìÆìIÇ…ÉTÉCÉYÇ"
		"í≤êÆÇµÇƒÉRÉsÅ[Ç∑ÇÈÇ±Ç∆Ç‡èoóàÇ‹Ç∑ÅB",
		/* [22] */
		"Ç±ÇÃÉ|ÉbÉvÉAÉbÉvÉÅÉjÉÖÅ[ÇÕÉ}ÉXÉNÇÃêFê[ìx"
		"ÇïœçXÇ∑ÇÈÇΩÇﬂÇ…égópÇµÇ‹Ç∑ÅBÉIÉvÉVÉáÉìÉL"
		"Å[ÇâüÇµÇ»Ç™ÇÁÅAà·Ç§êFê[ìxÇ…ïœçXÇ∑ÇÈÇ±Ç∆"
		"Ç…ÇÊÇ¡Çƒåªç›ÇÃÉ}ÉXÉNÇÉRÉsÅ[Ç∑ÇÈÇ±Ç∆Ç™èo"
		"óàÇ‹Ç∑ÅB",
		/* [23] */
		"åªç›ï“èWíÜÇÃÉAÉCÉRÉìÇÉ}ÉXÉNÇçáê¨ÇµÇΩèÛ"
		"ë‘Ç≈2 éÌóﬁÇÃîwåiÅiîíêFÇÃîwåiÇ∆åªç›ÇÃÉfÉX"
		"ÉNÉgÉbÉvÉpÉ^Å[ÉìÅjÇ…ï\\é¶Ç≥ÇÍÇ‹Ç∑ÅBÇ±ÇÃÉA"
		"ÉCÉRÉìÇÉNÉäÉbÉNÇ∑ÇÈÇ∆ëIëÅ^îÒëIëÇÃóºï˚"
		"ÇÃèÛë‘ÇÃÉAÉCÉRÉìÇÉvÉåÉrÉÖÅ[Ç∑ÇÈÇ±Ç∆Ç™èo"
		"óàÇ‹Ç∑ÅB",
		/* [24] */
		"åªç›ÇÃï`âÊÉpÉ^Å[ÉìÇ™Ç±Ç±Ç…ï\\é¶Ç≥ÇÍÇ‹Ç∑ÅB"
		"Ç±Ç±ÇÉNÉäÉbÉNÇ∑ÇÈÇ∆ï`âÊÉpÉ^Å[ÉìÇïœçXèo"
		"óàÇ‹Ç∑ÅB"
	}
};
...
resource 'STR#' (204, "-Icon Info Balloon Help", purgeable) {
	{	/* array StringArray: 11 elements */
		/* [1] */
		"ïœçXÇï€ë∂ÇµÇƒÇ±ÇÃÉ_ÉCÉAÉçÉOÇï¬Ç∂ÇÈÅB",
		/* [2] */
		"ïœçXÇï€ë∂ÇµÇ»Ç¢Ç≈Ç±ÇÃÉ_ÉCÉAÉçÉOÇï¬Ç∂ÇÈ"
		"ÅB",
		/* [3] */
		"ÇPÇ¬ÇÃÉtÉ@ÉCÉãÇ…ï°êîÇÃÉAÉCÉRÉìÇä‹Ç‹ÇπÇÈ"
		"èÍçáÅAÇ±Ç±Ç≈äeÉAÉCÉRÉìÇ…ï ÅXÇÃ ID î‘çÜÇ"
		"ïtÇØÇÈïKóvÇ™Ç†ÇËÇ‹Ç∑ÅB",
		/* [4] */
		"Ç±ÇÍÇÕç≈èIìIÇ»ÉAÉCÉRÉìÇÃÉäÉ\\Å[ÉXÇÃóeó Ç≈"
		"Ç∑ÅB",
		/* [5] */
		"ñºèÃê›íËÇÕÉIÉvÉVÉáÉìÇ≈Ç∑Ç™ÅAÉAÉCÉRÉìÉäÉ\\"
		"Å[ÉXÇåüçıÇ∑ÇÈç€Ç…ï÷óòÇ≈Ç∑ÅB",
		/* [6] */
		"Ç±Ç±ÇÉ`ÉFÉbÉNÇ∑ÇÈÇ∆ÅAÉÅÉÇÉäÇ™ïsë´ÇµÇƒÇ¢"
		"ÇÈèÍçáÇ…ÉAÉCÉRÉìÇì«Ç›çûÇ‹Ç»Ç¢Ç≈Ç®Ç≠Ç±Ç∆"
		"Ç™èoóàÇ‹Ç∑ÅB",
		/* [7] */
		"Ç±Ç±ÇÉ`ÉFÉbÉNÇ∑ÇÈÇ∆ÅAÉtÉ@ÉCÉãÇäJÇ≠éûÇ…"
		"é©ìÆìIÇ…ÉAÉCÉRÉìÇì«Ç›çûÇﬁÇ±Ç∆Ç™èoóàÇ‹Ç∑"
		"ÅB",
		/* [8] */
		"Ç±Ç±ÇÉ`ÉFÉbÉNÇ∑ÇÈÇ∆ÅAÉAÉCÉRÉìÇ™ÉçÉbÉNÇ≥"
		"ÇƒÅAÉÅÉÇÉäì‡Ç…ì«Ç›çûÇÒÇæéûÇ…ÉÅÉÇÉäóÃàÊÇ"
		"à⁄ìÆÇ≈Ç´Ç»Ç≠Ç»ÇËÇ‹Ç∑ÅB",
		/* [9] */
		"Ç±Ç±ÇÉ`ÉFÉbÉNÇ∑ÇÈÇ∆ÅAÉAÉCÉRÉìÇ…ïœçXÇâ¡"
		"Ç¶ÇÁÇÍÇ»Ç≠Ç»ÇËÇ‹Ç∑ÅB",
		/* [10] */
		"Ç±Ç±ÇÉ`ÉFÉbÉNÇ∑ÇÈÇ∆ÅAÉVÉXÉeÉÄÇÃégópÇ∑ÇÈ"
		"ÉÅÉÇÉäóÃàÊÇ…ÉAÉCÉRÉìÇì«Ç›çûÇﬁÇÊÇ§Ç…Ç»ÇË"
		"Ç‹Ç∑ÅB",
		/* [11] */
		"Ç±ÇÃÉ|ÉbÉvÉAÉbÉvÉÅÉjÉÖÅ[Ç©ÇÁÅAä˘ë∂ÇÃÉAÉC"
		"ÉRÉì ID ÇëIëÇ∑ÇÈÇ±Ç∆Ç™èoóàÇ‹Ç∑ÅB"
	}
};
...
resource 'STR#' (301, "-Icon Browser: Balloon Help", purgeable) {
	{	/* array StringArray: 4 elements */
		/* [1] */
		"ëIëÇµÇΩÉAÉCÉRÉìÇï“èWÉEÉCÉìÉhÉEÇ…äJÇ´Ç‹"
		"Ç∑ÅB",
		/* [2] */
		"âΩÇ‡ÉAÉCÉRÉìÇäJÇ©Ç∏Ç…Ç±ÇÃÉ_ÉCÉAÉçÉOÉEÉC"
		"ÉìÉhÉEÇï¬Ç∂Ç‹Ç∑ÅB",
		/* [3] */
		"Ç±ÇÃÉäÉXÉgÇ©ÇÁÉAÉCÉRÉìÇëIëÇµÇƒâ∫Ç≥Ç¢ÅB",
		/* [4] */
		"ëIëÇ≥ÇÍÇΩÉAÉCÉRÉìÇÃÉvÉåÉrÉÖÅ[Ç™Ç±Ç±Ç…ï\\"
		"é¶Ç≥ÇÍÇ‹Ç∑ÅB"
	}
};
...
resource 'STR#' (202, "-Icon Part Names", purgeable) {
	{	/* array StringArray: 18 elements */
		/* [1] */
		" ëÂÉTÉCÉY  32 bit ÉAÉCÉRÉì",
		/* [2] */
		" è¨ÉTÉCÉY  32 bit ÉAÉCÉRÉì",
		/* [3] */
		" ëÂÉTÉCÉY  8 bit É}ÉXÉN",
		/* [4] */
		" è¨ÉTÉCÉY  8 bit É}ÉXÉN",
		/* [5] */
		" ëÂÉTÉCÉY  8 bit ÉAÉCÉRÉì",
		/* [6] */
		" è¨ÉTÉCÉY  8 bit ÉAÉCÉRÉì",
		/* [7] */
		" ëÂÉTÉCÉY  4 bit ÉAÉCÉRÉì",
		/* [8] */
		" è¨ÉTÉCÉY  4 bit ÉAÉCÉRÉì",
		/* [9] */
		" ëÂÉTÉCÉY  1 bit ÉAÉCÉRÉì",
		/* [10] */
		" è¨ÉTÉCÉY  1 bit ÉAÉCÉRÉì",
		/* [11] */
		" ëÂÉTÉCÉY  1 bit É}ÉXÉN",
		/* [12] */
		" è¨ÉTÉCÉY  1 bit É}ÉXÉN",
		/* [13] */
		" ç≈ëÂÉTÉCÉY 32 bit ÉAÉCÉRÉì",
		/* [14] */
		" ç≈ëÂÉTÉCÉY 8 bit É}ÉXÉN",
		/* [15] */
		" ç≈ëÂÉTÉCÉY 1 bit ÉAÉCÉRÉì",
		/* [16] */
		" ç≈ëÂÉTÉCÉY 1 bit É}ÉXÉN",
		/* [17] */
		" ç≈ëÂÉTÉCÉY 8 bit ÉAÉCÉRÉì",
		/* [18] */
		" ç≈ëÂÉTÉCÉY 4 bit ÉAÉCÉRÉì"
	}
};
...
data 'hwin' (1001, "Icon Info", purgeable) {
	...
	$"0F83 4183 4383 5283 938F EE95 F12E 2E2E"            /* .ÉAÉCÉRÉìèÓïÒ... */
};

data 'hwin' (300, "Icon Browser", purgeable) {
	$"0002 0000 0000 0001 012C 6872 6374 000C"            /* .........,hrct.. */
	$"1083 4183 4383 5283 9383 7583 8983 4583"            /* .ÉAÉCÉRÉìÉuÉâÉEÉ */
	$"5500"                                               /* U. */
};

data 'hwin' (129, "Register", purgeable) {
	$"0002 0000 0000 0001 0081 6872 6374 0004"            /* .........Åhrct.. */
	$"0493 6F98 5E00"                                     /* .ìoò^. */
};
...
resource 'CNTL' (2000, "Å|Types Pop-up", purgeable) {
	{6, 8, 26, 258},
	0,
	invisible,
	60,
...
resource 'CNTL' (2001, "Å|Old Types Pop-up", purgeable) {
	{185, 11, 205, 261},
	0,
	visible,
	60,
...
resource 'CNTL' (1412, "Å|Size Popup", purgeable) {
	{66, 8, 86, 190},
	0,
	visible,
	45,
...
resource 'CNTL' (1410, "Å|Font Popup", purgeable) {
	{8, 8, 28, 188},
	0,
	visible,
	45,
...
resource 'CNTL' (1001, "Å|Flags Group Box", purgeable) {
	{70, 10, 150, 271},
	0,
	visible,
	100,
...
resource 'CNTL' (1003, "Å|Startup Options Group Box", purgeable) {
	{93, 7, 169, 308},
	0,
	visible,
	100,
...
resource 'CNTL' (1013, "Å|Lightness Slider", purgeable) {
	{124, 92, 155, 312},
	6,
	visible,
	100,
...
resource 'CNTL' (208, "Å|Icon Label", purgeable) {
	{126, 298, 138, 352},
	0,
	visible,
	100,
...
resource 'CNTL' (209, "Å|Mask Label", purgeable) {
	{126, 366, 138, 420},
	0,
	visible,
	100,
...
resource 'CNTL' (211, "Å|Preview Label", purgeable) {
	{196, 296, 208, 420},
	0,
	visible,
	100,
...
resource 'CNTL' (1011, "Å|Hue Slider", purgeable) {
	{47, 83, 78, 303},
	5,
	visible,
	180,
...
resource 'CNTL' (1012, "Å|Saturation Slider", purgeable) {
	{85, 83, 116, 303},
	5,
	visible,
	100,
...
resource 'CNTL' (1014, "Å|Brightness Slider", purgeable) {
	{47, 83, 78, 303},
	5,
	visible,
	100,
...
resource 'CNTL' (1015, "Å|Contrast Slider", purgeable) {
	{85, 83, 116, 303},
	5,
	visible,
	100,
