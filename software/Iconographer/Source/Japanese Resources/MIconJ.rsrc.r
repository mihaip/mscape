...
resource 'STR#' (4003, "Icon Info Help", purgeable) {
	{	/* array StringArray: 70 elements */
		/* [1] */
		"‘I‘ğ‚³‚ê‚½İ’è‚ğ“K—p‚µ‚Ä‚±‚Ìƒ_ƒCƒAƒƒO‚ğ"
		"•Â‚¶‚Ü‚·B",
		/* [2] */
		"‚·‚×‚Ä‚Ì•ÏX‚ğ–³‹‚µ‚Ä‚±‚Ìƒ_ƒCƒAƒƒO‚ğ•Â"
		"‚¶‚Ü‚·B",
		/* [3] */
		"",
		/* [4] */
		...
		"",
		/* [18] */
		"16 x 12 ƒsƒNƒZƒ‹ƒTƒCƒY",
		/* [19] */
		"128 x 128 ƒsƒNƒZƒ‹ƒTƒCƒY",
		/* [20] */
		"48 x 48 ƒsƒNƒZƒ‹ƒTƒCƒY",
		/* [21] */
		"32 x 32 ƒsƒNƒZƒ‹ƒTƒCƒY",
		/* [22] */
		"16 x 16 ƒsƒNƒZƒ‹ƒTƒCƒY",
		/* [23] */
		"",
		/* [24] */
		"",
		...
		"",
		/* [56] */
		"ŠeƒAƒCƒRƒ“‚ğƒtƒ@ƒCƒ‹‚É•Û‘¶‚·‚é‚É‚ÍŒÅ—L‚Ì"
		" ID ‚ª•K—v‚Å‚·B",
		/* [57] */
		"ƒ|ƒbƒvƒAƒbƒvƒƒjƒ…[‚©‚ç—Ç‚­g‚í‚ê‚éŒÅ—L"
		"‚Ì ID ‚ğ‘I‘ğ‚Å‚«‚Ü‚·B",
		/* [58] */
		"",
		/* [59] */
		"–¼‘O‚Í•t‚¯‚È‚­‚Ä‚à\\‚¢‚Ü‚¹‚ñ‚ªAŠó–]‚·‚é"
		"ƒAƒCƒRƒ“ƒŠƒ\\[ƒX‚ğ‚·‚Î‚â‚­Œ©‚Â‚¯‚é‚Ì‚É–ğ"
		"—§‚¿‚Ü‚·B",
		/* [60] */
		"",
		/* [61] */
		"‚¢‚­‚Â‚©‚ÌŒ`®‚Í‚·‚×‚Ä‚Ì‹@”\\‚ÆŒİŠ·«‚ª‚ "
		"‚è‚Ü‚¹‚ñB(—á: Windows ‚Í 8 ƒrƒbƒg‚Ìƒ}ƒX"
		"ƒN‚âƒŠƒ\\[ƒXî•ñ‚ğŠÜ‚Ü‚¹‚é‚±‚Æ‚ªo—ˆ‚Ü‚¹"
		"‚ñB)",
		/* [62] */
		"",
		/* [63] */
		"ÅI“I‚ÈƒAƒCƒRƒ“ƒŠƒ\\[ƒXƒtƒ@ƒCƒ‹‚Ì—e—Ê‚Å"
		"‚·B",
		/* [64] */
		"",
		/* [65] */
		"",
		/* [66] */
		"ƒp[ƒWƒƒƒuƒ‹ƒŠƒ\\[ƒX‚ÍAƒƒ‚ƒŠ—Ìˆæ‚ª•s‘«"
		"‚µ‚½ê‡‚É“Ç‚İ‚Ü‚È‚¢İ’è‚ğ‚µ‚Ü‚·B",
		/* [67] */
		"ƒvƒŠƒ[ƒhƒŠƒ\\[ƒX‚ÍAˆê“xƒtƒ@ƒCƒ‹‚ªŠJ‚©"
		"‚ê‚½‚Éƒƒ‚ƒŠã‚ÉƒAƒCƒRƒ“î•ñ‚ğ•Û‚·‚é"
		"‚æ‚¤‚Éİ’è‚µ‚Ü‚·B",
		/* [68] */
		"ƒƒbƒNƒŠƒ\\[ƒX‚ÍAƒƒ‚ƒŠ—Ìˆæã‚ÅêŠ‚ÌˆÚ"
		"“®‚ğs‚í‚È‚¢İ’è‚ğ‚µ‚Ü‚·B",
		/* [69] */
		"ƒvƒƒeƒNƒgƒŠƒ\\[ƒX‚ÍA•ÏX‚ğo—ˆ‚È‚¢‚æ‚¤"
		"‚Éİ’è‚µ‚Ü‚·B",
		/* [70] */
		"ƒVƒXƒeƒ€ƒq[ƒvƒŠƒ\\[ƒX‚ÍAƒVƒXƒeƒ€‚Ìg—p"
		"‚·‚éƒƒ‚ƒŠ—Ìˆæ‚ğg—p‚·‚é‚æ‚¤‚Éİ’è‚µ‚Ü‚·"
		"B"
	}
};
