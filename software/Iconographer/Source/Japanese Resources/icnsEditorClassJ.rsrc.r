/* Resource fork of software/Iconographer/Source/Japanese Resources/icnsEditorClassJ.rsrc */
...
resource 'STR#' (200, "Basic Strings", purgeable) {
	{	/* array StringArray: 18 elements */
		...
		"B",
		/* [16] */
		"Windows ƒAƒCƒRƒ“‚Í 10 ŒÂ‚Ü‚Å‚ÌƒAƒCƒRƒ“\\"
		"¬‚É‚·‚é‚×‚«‚Å‚·B (‚±‚ÌƒAƒCƒRƒ“‚Í <numb"
		"er> ŒÂ‚Å‚·B)",
		/* [17] */
		"Windows 95/98/Me/NT/2000 ‚Å‚ÍA‘å—Ê‚ÌƒAƒ"
		"CƒRƒ“\\¬‚ğ•\\¦‚·‚é‚±‚Æ‚ªo—ˆ‚Ü‚¹‚ñB‚±‚"
		"Ì‚Ü‚Üˆ—‚ğ‘±‚¯‚Ü‚·‚©H‚»‚ê‚Æ‚à‚¢‚­‚Â‚©‚"
		"ÌƒAƒCƒRƒ“\\¬‚ğíœ‚µ‚Ü‚·‚©H",
		/* [18] */
		"‘±‚¯‚é"
	}
};
...
resource 'STR#' (1000, "Preferences Help", purgeable) {
	{	/* array StringArray: 79 elements */
		/* [1] */
		"ƒfƒBƒXƒvƒŒƒC‚Ìİ’è‚ğ“K—p‚µ‚Ü‚·B",
		/* [2] */
		"ˆÈ‘O‚Ìİ’è‚É–ß‚µ‚Ü‚·B",
		/* [3] */
		"",
		/* [4] */
		"",
		...
		"",
		/* [56] */
		"Œ»İ‘I‘ğ‚³‚ê‚Ä‚¢‚éŠO•”ƒGƒfƒBƒ^",
		/* [57] */
		"",
		/* [58] */
		"Œ»İ‘I‘ğ‚³‚ê‚Ä‚¢‚éŠO•”ƒGƒfƒBƒ^‹N“®‚ÌƒVƒ‡"
		"[ƒgƒJƒbƒg",
		/* [59] */
		"",
		/* [60] */
		...
		"",
		/* [62] */
		"ƒAƒCƒRƒ“\\¬ƒpƒŒƒbƒg‚Ì‹ó‚Å‚Í‚È‚¢‚à‚Ì‚¾‚¯"
		"•\\¦‚·‚éB",
		/* [63] */
		"•\\¦‚Ì–â‘è‚ª”­¶‚µ‚È‚¢‚æ‚¤‚·‚éB",
		/* [64] */
		"ƒpƒ^[ƒ“‚ğg—p‚µ‚Ä‘½‚­‚ÌF‚ğ•\\Œ»‚·‚éB",
		/* [65] */
		"",
		/* [66] */
		"",
		...
		"",
		/* [79] */
		"g—p‚³‚ê‚Ä‚¢‚éƒAƒCƒRƒ“\\¬‚âŠg‘åƒTƒCƒY‚È"
		"‚Ç‚Ìî•ñ‚ğ•Û‚µ‚Ä‚¢‚Ü‚·B"
	}
};
...
resource 'STR#' (1003, "Add Member Help", purgeable) {
	{	/* array StringArray: 5 elements */
		/* [1] */
		"‘I‘ğ‚³‚ê‚½ƒAƒCƒRƒ“\\¬‚ğì¬‚·‚éB",
		/* [2] */
		"‰½‚à‚µ‚È‚¢B",
		/* [3] */
		"",
		/* [4] */
		"ƒAƒCƒRƒ“\\¬‚ÌƒTƒCƒY‚ÆF[“x‚ğ‘I‘ğ‚·‚éB",
		/* [5] */
		"‚·‚Å‚É‚ ‚éƒAƒCƒRƒ“‚©‚çV‚µ‚¢ƒAƒCƒRƒ“‚ğì"
		"¬‚·‚éİ’èB"
	}
};
