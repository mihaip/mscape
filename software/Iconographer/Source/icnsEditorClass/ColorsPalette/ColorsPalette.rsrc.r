/* Resource fork of software/Iconographer/Source/icnsEditorClass/ColorsPalette/ColorsPalette.rsrc */
...
resource 'STR#' (270, "Colors Palette: HSV Picker: Balloon Help", purgeable) {
	{	/* array StringArray: 6 elements */
		...
		/* [3] */
		"Saturation (ÒpurityÓ of color) control s"
		"lider",
		/* [4] */
		"Saturation (ÒpurityÓ of color) preview",
		/* [5] */
