...
resource 'MENU' (624) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"Pixelliss", noIcon, noKey, noMark, plain,
		/* [2] */
		"Lisss", noIcon, noKey, noMark, plain
	}
};
